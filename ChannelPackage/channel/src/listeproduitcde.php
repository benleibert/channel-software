	...
	if($lg != '') {
		$code .= '<script language="JavaScript"> 
					function pickUp(idArticle,designat,unite,prixUnit){
						...
						if(parseFloat(window.opener.document.formadd.qte'.$lg.'.value)>0 && parseFloat(window.opener.document.formadd.prix'.$lg.'.value)>0) {
						window.opener.document.formadd.total'.$lg.'.value = parseInt(window.opener.document.formadd.qte'.$lg.'.value) * parseFloat(window.opener.document.formadd.prix'.$lg.'.value);
						}
						else {
