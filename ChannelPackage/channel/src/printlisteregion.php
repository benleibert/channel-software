...
$libellecde = getlang(390); // 'Liste des sites de niveau central';
//Ligne
if(isset($_SESSION['WHERE']) && $_SESSION['WHERE']!='') {
	$ligne = ligneEtatListeRegions($_SESSION['WHERE']);
}
else {
$ligne = ligneEtatListeRegions('','','');
}
?>
    ...
    <table width="100%" border="0" align="left"  cellpadding="3" cellspacing="1"  class="botBorder">
                              <tbody>
                                <tr align="left" valign="top" nowrap>
                                  ...
                                  <td align=left valign="middle" class="botBorderTdall"><div><strong><?php echo getlang(102); ?> </strong></div></td>
                                </tr>
                                <?php echo $ligne; ?>
        </tbody>
      </table>
