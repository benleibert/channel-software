        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="2">
          <tr>
            <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
              ...
              <tr>
                <td colspan="2" align="left" valign="top"><form action="dbetat.php?do=journal" method="post" name="formadd" id="formadd">
                  <table width="100%" border="0" cellpadding="5" cellspacing="0" class="tableBorder">
                    <tr class="header2Bg">
                      <td align="left" valign="top" class="boldText" ><?php echo getlang(302); ?></td>
                    </tr>
                    <tr>
                      <td class="text" align="center"><table width="574" border="0" align="left" cellpadding="5" cellspacing="0" class="botBorder">
                        <tbody>
                          <tr align="left" valign="top">
                            <td width="255" align="right" valign="middle" class="text"><?php echo getlang(62); ?> :</td>
                            <td width="299" align="left" class="text"><select name="xexercice" id="xexercice" class="formStyle" readonly="readonly"  disabled="disabled">
                          ...
                          <tr align="left" valign="top">
                            ...
                            <td align="left" class="text"><input name="datedebut" type="text" class="formStyle" id="datepicker3" value="<?php echo date('01-01-'.$_SESSION['GL_USER']['EXERCICE']); ?>" /></td>
                          </tr>
                          <tr align="left" valign="top">
                          ...
                          <tr align="left" valign="top">
                            ...
                            <td align="left" class="text"><div id="listearticle">
                              <select name="produit[]" size="10" class="formStyle" id="produit[]" multiple="multiple">
                                          </select>
                            </div>
                            <br>
