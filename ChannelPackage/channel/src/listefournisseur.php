...
function jscode() {
	...
	$code .= '<script language="JavaScript"> 
					function pickUp(idfour,fournisseur){
...
<script> writeTableStartTagBasedOnResolution(); </script>
  ...
  <tr>
    ...
    <table width="400" border="0" align="left" cellpadding="1" cellspacing="1">
      <tr>
        <td height="20" colspan="2" class="leftHeader"><?php echo getlang(395); ?></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <table width="400" border="0" cellpadding="5" cellspacing="1" class="tableBorder">
          <!-- Begin Table Header -->
          <tr class="header2">
            <td width="46" height="25" align="left" valign="middle" class="header2Bg" nowrap="nowrap">Code</td>
            <td width="208" height="25" align="left" valign="middle" class="header2Bg">&nbsp;<?php echo getlang(66); ?></td>
            </tr>
		  <?php 
		  	(isset($_GET['wh']) ? $wh=$_GET['wh'] : $wh = '');
			echo listeDesFournisseurs($wh);
			?>
