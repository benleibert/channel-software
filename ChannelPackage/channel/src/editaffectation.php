...
if($_SESSION['GL_USER']['DROIT']['par_aff']['MODIF']!=1) header("location:accessinterdit.php?selectedTab=home");
...
(isset($_SESSION['DATA_AFF']['LOGIN']) ? $login = $_SESSION['DATA_AFF']['LOGIN']: $login ='');
(isset($_SESSION['DATA_AFF']['NUM_MLLE']) ? $nummlle = $_SESSION['DATA_AFF']['NUM_MLLE']: $nummlle ='');
$magasin = $_SESSION['DATA_AFF']['MAGASIN'];
        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="2">
          <tr>
            <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
              ...
              <tr>
                <td colspan="2" align="left" valign="top"><form action="dbaffectation.php?do=update" method="post" name="formadd" id="formadd">
                  <table width="100%" border="0" cellpadding="5" cellspacing="0" class="tableBorder">
                    <tr class="header2Bg">
                      <td align="left" valign="top" class="boldText" ><?php echo getlang(429); ?></td>
                    </tr>
                    <tr>
                      <td class="text" align="center"><table width="700" border="0" align="left" cellpadding="5" cellspacing="0" class="botBorder">
                        <tbody>
                          <tr align="left" valign="top">
                            ...
                            <td align="left" class="text"><select name="personnel" class="formStyle" id="personnel" onchange="fillCompte();" disabled="disabled">
                              <option value="0"></option>
                              <?php echo selectPersonnel($nummlle); ?>
                            </select>
                              <span class="mandatory">*
                              <input name='mlle' type='hidden' id="mlle" value="<?php echo  $nummlle; ?>" />
                              </span></td>
                          </tr>
                          <tr align="left" valign="top">
                            <td width="200" align="right" valign="middle" class="text">Compte&nbsp;:&nbsp;</td>
                            <td align="left" class="text"><select name="compte" class="formStyle" id="compte" disabled="disabled">
                              <option value="0"></option>
                              <?php echo selectCompte($login); ?>
                            </select>
                              <span class="mandatory"> * 
                          ...
                          <tr align="left" valign="top">
                            ...
                            <td>&nbsp;<?php echo listemagasin($magasin); ?></td>
                          </tr>
                          <tr align="left" valign="top">
                            <td width="200">&nbsp;</td>
