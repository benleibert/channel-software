...
$libellecde = getlang(385); //'Liste des produits';
//Ligne
if(isset($_SESSION['WHERE']) && $_SESSION['WHERE']!='') {
	$ligne = ligneEtatListeProduit($_SESSION['WHERE']);
}
else {
$ligne = ligneEtatListeProduit('');
}
?>
    ...
    <table width="890" border="0" align="left"  cellpadding="3" cellspacing="1"  class="botBorder">
                              <tbody>
                                <tr align="left" valign="top" nowrap>
                                  <td width="111" align=right valign="middle" class="botBorderTdall"><div align="center"><strong><?php echo getlang(257); ?></strong></div></td>
                                  <td width="162" align=right valign="middle" class="botBorderTdall"><div align="center"><strong><?php echo getlang(116); ?></strong></div></td>
                                  <td width="192" align=right valign="middle" class="botBorderTdall"><div align="center"><strong><?php echo getlang(19); ?> </strong></div></td>
                                  <td width="66" align=right valign="middle" class="botBorderTdall"><div align="center"><strong><?php echo getlang(204); ?></strong></div></td>
                                  <td width="84" align=right valign="middle" class="botBorderTdall"><div align="center"><strong><?php echo getlang(116); ?> traceur</strong></div></td>
                                </tr>
                                <?php echo $ligne; ?>
        </tbody>
      </table>
