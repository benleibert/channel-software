...
//Ligne
$ligne = ligneEtatStockLot($nbreLigne,$data);
...
<table width="700" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
                ...
                <tr>
                  <td height="20" class="leftHeader" colspan="2"><h2><?php echo getlang(58); ?></h2></td>
                </tr>
	<tr class="header2">
    ...
    <table width="1036" border="0" align="left"  cellpadding="3" cellspacing="0"  class="botBorderTdall">
                              <tbody>
                                <tr align="left" valign="top" nowrap>
                                  ...
                                  <td align=right valign="middle" class="botBorderTdall header2Bg">&nbsp;</td>
                                  <td colspan="4" align=center valign="middle" class="botBorderTdall header2Bg"><div align="center"><strong><?php echo getlang(236); ?></strong>s</div></td>
                                ...
                                <tr align="left" valign="top" nowrap>
                                  ...
                                  <td width="10" align=right valign="middle" class="botBorderTdall header2Bg" nowrap="nowrap"><div align="left"><strong>Réf. Lot</strong></div></td>
