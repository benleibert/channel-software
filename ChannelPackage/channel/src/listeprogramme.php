...
(isset($wh) && $wh!='' ? $where = " WHERE programmation.ID_EXERCICE=".$_SESSION['GL_USER']['EXERCICE']." AND programmation.CODE_NDOTATION NOT LIKE '10DOT' AND  programmation.PRG_VALID=1 AND BENEF_NOM LIKE '$wh%'" : $where = " WHERE programmation.CODE_NDOTATION NOT LIKE '10DOT' AND  programmation.PRG_VALID=1 AND programmation.ID_EXERCICE=".$_SESSION['GL_USER']['EXERCICE']);
$programme = listeProgramme($where);

//Next link
$urlAlph = "listeprogramme.php?lg=$lg&wh=";
//JS code to send data in form
function jscode() {
	$code ='';
	$code .= '<script language="JavaScript"> 
					function pickUp(idArticle,designat){
						window.opener.document.formadd.programmation.value = idArticle;
						window.opener.document.formadd.libprogrammation.value = designat;
						window.close();
					}
			</script>';
	return $code;
...
<script> writeTableStartTagBasedOnResolution(); </script>
  ...
  <tr>
    ...
    <table width="400" border="0" align="left" cellpadding="1" cellspacing="1">
      <tr>
        <td height="20" colspan="2" class="leftHeader">Liste des programmations </td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <table width="400" border="0" cellpadding="5" cellspacing="1" class="tableBorder">
          <!-- Begin Table Header -->
          <tr class="header2">
            <td width="58" height="25" align="center" valign="middle" class="header2Bg" nowrap>Dotation</td><td width="317" height="25" align="left" valign="middle" class="header2Bg">&nbsp;B&eacute;n&eacute;ficiaire</td>
