...
function validateForm(){
	...
	var codeinventaire 	= trimAll(document.formadd.codeinventaire.value);
	var inventaire 	= trimAll(document.formadd.inventaire.value);
	var msg = '';
		
	if(dateinventaire == "" && codeinventaire == "" && inventaire == "" && document.formadd.statut.checked==false) {
        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="2">
          <tr>
            <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
              ...
              <tr>
                <td colspan="2" align="left" valign="top"><form action="../src/inventaire.php?selectedTab=int&amp;do=search" method="post" name="formadd" id="formadd">
                  <table width="100%" border="0" cellpadding="5" cellspacing="0" class="tableBorder">
                    <tr class="header2Bg">
                      <td align="left" valign="top" class="boldText" >&nbsp;<?php echo getlang(139); ?> <?php echo getlang(298); ?></td>
                    </tr>
                    <tr>
                      <td class="text" align="center"><table width="600" border="0" align="left" cellpadding="5" cellspacing="0" class="botBorder">
                        <tbody>
                          ...
                          <tr align="left" valign="top">
                            ...
                            <td align="left" class="text"><input name="dateinventaire" type="text" class="formStyle" id="datepicker1" value="" /></td>
                          </tr>
                          <tr align="left" valign="top">
                            <td align="right" valign="middle" class="text"><?php echo getlang(286); ?>&nbsp;:&nbsp;</td>
                            <td align="left" class="text"><input name="codeinventaire" type="text" class="formStyle" id="codeinventaire" value="" />
                              <span class="mandatory" id="msg"></span></td>
                          </tr>
                          <tr align="left" valign="top">
                            <td align="right" valign="middle" class="text"><?php echo getlang(284); ?>&nbsp;:&nbsp;</td>
                            <td align="left" class="text"><input name="inventaire" type="text" class="formStyle" id="inventaire" value="" /></td>
                          </tr>
                          <tr align="left" valign="top">
