...
//Ligne
$ligne = lignedetailLivraison($nbreLigne,$data);
//Ligne
              ...
              <tr>
                <td colspan="2" align="left" valign="top"><form action="dblivraison.php" method="post" name="formadd" id="formadd">
                  <table width="100%" border="0" cellpadding="5" cellspacing="0" class="tableBorder">
                    <tr class="header2Bg">
                      <td align="left" valign="top" class="boldText" >&nbsp;D&eacute;tails une livraison </td>
                    </tr>
                    <tr>
                      <td class="text" align="center"><table width="600" border="0" align="left" cellpadding="5" cellspacing="0" class="botBorder">
                        <tbody>
                          ...
                          <tr align="left" valign="top">
                            ...
                            <td align="left" class="text"><input name="libcommande" type="text" class="formStyle" id="libcommande" readonly="readonly" value="<?php echo  $commande; ?>"/>
                              <input name="refcommande" type="hidden" class="formStyle"  id="refcommande" value="<?php echo  $commande; ?>"/>
                              &nbsp;</td>
                          </tr>
                          <tr align="left" valign="top">
                            <td align="right" valign="middle" class="text"><?php echo getlang(82); ?> :&nbsp;</td>
                            <td align="left" class="text"><input name="libcommande2" type="text" class="formStyle" id="libcommande2" readonly="readonly" value="<?php echo  $libcommande; ?>"/>
                              <input name="libcommande2" type="hidden" class="formStyle"  id="libcommande2" value="<?php echo  $commande; ?>"/>
                              &nbsp;</td>
                          </tr>
                          <tr align="left" valign="top">
...
<table width="100%" border="0" cellpadding="5" cellspacing="0" class="tableBorder">
                        <tr class="header2Bg">
                          <td align="left" valign="top" class="boldText" ><?php echo getlang(214); ?> <?php echo getlang(86); ?> (Pr&eacute;cisez les magasin de stockage)</td>
						...
						<input name="statusexercice" type="hidden" id="statusexercice" value="<?php echo $_SESSION['GL_USER']['STATUT_EXERCICE']; ?>">
							  ...
							  <tr align="left" valign="top">
							    ...
							    <td colspan="10">
							      ...
							      <input name="Enregistrer" type="button" class="button" id="Enregistrer"  value='<?php echo getlang(187); ?>'  onClick="OpenBigWin('printlivraison.php','');"> <?php echo $Annuler; ?></td>
  								</tr>
                          </table></td>
