...
$libellecde 	= getlang(129);

//Ligne
$ligne = ligneEtatrapmvtfournisseur($nbreLigne,$data);
...
<table width="700" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
                <tr>
                  <td height="20" colspan="2" class="leftHeader"><h2><?php echo (stripslashes($libellecde)); ?> : <?php echo $mag; ?></h2></td>
                </tr>
	<tr class="header2">
                      <td width="34%" height="25" align="left" valign="middle" nowrap="nowrap" class="header2Bg">&nbsp;<?php echo getlang(62); ?> : <strong><?php echo $exercice; ?>&nbsp;&nbsp;</strong></td>
                      <td width="66%" align="left" valign="middle" nowrap="nowrap" class="header2Bg"><?php echo getlang(66); ?> : <strong><?php echo $fournisseur; ?></strong></td>
        </tr>
      </table>
    <p>&nbsp;</p>
  <tr>
    ...
    <table width="723" border="0" align="left"  cellpadding="3" cellspacing="0"  class="botBorderTdall">
                              <tbody>
                                <tr align="left" valign="top" nowrap>
                                  ...
                                  <td width="48" align=center valign="middle" class="botBorderTdall header2Bg"><div align="center"><strong><?php echo getlang(226); ?></strong></div></td>
                                </tr>
                                <?php echo $ligne; ?>
        </tbody>
      </table>
