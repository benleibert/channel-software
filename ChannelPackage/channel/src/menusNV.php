...
$ilang=getCodelangue($userName);
	...
	'0'=>  array('0'=>'Inventaires',
				'2'=> array('Imprimer fiche d\'inventaire', 'ficheinventaire.php?selectedTab=int&rst=1',$int_pcd, 'int'),
				'1'=> array('Saisie d\'inventaire', 'inventaire.php?selectedTab=int&rst=1',$int_int, 'int')
				),
	'1'=>  array('0'=>'Etat du stock',
	...
	$TOPMENUS =array( //Libellé , Lien, Droit, Tab
	'0'=>  array('0'=>'Inventory',
				'2'=> array('Print inventory sheet', 'ficheinventaire.php?selectedTab=int&rst=1',$int_pcd, 'int'),
				'1'=> array('Entering Inventory', 'inventaire.php?selectedTab=int&rst=1',$int_int, 'int')
				),
	'1'=>  array('0'=>'Stock status',
	...
	'0'=>  array('0'=>'Inventário',
				'2'=> array('Folha de inventário Imprimir', 'ficheinventaire.php?selectedTab=int&rst=1',$int_pcd, 'int'),
				'1'=> array('Entrando Inventory', 'inventaire.php?selectedTab=int&rst=1',$int_int, 'int')
				),
	'1'=>  array('0'=>'Da estatuto',
...
define('RIGHT_MENU','<a href="choixlangue.php"> Langue : <select name="langue" id="langue" class="formStyleFree" ><option value="1"></option>'.selectlangue($ilang).'</select></a> <a href="/BDEB/index0.php">Administrateur  </a> <a href="aide.php?selectedTab=aid"><img src="/BDEB/images/help0000.gif" border="0" hspace="3" align="middle" />'.$vaide.'</a> <span class=white> </span> <a href="about.php?selectedTab=aid"><img src="/BDEB/images/about000.gif" border="0" hspace="3" align="middle" />'.$vprop.'</a>&nbsp;&nbsp;');
