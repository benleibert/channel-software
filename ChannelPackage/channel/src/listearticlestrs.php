    ...
    <table width="400" border="0" align="left" cellpadding="1" cellspacing="1">
      ...
      <tr>
        ...
        <table width="400" border="0" cellpadding="5" cellspacing="1" class="tableBorder">
          <!-- Begin Table Header -->
          <tr class="header2">
            <td width="30" align="left" valign="middle" class="header2Bg">Code</td>
            <td width="30" align="left" valign="middle" class="header2Bg">Qté</td>
            <td width="30" height="25" align="left" valign="middle" class="header2Bg"><?php echo getlang(220); ?></td>
            <td width="100" height="25" align="left" valign="middle" class="header2Bg"><?php echo getlang(199); ?></td>
            <td width="30" height="25" align="center" valign="middle" class="header2Bg" nowrap>Stock</td>
			<td width="30" height="25" align="center" valign="middle" class="header2Bg" nowrap="nowrap"><?php echo getlang(204); ?></td>
          </tr>
		  <?php 
		  	(isset($_GET['wh']) ? $wh=$_GET['wh'] : $wh = '');
			echo listeDesArticlestrs($wh);
			?>
