...
//Ligne
$ligne = lignedetailLivraison2($nbreLigne,$data);
...
<script type="text/javascript">	
	$(document).ready(function(){ 
	  $('.placeholder').mask("0000/00/00", {placeholder: "____/__/__"});
	});
</script>
              ...
              <tr>
                <td colspan="2" align="left" valign="top"><form action="dblivraison.php" method="post" name="formadd" id="formadd">
                  <table width="100%" border="0" cellpadding="5" cellspacing="0" class="tableBorder">
                    <tr class="header2Bg">
                      <td align="left" valign="top" class="boldText" ><?php echo getlang(86); ?> </td>
                    </tr>
                    <tr>
