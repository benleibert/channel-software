...
function validateForm(){
	//var jours 	= trimAll(document.formadd.jours.options[document.formadd.jours.selectedIndex].value);
	...
	//if(jours == "0") {
    //  	msg += '- Veuillez sélectionner le nombre de jours.\n';
    //}
	if(datedebut==''){
        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="2">
          <tr>
            <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
              <tr>
                <td width="43" bgcolor="#FFCC66" class="leftHeader">Rapports &rarr; Rapport de produits à date de péremption proche</td>
              </tr>
              <tr>
                <td colspan="2" align="left" valign="top"><form action="dbetat.php?do=rapprdaperimer" method="post" name="formadd" id="formadd">
                  <table width="100%" border="0" cellpadding="5" cellspacing="0" class="tableBorder">
                    <tr class="header2Bg">
                      <td align="left" valign="top" class="boldText" >Faire le Rapport des produits prohe de la péremtion</td>
                    </tr>
                    <tr>
                      <td class="text" align="center"><table width="600" border="0" align="left" cellpadding="5" cellspacing="0" class="botBorder">
                        <tbody>
                          ...
                          <!--
                          <tr align="left" valign="top">
                            <td align="right" valign="middle" class="text"><?php echo getlang(201); ?> :&nbsp;</td>
                            <td align="left" class="text"><input name="datedebut" type="text" class="formStyle" id="datepicker2" value="<?php echo date('d/m/Y'); ?>" />
                              <span class="mandatory" >*</span></td>
                          </tr>
                          -->
                          <tr align="left" valign="top">
                          ...
                          <!--
                          <tr align="left" valign="top">
                            <td align="right" valign="middle" class="text">Dans x jours/mois&nbsp;:&nbsp;</td>
                            <td align="left" class="text"><select name="jours" id="jours" class="formStyle" >
                              <option value="0">Jours/mois</option>
                              <?php echo selectJourMois(''); ?>
                              </select></td>
                          </tr>
                          -->
                          <tr align="left" valign="top">
                          ...
                          <tr align="left" valign="top">
                            <td width="200"><input name='debutexercice' type='hidden' id="debutexercice" value="<?php echo $_SESSION['GL_USER']['DEBUT_EXERCICE']; ?>" />
