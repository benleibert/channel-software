...
$libelle ='Report de l\'exercice '.$exercice;
(isset($_SESSION['DATA_REP']['datereport']) 		? $date 	= $_SESSION['DATA_REP']['datereport']: $date ='');
(isset($_SESSION['DATA_REP']['ligne']) ? $data= $_SESSION['DATA_REP']['ligne'] : $data=array());
//Ligne
$ligne = ligneEtatReport($nbreLigne,$data);
...
<table width="700" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
                ...
                <tr>
                  <td height="20" class="leftHeader" colspan="3"><h3><strong><?php echo $libelle; ?></strong></h3></td>
                </tr>
	<tr class="header2">
          ...
          <td width="33%" align="left" valign="middle" nowrap class="header2Bg">&nbsp;</td>
           </tr>
      </table>
    <p>&nbsp;</p>
    <tr>
    <td>
    <table width="723" border="0" align="left"  cellpadding="3" cellspacing="1"  class="botBorder">
                              <tbody>
                                <tr align="left" valign="top" nowrap>
                                  <td width="5" align=center valign="middle" class="botBorderTdall"><strong>N°</strong></td>
                                  <td width="200" align=right valign="middle" class="botBorderTdall"><div align="left"><strong><?php echo getlang(199); ?></strong> </div></td>

                                 
                                  <td width="48" align=center valign="middle" class="botBorderTdall"><div align="center"><strong><?php echo getlang(222); ?></strong></div></td>
								  <td width="48" align=center valign="middle" class="botBorderTdall"><div align="center"><strong><?php echo getlang(204); ?></strong></div></td>
