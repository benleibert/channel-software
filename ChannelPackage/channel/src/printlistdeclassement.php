...
$libellecde = 'Liste des déclassements';
...
<table width="700" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
                <tr>
                  <td width="100%" height="20" class="leftHeader"><h3><?php echo getlang(359); ?></h3></td>
                </tr>
      </table>
    <p>&nbsp;</p>
    <tr>
    ...
    <table width="723" border="0" align="left"  cellpadding="3" cellspacing="0"  class="botBorderTdall">
                    ...
                    <td width="15%" height="25" align="center" valign="middle" class="botBorderTdall header2Bg"><strong><?php echo getlang(31); ?></strong></td>
                    <td width="10%" height="25" align="left" valign="middle" class="botBorderTdall header2Bg"><strong><?php echo getlang(42); ?></strong> </td>
                    <td width="35%" height="25" align="left" valign="middle" class="botBorderTdall header2Bg"><strong><?php echo getlang(278); ?></strong></td>
							    </tr>
                                <?php echo $ligne; ?>
        </tbody>
      </table>
