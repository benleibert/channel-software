...
function validateForm(){
	...
	if(raison == "") {
      	msg += '- Veuillez saisir la raison de la perte.\n';
    }
	if(msg !=''){
		alert(msg);
	}
...
function go(){
	if(document.getElementById('refdeclassement').value != document.getElementById('oldrefdeclassement').value){
	var xhr = getXhr();
                      ...
                      <td class="text" align="center"><table width="600" border="0" align="left" cellpadding="5" cellspacing="0" class="botBorder">
                        <tbody>
                          ...
                          <tr align="left" valign="top">
                            ...
                            <td align="left" class="text"><input name="refdeclassement" type="text" class="formStyle" id="refdeclassement" readonly="readonly" value="<?php echo $refdeclassement; ?>" onblur="go();"  /><span class="mandatory" id="msg"></span></td>
                          </tr>
                          <tr align="left" valign="top">
                            <td align="right" valign="middle" class="text"><?php echo getlang(99); ?>&nbsp;:&nbsp;</td>
                            <td align="left" class="text"><input name="raison" type="text" class="formStyle" id="raison" readonly="readonly" value="<?php echo $raison; ?>" /></td>
                          </tr>
                          <tr align="left" valign="top">
...
<table width="100%" border="0" cellpadding="5" cellspacing="0" class="tableBorder">
                        <tr class="header2Bg">
                          <td align="left" valign="top" class="boldText" ><?php echo getlang(214); ?> <?php echo getlang(111); ?></td>
                        </tr>
                        <tr>
