...
$libellecde = 'Liste des inventaires';

//Ligne
if(isset($_SESSION['WHERE']) && $_SESSION['WHERE']!='') {
	$ligne = ligneEtatListeInventarie($_SESSION['WHERE'],'','');
}
else {
$ligne = ligneEtatListeInventarie("inventaire.ID_EXERCICE=".$_SESSION['GL_USER']['EXERCICE']."  AND inventaire.CODE_MAGASIN LIKE '".$_SESSION['GL_USER']['MAGASIN']."'",'','');
}
?>
...
<table width="700" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
                <tr>
                  <td width="100%" height="20" class="leftHeader"><h2> <?php echo getlang(355); ?></h2></td>
                </tr>
      </table>
    <p>&nbsp;</p>
    <tr>
    ...
    <table width="723" border="0" align="left"  cellpadding="3" cellspacing="0"  class="botBorderTdall">
                    ...
                    <td width="10%" height="25" align="center" valign="middle" class="botBorderTdall header2Bg"><strong>Code invenatire</strong></td>
                    <td width="10%" align="left" valign="middle" class="botBorderTdall header2Bg"><strong><?php echo getlang(291); ?></strong></td>
                    <td width="30%" height="25" align="left" valign="middle" class="botBorderTdall header2Bg"><strong>&nbsp;&nbsp;<span class="header2Bg"><?php echo getlang(284); ?></span></strong></td>
