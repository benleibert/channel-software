...
//Ligne
$ligne = ligneEtatrapmensuel2($nbreLigne,$data);
$periode = '';
...
<table width="700" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
                <tr>
                   <td height="20"  bgcolor="#FFCC66" class="leftHeader"><h2><?php echo (stripslashes($libelle)); ?> <?php echo (stripslashes($periode)); ?></h2></td>
                </tr>
	<tr class="header2">
    ...
    <table width="723" border="0" align="left"  cellpadding="3" cellspacing="0"  class="botBorderTdall">
                              <tbody>
                                <tr align="left" valign="top" nowrap>
                                  <td width="8%" align="center" valign="middle" class="botBorderTdall header2Bg" nowrap="nowrap"><strong>Réf. lot</strong></td>
                    ...
                    <td width="8%" align="center" valign="middle" nowrap class="botBorderTdall header2Bg"><strong>Qté réçu durant le mois</strong></td>
                    <td width="4%" align="center" valign="middle" nowrap class="botBorderTdall header2Bg"><strong><?php echo getlang(208); ?> durant le mois</strong></td>
