...
if($_SESSION['GL_USER']['DROIT']['par_bud']['AJOUT']!=1) header("location:accessinterdit.php?selectedTab=home");
        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="2">
          <tr>
            <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
              <tr>
                <td height="20" bgcolor="#FFCC66" class="leftHeader"><?php echo getlang(447); ?></td>
              </tr>
              <tr>
                <td colspan="2" align="left" valign="top"><form action="dbexercice.php?do=add" method="post" name="formadd" id="formadd">
                  <table width="100%" border="0" cellpadding="5" cellspacing="0" class="tableBorder">
                    <tr class="header2Bg">
                      <td align="left" valign="top" class="boldText" >&nbsp;Ajouter  <?php echo getlang(62); ?></td>
                    </tr>
                    <tr>
                      <td class="text" align="center"><table width="600" border="0" align="left" cellpadding="5" cellspacing="0" class="botBorder">
                        <tbody>
                          <tr align="left" valign="top">
                            ...
                            <td width="358" align="left" class="text"><input name="codeexercice" type="text" class="formStyle" id="codeexercice" onblur="go();" />
                              <span class="mandatory" id="msg">*</span></td>
                          </tr>
                          <tr align="left" valign="top">
                            <td align="right" valign="middle" class="text"><?php echo getlang(62); ?>&nbsp;:&nbsp;</td>
                            <td align="left" class="text"><input name="exercice" type="text" class="formStyle" id="exercice" />
                              <span class="mandatory">*</span></td>
                          </tr>
                          <tr align="left" valign="top">
                            <td align="right" valign="middle" class="text"><?php echo getlang(398); ?> :&nbsp;</td>
                            <td align="left" class="text"><input name="datedebut" type="text" class="formStyle" id="datepicker1" />
                              <span class="mandatory">*</span></td>
                          </tr>
                          <tr align="left" valign="top">
                            <td align="right" valign="middle" class="text"><?php echo getlang(399); ?> :&nbsp;</td>
                            <td align="left" class="text"><input name="datefin" type="text" class="formStyle" id="datepicker2" />
                              <span class="mandatory">*</span></td>
                          </tr>
                          <tr align="left" valign="top">
                            <td align="right" valign="middle" class="text"><?php echo getlang(445); ?> :&nbsp;</td>
                            <td align="left" class="text"><input type="checkbox" name="cloture" id="cloture" value="1" /></td>
                          </tr>
                          <tr align="left" valign="top">
                            <td align="right" valign="middle" class="text"><?php echo getlang(400); ?> :&nbsp;</td>
                            <td align="left" class="text"><input name="datecloture" type="text" class="formStyle" id="datepicker3" /></td>
                          </tr>
                          <tr>
