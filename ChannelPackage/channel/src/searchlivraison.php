...
function validateForm(){
	...
	var codelivraison = trimAll(document.formadd.codelivraison.value);
	var libelle  =  trimAll(document.formadd.libelle.value);
	var datelivraison1 	= trimAll(document.formadd.datelivraison1.value);
	var commande 	= trimAll(document.formadd.commande.value);
	var msg = '';

	if( datelivraison == ""  && datelivraison1 == "" && codelivraison == "" && libelle == ""  && commande == "" && document.formadd.statut.checked==false) {
...
function go(){
	...
	id = document.getElementById('codelivraison').value;
	xhr.send("code="+id);
}
        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="2">
          <tr>
            <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
              ...
              <tr>
                <td colspan="2" align="left" valign="top"><form action="livraison.php?selectedTab=bde&do=search" method="post" name="formadd" id="formadd">
                      ...
                      <td class="text" align="center"><table width="600" border="0" align="left" cellpadding="5" cellspacing="0" class="botBorder">
                        <tbody>
                          ...
                          <tr align="left" valign="top">
                            ...
                            <td align="left" class="text"><input name="datelivraison" type="text" class="formStyle" id="datepicker1" value="" /></td>
                          </tr>
                          <tr align="left" valign="top">
                            <td align="left" class="text"><input name="datelivraison1" type="text" class="formStyle" id="datepicker2" value="" /></td>
                          </tr>
                          <tr align="left" valign="top">
                            <td align="right" valign="middle" class="text"><?php echo getlang(140); ?> :</td>
                            <td align="left" class="text"><select name="commande" id="commande" class="formStyle">
                              <option value="0"></option>
                              <?php echo selectCommande(0,"ID_EXERCICE = '".$_SESSION['GL_USER']['EXERCICE']."' AND CDE_STATUT=1"); ?>
                            </select></td>
                          </tr>
                          <tr align="left" valign="top">
                            <td align="right" valign="middle" class="text"><?php echo getlang(141); ?> :</td>
                            <td align="left" class="text"><input name="codelivraison"  id="codelivraison" type="text" class="formStyle" onblur="go();"  /></td>
                          </tr>
                          <tr align="left" valign="top">
                            <td align="right" valign="middle" class="text"><?php echo getlang(83); ?> :</td>
                            <td align="left" class="text"><input name="libelle"  id="libelle" type="text" class="formStyle"  /></td>
                          </tr>
                          <tr align="left" valign="top">
