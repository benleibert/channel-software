...
$libellecde 	= getlang(407); // 'Rapport produit se périmant avant le '.$_SESSION['DATA_ETAT']['DATEPEREMPTION'];
$libellecde 	=$libellecde.'  '.$_SESSION['DATA_ETAT']['DATEPEREMPTION'];
//Ligne
$ligne = ligneEtatrapproduitaperime($nbreLigne,$data);
    ...
    <table width="723" border="0" align="left"  cellpadding="3" cellspacing="0"  class="botBorderTdall">
                              <tbody>
                                <tr align="left" valign="top" nowrap>
                                  ...
                                  <td width="10" align=center valign="middle" class="botBorderTdall header2Bg"><div align="left"><strong>Réf. lot</strong></div></td>
                                  ...
                                  <td width="48" align=center valign="middle" class="botBorderTdall header2Bg"><div align="center"><strong><?php echo getlang(201); ?></strong></div></td>
                                </tr>
                                <?php echo $ligne; ?>
        </tbody>
      </table>
