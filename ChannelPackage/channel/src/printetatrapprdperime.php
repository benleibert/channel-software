...
$libellecde 	= getlang(131);

//Ligne
$ligne = ligneEtatrapprdperime($nbreLigne,$data);
...
<table width="700" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td><table width="100%" cellspacing="0" cellpadding="0">
      ...
      <tr valign="top" class="EtatText">
        <td align="center">
          <?php echo mb_strtoupper(stripslashes($nommag)); ?>,  <?php echo date("d/m/Y"); ?></td>
      </tr>
      <tr valign="top" class="EtatText">
        <td>&nbsp;</td>
      </tr>
    ...
    <table width="723" border="0" align="left"  cellpadding="3" cellspacing="0"  class="botBorderTdall">
                              <tbody>
                                <tr align="left" valign="top" nowrap>
                                  ...
                                  <td width="48" align=center valign="middle" class="botBorderTdall header2Bg" nowrap="nowrap"><div align="center"><strong><?php echo getlang(201); ?></strong></div></td>
