...
if(isset($_SESSION['WHERE']) && $_SESSION['WHERE']!='') {
	$ligne = ligneEtatListeCommande($_SESSION['WHERE'],'','');
}
else {
$ligne = ligneEtatListeCommande("commande.ID_EXERCICE=".$_SESSION['GL_USER']['EXERCICE']."  AND commande.CODE_MAGASIN LIKE '".$_SESSION['GL_USER']['MAGASIN']."'",'','');
}
?>
    ...
    <table width="723" border="0" align="left"  cellpadding="3" cellspacing="0"  class="botBorderTdall">
                              <tbody>
                                <tr align="left" valign="top" nowrap>
                                  ...
                                  <td width="80" align=right valign="middle" class="botBorderTdall header2Bg"><div align="left"><strong>Code cde</strong> </div></td>
                                  ...
                                  <td width="100" align=center valign="middle" class="botBorderTdall header2Bg"><div align="center"><strong><?php echo getlang(66); ?></strong></div></td>
							    </tr>
                                <?php echo $ligne; ?>
        </tbody>
      </table>
