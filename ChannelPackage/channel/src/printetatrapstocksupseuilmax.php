...
$libellecde 	= getlang(415); // 'Rapport stock supérieur au seuil maximum';

//Ligne
$ligne = ligneEtatrapstocksupseuilmax($nbreLigne,$data);
    ...
    <table width="723" border="0" align="left"  cellpadding="3" cellspacing="0"  class="botBorderTdall">
                              <tbody>
                                <tr align="left" valign="top" nowrap>
                                  ...
                                  <td width="48" align=center valign="middle" class="botBorderTdall header2Bg"><div align="center"><strong>CMM</strong></div></td>
                                  ...
                                  <td width="48" align=center valign="middle" class="botBorderTdall header2Bg"><div align="center"><strong><?php echo getlang(436); ?></strong></div></td>
