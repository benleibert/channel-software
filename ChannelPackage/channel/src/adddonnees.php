...
if($_SESSION['GL_USER']['DROIT']['par_inf']['AJOUT']!=1) header("location:accessinterdit.php?selectedTab=home");
...
//DOIT MAJ
$droitMAJ = $_SESSION['GL_USER']['DROIT']['par_inf'];
...
$link ='adddonnees.php?selectedTab=par';
$retour = ligneGenererDonnees($_SESSION['DATA_DON'],'CODE_MAGASIN LIKE "'.$_SESSION['GL_USER']['MAGASIN'].'"','','', $page, $_SESSION['GL_USER']['ELEMENT']); //$where, $order, $sens, $page=1, $nelt
            ...
            <td colspan=3 align="left" valign="top">
                ...
                <table width="100%" border="0" cellpadding="2" cellspacing="1" class="tableBorder">
                  ...
                  <tr class="header2">
                    ...
                    <td width="5%" align="center" valign="middle" class="header2Bg">Rationnaires</td>
