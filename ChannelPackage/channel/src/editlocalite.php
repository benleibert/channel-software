...
(isset($_SESSION['DATA_LOC']['ID_LOCALITE']) ? $codelocalite = $_SESSION['DATA_LOC']['ID_LOCALITE']: $codelocalite ='');
(isset($_SESSION['DATA_LOC']['ID_GRPLOC']) ? $grplocalite = $_SESSION['DATA_LOC']['ID_GRPLOC']: $grplocalite ='');
(isset($_SESSION['DATA_LOC']['LOC_NOM']) ? $localite = $_SESSION['DATA_LOC']['LOC_NOM']: $localite ='');
...
function validateForm(){
		...
		if(localite == "") {
        	msg += '- Veuillez saisir le nom de la localité.\n';
        }
		if(msg !=''){
			alert(msg);
		}
        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="2">
          <tr>
            <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
              ...
              <tr>
                <td colspan="2" align="left" valign="top"><form action="dblocalite.php?do=update" method="post" name="formadd" id="formadd">
                  <table width="100%" border="0" cellpadding="5" cellspacing="0" class="tableBorder">
                    <tr class="header2Bg">
                      <td align="left" valign="top" class="boldText" ><?php echo getlang(440); ?> r une localit&eacute;</td>
                    </tr>
                    <tr>
                      <td class="text" align="center"><table width="600" border="0" align="left" cellpadding="5" cellspacing="0" class="botBorder">
                        <tbody>
                          ...
                          <tr align="left" valign="top">
                            ...
                            <td align="left" class="text"><input name="localite" type="text" class="formStyle" id="localite" value="<?php echo  $localite; ?>" />
                              <span class="mandatory">*</span></td>
                          </tr>
                          <tr align="left" valign="top">
                            ...
                            <td align="left" class="text"><input name="xdependance" type="text" class="formStyle" id="xdependance" readonly="readonly" value="<?php echo  ($xdependance); ?>" />
                              ...
                              <input name="openf" type="button" class="button"  title="Loclités" value="..." onclick="OpenWin('listeprovince.php','Liste');" /></td>
                          </tr>
                          <tr>
