...
function validateForm(){
		...
		if(personnel == "0") {
        	msg += '- Veuillez sélectionner le responsable.\n';
        }
		if(datedebut == "") {
        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="2">
          <tr>
            <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
              ...
              <tr>
                <td colspan="2" align="left" valign="top"><form action="dbresponsable.php?do=update" method="post" name="formadd" id="formadd">
                  <table width="100%" border="0" cellpadding="5" cellspacing="0" class="tableBorder">
                    <tr class="header2Bg">
                      <td align="left" valign="top" class="boldText" ><?php echo getlang(449); ?></td>
                    </tr>
                    <tr>
                      <td class="text" align="center"><table width="600" border="0" align="left" cellpadding="5" cellspacing="0" class="botBorder">
                        <tbody>
                          <tr align="left" valign="top">
                            <td align="right" valign="middle" class="text"><?php echo getlang(213); ?></td>
                            <td align="left" class="text"><select name="magasin" id="magasin" class="formStyle">
                              <option value="0"></option>
                              <?php echo selectmagasin($magasin); ?>
                            </select>
                          ...
                          <tr align="left" valign="top">
                            ...
                            <td align="left" class="text"><select name="personnel" class="formStyle" id="personnel">
                              <option value="0"></option>
                              <?php echo selectPersonnel($personnel); ?>
                            </select>
                          ...
                          <tr align="left" valign="top">
                            ...
                            <td align="left" class="text"><input name="datefin" type="text" class="formStyle" id="datepicker2" value="<?php echo $datefin; ?>" /></td>
                          </tr>
                          <tr>
                            <td colspan="2"><input name="exercicecourant" type="hidden" id="exercicecourant" value="<?php echo $_SESSION['GL_USER']['EXERCICE']; ?>" />
                              ...
                              <input name='id' type='hidden' id="id" value="<?php echo  $idresp; ?>"  /></td>
                          </tr>
                          <tr align="left" valign="top">
                            <td width="200">&nbsp;</td>
