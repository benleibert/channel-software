    ...
    <td width="85%" height="80%" align="left" valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="2">
      <tr>
        <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
          <tr>
            <td width="43"  bgcolor="#FFCC66" class="leftHeader"><?php echo getlang(79); ?></td>
          </tr>
          <tr>
          ...
          <tr>
            <td align="left" valign="top" class="text">
              <p><?php echo getlang(350); ?> </p>
              <ul>
                <li><?php echo getlang(351); ?></li>
                <li><?php echo getlang(352); ?></li>
                <li><?php echo getlang(353); ?></li>
                <li><?php echo getlang(354); ?></li>
