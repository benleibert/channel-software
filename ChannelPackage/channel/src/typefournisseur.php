...
//DOIT MAJ
$droitMAJ = $_SESSION['GL_USER']['DROIT']['par_tfr'];
...
if(isset($_GET['do']) && $_GET['do']=="search") {
	$where ="";
	$_SESSION['WHERE'] ='';
	(isset($_POST['codetypefournisseur']) && $_POST['codetypefournisseur']!='' 	? 	$where .="typefournisseur.CODE_TYPEFOUR LIKE '".addslashes(trim($_POST['codetypefournisseur']))."' AND " 	: $where .="");
	(isset($_POST['typefournisseur']) && $_POST['typefournisseur']!='' 			? 	$where .="typefournisseur.TYPEFOUR_NOM LIKE '".addslashes(trim($_POST['typefournisseur']))."%' AND " 	: $where .="");

	if($where != '')  {$where = substr($where,0, strlen($where)-4);
		$_SESSION['WHERE'] = $where;
	}
	elseif($_SESSION['WHERE'] !='') {$where = $_SESSION['WHERE'];}
	$link ='typefournisseur.php?selectedTab=par&do=search';
	$retour = ligneConTypeFournisseur($where,'','', $page, $_SESSION['GL_USER']['ELEMENT']); //$where, $order, $sens, $page=1, $nelt
}
else {
	$link ='typefournisseur.php?selectedTab=par';
	$retour = ligneConTypeFournisseur('','','', $page, $_SESSION['GL_USER']['ELEMENT']); //$where, $order, $sens, $page=1, $nelt
}
    ...
    <td width="85%" height="80%" align="left" valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="2">
      ...
      <tr>
        <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
		  ...
		  <form name="ListingForm" action="dbtypefournisseur.php" method="POST">
          <tr>
            <td width="43%"><?php echo  sousMenuDroitSansVlider($page='typefournisseur', $tab='par', $droitMAJ); ?></td>
            ...
            <td colspan=3 align="left" valign="top">
                ...
                <table width="100%" border="0" cellpadding="2" cellspacing="1" class="tableBorder">
                  ...
                  <tr class="header2">
                    ...
                    <td width="90%" height="25" align="left" valign="middle" class="header2Bg">&nbsp;&nbsp;<?php echo getlang(173); ?></td>
                   </tr>
                  <!-- Begin Table row -->
                  <?php echo $affichage;?>
                  <!-- End Table row -->
          ...
          <table border="0" align="right" cellpadding="5" cellspacing="0" class="botBorder">
                  <tbody>
                    <tr align="left" valign="top">
                      <td><input name="Enregistrer2" type="button" class="button" id="Enregistrer2"  value='<?php echo getlang(187); ?>'   onclick="OpenBigWin('printlistetypefournisseur.php','');" /></td>
                    </tr>
                  </tbody>
                </table>
            <!-- Fin Affichage -->
