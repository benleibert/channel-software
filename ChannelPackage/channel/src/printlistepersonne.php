...
$libellecde = 'Liste du personnel';
//Ligne
if(isset($_SESSION['WHERE']) && $_SESSION['WHERE']!='') {
	$ligne = ligneEtatListePersonne($_SESSION['WHERE']);
}
else {
$ligne = ligneEtatListePersonne('','','');
}
?>
    ...
    <table width="890" border="0" align="left"  cellpadding="3" cellspacing="1"  class="botBorder">
                              <tbody>
                                <tr align="left" valign="top" nowrap>
                                  <td width="10" align=right valign="middle" class="botBorderTdall"><div align="center"><strong>N&deg;</strong></div></td>
                                  <td width="50" align=right valign="middle" class="botBorderTdall"><div align="center"><strong>N&deg; mlle</strong></div></td>
                                  <td width="150" align=right valign="middle" class="botBorderTdall"><div align="left"><strong><?php echo getlang(103); ?> et pr&eacute;noms</strong> </div></td>
                                  <td width="120" align=center valign="middle" class="botBorderTdall"><div align="center"><strong><?php echo getlang(151); ?></strong></div></td>
                                  <td width="120" align=center valign="middle" class="botBorderTdall"><div align="center"><strong><?php echo getlang(65); ?></strong></div></td>
                                  <td width="100" align=center valign="middle" class="botBorderTdall"><div align="center"><strong><?php echo getlang(165); ?></strong></div></td>

                                 
                                  <td width="160" align=center valign="middle" class="botBorderTdall"><div align="center"><strong><?php echo getlang(51); ?></strong></div></td>
							    </tr>
                                <?php echo $ligne; ?>
        </tbody>
      </table>
