...
function validateForm(){
	...
	produit = trimAll(document.formadd.produit.options[document.formadd.produit.selectedIndex].value);
...
function fillCatProduit(){
	...
	xhr.onreadystatechange = function(){
		...
		if(xhr.readyState == 4 && xhr.status == 200){
			retour = xhr.responseText;
			// On se sert de innerHTML pour rajouter les options a la liste
			document.getElementById('produit').innerHTML = retour;
		}
	}
...
function fillSousCatProduitFiche(){
	var xhr = getXhr();
	// On défini ce qu'on va faire quand on aura la réponse
	xhr.onreadystatechange = function(){
		// On ne fait quelque chose que si on a tout reéu et que le serveur est ok
	...
	// Ici on va voir comment faire du post
	xhr.open("POST","dbetat.php?do=fillSousCatProduitFiche",true);
	// ne pas oublier éa pour le post
	xhr.setRequestHeader('Content-Type','application/x-www-form-urlencoded');
	// ne pas oublier de poster les arguments
	// ici, l'id de l'auteur
        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="2">
          <tr>
            <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
              <tr>
                <td width="43" bgcolor="#FFCC66" class="leftHeader"><?php echo getlang(413); ?></td>
              </tr>
              <tr>
                <td colspan="2" align="left" valign="top"><form action="dbetat.php?do=fichestock" method="post" name="formadd" id="formadd">
                  <table width="100%" border="0" cellpadding="5" cellspacing="0" class="tableBorder">
                    <tr class="header2Bg">
                      <td align="left" valign="top" class="boldText" ><?php echo getlang(414); ?></td>
                    </tr>
                    <tr>
                      <td class="text" align="center"><table width="600" border="0" align="left" cellpadding="5" cellspacing="0" class="botBorder">
                        <tbody>
                          <tr align="left" valign="top">
                            <td width="254" align="right" valign="middle" class="text"><?php echo getlang(62); ?> : </td>
                            <td width="326" align="left" class="text"><select name="xexercice" id="xexercice" class="formStyle" readonly="readonly"  disabled="disabled">
                          ...
                          <tr align="left" valign="top">
                            ...
                            <td align="left" class="text"><input name="datedebut" type="text" class="formStyle" id="datepicker3" value="<?php echo $_SESSION['GL_USER']['DEBUT_EXERCICE']; ?>" /> <span class="mandatory">*</span></td>
                          </tr>
                          <tr align="left" valign="top">
                            <td align="left" class="text"><input name="datefin" type="text" class="formStyle" id="datepicker2" value="<?php echo date('d/m/Y'); ?>" /> <span class="mandatory">*</span></td>
                          </tr>
                          <tr align="left" valign="top">
                            <td align="right" valign="middle" class="text"><?php echo getlang(20); ?> : </td>
                            <td align="left" class="text"><select name="categorie" id="categorie" class="formStyle" onchange="fillSousCat(); fillSousCatProduitFiche();">
                              <option value="0"></option>
                          ...
                          <tr align="left" valign="top">
                            ...
                            <td align="left" class="text"><select name="souscategorie" id="souscategorie" class="formStyle" onchange="fillSousCatProduitFiche();">
                              <option value="0"></option>
                            </select> <span class="mandatory">*</span></td>
                          </tr>
                          <tr align="left" valign="top">
                            ...
                            <td align="left" class="text"><div id="listearticle">
                              <select name="produit" id="produit" class="formStyle">
                                 <option value="0"></option>
                          ...
                          <tr align="left" valign="top">
                            <td width="254"><input name='debutexercice' type='hidden' id="debutexercice" value="<?php echo $_SESSION['GL_USER']['DEBUT_EXERCICE']; ?>" />
