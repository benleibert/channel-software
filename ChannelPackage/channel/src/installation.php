    ...
    <td width="85%" height="80%" align="left" valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="2">
      <tr>
        <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
          <tr>
            <td width="43"  bgcolor="#FFCC66" class="leftHeader">Aide de Stock Pro v1.0 &rarr; Installation</td>
          </tr>
          <tr>
      ...
      <tr>
        <td><ul>
          <li>Pour disposer très rapidement d&rsquo;un serveur web  sous Windows, télécharger et installer «&nbsp;WampServer&nbsp;» disponible sur  le site <a href="http://www.wampserver.com/" target="_blank">http://www.wampserver.com/</a> Sous  un ordinateur Linux cet environnement est installé par défaut</li>
          <li>Installer la base de données de «&nbsp;Kibsa&nbsp;»  à l&rsquo;aide de l&rsquo;outil PhpMyAdmin</li>
          <li>Copier le logiciel dans le répertoire racine de  votre serveur web généralement «&nbsp;www&nbsp;» et l&rsquo;installation est terminer</li>
        </ul><p>&nbsp;</p></td>
      </tr>
    </table>
          <!-- Fin Affichage -->
