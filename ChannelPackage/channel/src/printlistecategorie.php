...
$libellecde = getlang(382); //'Liste des catégories';
//Ligne
if(isset($_SESSION['WHERE']) && $_SESSION['WHERE']!='') {
	$ligne = ligneEtatListeCategorie($_SESSION['WHERE']);
}
else {
$ligne = ligneEtatListeCategorie('');
}
?>
    ...
    <table width="890" border="0" align="left"  cellpadding="3" cellspacing="1"  class="botBorder">
                              <tbody>
                                <tr align="left" valign="top" nowrap>
                                  ...
                                  <td width="400" align=right valign="middle" class="botBorderTdall"><div align="left"><strong><?php echo getlang(357); ?> cat&eacute;gorie</strong> </div></td>
                                </tr>
                                <?php echo $ligne; ?>
        </tbody>
      </table>
