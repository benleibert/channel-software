...
function validateForm(){
	...
	var datecommande1 	= trimAll(document.formadd.datecommande1.value);
	...
	var codecommande 	= trimAll(document.formadd.codecommande.value);
	var msg = '';
		
	if( datecommande == "" && datecommande1=='' && codecommande=='' && libellecde=='' && fournisseur=='0' && document.formadd.statut.checked==false) {
        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="2">
          <tr>
            <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
              <tr>
                <td width="43" bgcolor="#FFCC66" class="leftHeader"><?php echo getlang(244); ?> -> <?php echo getlang(36); ?></td>
              </tr>
              <tr>
                <td colspan="2" align="left" valign="top"><form action="commande.php?selectedTab=bde&do=search" method="post" name="formadd" id="formadd">
                  <table width="100%" border="0" cellpadding="5" cellspacing="0" class="tableBorder">
                    <tr class="header2Bg">
                      <td align="left" valign="top" class="boldText" >&nbsp;<?php echo getlang(139); ?> <?php echo getlang(36); ?></td>
                    </tr>
                    <tr>
                      <td class="text" align="center"><table width="600" border="0" align="left" cellpadding="5" cellspacing="0" class="botBorder">
                        <tbody>
                          ...
                          <tr align="left" valign="top">
                            <td rowspan="2" align="right" valign="middle" class="text"><?php echo getlang(43); ?> <?php echo getlang(36); ?> :&nbsp;</td>
                            <td align="left" class="text"><input name="datecommande" type="text" class="formStyle" id="datepicker1" /></td>
                          </tr>
                          <tr align="left" valign="top">
                            <td align="left" class="text"><input name="datecommande1" type="text" class="formStyle" id="datepicker2" /></td>
                          </tr>
                          <tr align="left" valign="top">
                            <td align="right" valign="middle" class="text"><?php echo getlang(140); ?> :</td>
                            <td align="left" class="text"><input name="codecommande"  id="codecommande" type="text" class="formStyle" /></td>
                          </tr>
                          <tr align="left" valign="top">
                            <td align="right" valign="middle" class="text"><?php echo getlang(82); ?> :</td>
                            <td align="left" class="text"><input name="libellecde" type="text" class="formStyle" id="libellecde" /></td>
                          </tr>
                          <tr align="left" valign="top">
