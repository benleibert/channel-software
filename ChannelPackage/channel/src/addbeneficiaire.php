...
if($_SESSION['GL_USER']['DROIT']['par_ben']['AJOUT']!=1) header("location:accessinterdit.php?selectedTab=home");
...
function validateForm(){
	   ...
	   var beneficiaire = trimAll(document.formadd.beneficiaire.value);
		...
		if(province == "0") {
        	msg += '- Veuillez sélectionner le magasin d\'affectation.\n';
        }
        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="2">
          <tr>
            <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
              <tr>
                <td height="20" bgcolor="#FFCC66" class="leftHeader"><?php echo getlang(16); ?></td>
              </tr>
              <tr>
                <td colspan="2" align="left" valign="top"><form action="dbbeneficiaire.php?do=add" method="post" name="formadd" id="formadd">
                  <table width="100%" border="0" cellpadding="5" cellspacing="0" class="tableBorder">
                    <tr class="header2Bg">
                      <td align="left" valign="top" class="boldText" ><?php echo getlang(11); ?> <?php echo getlang(16); ?></td>
                    </tr>
                    <tr>
                      <td class="text" align="center"><table width="600" border="0" align="left" cellpadding="5" cellspacing="0" class="botBorder">
                        <tbody>
                          <tr align="left" valign="top">
                            ...
                            <td width="358" align="left" class="text"><input name="codebeneficiaire" type="text" class="formStyle" id="codebeneficiaire" onblur="go();" />
                              <span class="mandatory" id="msg">*</span></td>
                          </tr>
                          <tr align="left" valign="top">
                            <td align="right" valign="middle" class="text"><?php echo getlang(16); ?>&nbsp;:&nbsp;</td>
                            <td align="left" class="text"><input name="beneficiaire" type="text" class="formStyle" id="beneficiaire" />
                              <span class="mandatory">*</span></td>
                          </tr>
                          <tr align="left" valign="top">
                            <td align="right" valign="middle" class="text"><?php echo getlang(452); ?>&nbsp;:&nbsp;</td>
                            <td align="left" class="text"><input name="abbrege" type="text" class="formStyle" id="abbrege" /></td>
                          </tr>
                          <tr align="left" valign="top">
                            ...
                            <td align="left" class="text"><select name="typebeneficiaire" id="typebeneficiaire" class="formStyle">
                              ...
                              <?php echo selectTypeBeneficiaire(); ?>
                              </select>
                              <span class="mandatory"> *</span></td>
                          </tr>
                          <tr align="left" valign="top">
                          ...
                          <tr align="left" valign="top">
                            ...
                            <td align="left" class="text"><input name="ville" type="text" class="formStyle" id="ville" value="" /></td>
                          </tr>
                          <tr align="left" valign="top">
                            <td align="right" valign="middle" class="text"><?php echo getlang(165); ?>&nbsp;:&nbsp;</td>
                            <td align="left" class="text"><input name="tel" type="text" class="formStyle" id="tel" /></td>
                          </tr>
                          <tr align="left" valign="top">
