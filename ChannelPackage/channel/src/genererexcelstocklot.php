...
//Titre de la feuille
$objPHPExcel->getActiveSheet()->setTitle('Etat du stock par lot');
...
//	(isset($data[$i-1]['perime']) && $data[$i-1]['perime']!=0	? $perime 		= $data[$i-1]['perime'] 		: $perime			='');
	...
	$objPHPExcel->setActiveSheetIndex(0)
           ...
           ->setCellValue('B'.$ligne, stripslashes($codeproduit))
            ...
            ->setCellValue('D'.$ligne, stripslashes($reportentree))
			->setCellValue('E'.$ligne, stripslashes($transfertent))
			->setCellValue('F'.$ligne, stripslashes($livraison))
			->setCellValue('G'.$ligne, stripslashes($qteentre))
			->setCellValue('H'.$ligne, stripslashes($reportsortie))
			->setCellValue('I'.$ligne, stripslashes($transfertsort))
