...
//Next link
$urlAlph = "listeprovince.php?lg=$lg&wh=";
//JS code to send data in form
function jscode($lg) {
	$code ='';
		$code .= '<script language="JavaScript"> 
					function pickUp(idArticle,designat){
						window.opener.document.formadd.dependance.value = idArticle;
						window.opener.document.formadd.xdependance.value = designat;
...
<script> writeTableStartTagBasedOnResolution(); </script>
  ...
  <tr>
    ...
    <table width="400" border="0" align="left" cellpadding="1" cellspacing="1">
      <tr>
        <td height="20" colspan="2" class="leftHeader">Liste des d&eacute;coupages GL_USERistratives</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <table width="400" border="0" cellpadding="5" cellspacing="1" class="tableBorder">
          <!-- Begin Table Header -->
          <tr class="header2">
            <td width="32" height="25" align="left" valign="middle" class="header2Bg">Code</td>
            <td width="104" height="25" align="left" valign="middle" class="header2Bg">&nbsp;Localit&eacute;</td>
            <td width="83" height="25" align="center" valign="middle" class="header2Bg" nowrap>Type</td>
			<td width="134" height="25" align="center" valign="middle" class="header2Bg" nowrap>D&eacute;pendance</td>
          </tr>
		  <?php 
		  	(isset($_GET['wh']) ? $wh=$_GET['wh'] : $wh = '');
			echo listeDesProvinces($wh);
			?>
