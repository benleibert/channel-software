...
$libellecde = getlang(393); // 'Liste des types de fournisseurs';
//Ligne
if(isset($_SESSION['WHERE']) && $_SESSION['WHERE']!='') {
	$ligne = ligneEtatTypeBeneficiaire($_SESSION['WHERE']);
}
else {
$ligne = ligneEtatTypeFournisseur('','','');
}
?>
    ...
    <table width="100%" border="0" align="left"  cellpadding="3" cellspacing="1"  class="botBorder">
                              <tbody>
                                <tr align="left" valign="top" nowrap>
                                  ...
                                  <td width="86%" align=left valign="middle" class="botBorderTdall"><div><strong><?php echo getlang(357); ?> <?php echo getlang(175); ?></strong></div></td>
                                </tr>
                                <?php echo $ligne; ?>
        </tbody>
      </table>
