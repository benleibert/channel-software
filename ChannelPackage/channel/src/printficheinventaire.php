...
//Ligne
$ligne = ligneEtatFicheInventaire($nbreLigne,$data);
...
<table width="858" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td>
    <table width="854" border="0" align="left"  cellpadding="3" cellspacing="0"  class="botBorderTdall">
                              <tbody>
                                <tr align="left" valign="top" nowrap>
                                  <td width="21" align=center valign="middle" class="botBorderTdall header2Bg"><strong>N°</strong></td>
                                  <td width="41" align=center valign="middle" class="botBorderTdall header2Bg" nowrap="nowrap"><strong>Code</strong></td>
                                  <td width="316" align=right valign="middle" class="botBorderTdall header2Bg"><div align="left"><strong><?php echo getlang(199); ?></strong> </div></td>
                                  <td width="58" align=center valign="middle" class="botBorderTdall header2Bg"><div align="center"><strong>Réf. Lot</strong></div></td>

                                  <td width="25" align=center valign="middle" class="botBorderTdall header2Bg"><div align="center"><strong><?php echo getlang(204); ?></strong></div></td>
                                  <td width="58" align=center valign="middle" class="botBorderTdall header2Bg" nowrap="nowrap"><div align="center"><strong><?php echo getlang(289); ?></strong></div></td>
								  <td width="58" align=center valign="middle" class="botBorderTdall header2Bg"><div align="center"><strong><?php echo getlang(455); ?></strong></div></td>
								  <td width="227" align=center valign="middle" class="botBorderTdall header2Bg"><div align="center"><strong>Observations</div></td>
                                </tr>
                                <?php echo $ligne; ?>
        </tbody>
      </table>
