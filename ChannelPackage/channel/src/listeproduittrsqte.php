	...
	if($lg != '') {
		$code .= '<script language="JavaScript"> 
					function pickUp(idArticle,designat,unite,qteDispo,prixUnit,prixUnitn2,refLot,Datep,MonLot){
						...
						if(window.opener.document.formadd.prixdistrict.checked==true) {	
							//alert(\'oui\');					
  ...
  <tr>
    ...
    <table width="400" border="0" align="left" cellpadding="1" cellspacing="1">
      ...
      <tr>
        ...
        <table width="514" border="0" cellpadding="5" cellspacing="1" class="tableBorder">
          <!-- Begin Table Header -->
          <tr class="header2">
            ...
            <td width="42" align="center" valign="middle" class="header2Bg">Qté</td>
