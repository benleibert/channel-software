...
$stock = $_SESSION['DATA_ETAT']['STOCK'];

//var_dump($_SESSION['DATA_ETAT']['ligne']);
$affichage = ligneConrapficheproduit($_SESSION['DATA_ETAT']['nbreLigne'],$_SESSION['DATA_ETAT']['ligne']); //$where, $order, $sens, $page=1, $nelt
    ...
    <td width="85%" height="80%" align="left" valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="2">
      <tr>
        <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
          <tr>
            <td width="43"  bgcolor="#FFCC66" class="leftHeader"><?php echo getlang(413); ?> : <?php echo getSiteBénéf($_SESSION['GL_USER']['MAGASIN']); ?></td>
          </tr>
          <tr>
      ...
      <tr>
        <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
            ...
            <tr>
              <td width="43%"><table width="389" border="0" cellpadding="2" cellspacing="1" class="tableBorder">
                <!-- Begin Table Header -->
                <tr class="header2">
                  <td width="87%" align="left" valign="middle" class="header2Bg"  nowrap="nowrap"><?php echo getlang(57); ?> ->  <?php echo $_SESSION['DATA_ETAT']['DATEJ'] ; ?>  -  <?php echo $_SESSION['DATA_ETAT']['DATEF']; ?> </td>
                </tr>
              </table></td>
            ...
            <tr>
              <td colspan=3 align="left" valign="top">
                ...
                <table width="100%" border="0" cellpadding="2" cellspacing="1" class="tableBorder">
                  <!-- Begin Table Header -->
                  <tr class="header2">
                    <td width="5%" align="center" valign="middle" class="header2Bg"  nowrap="nowrap">Réf. Lot</td>
                    <td width="4%" height="25" align="center" valign="middle" class="header2Bg">Code</td>
                    <td width="20%" height="25" align="left" valign="middle" class="header2Bg" nowrap="nowrap"><?php echo getlang(199); ?></td>
                    <td width="10%" align="center" valign="middle" nowrap class="header2Bg"><?php echo getlang(206); ?></td>
                    <td width="6%" align="center" valign="middle" nowrap class="header2Bg"><?php echo getlang(42); ?></td>
                    <td width="8%" align="center" valign="middle" nowrap class="header2Bg"><?php echo getlang(207); ?></td>
                    <td width="8%" align="center" valign="middle" nowrap class="header2Bg"><?php echo getlang(208); ?></td>
                    <td width="8%" align="center" valign="middle" nowrap class="header2Bg">Stock</td>
                    <td width="3%" align="center" valign="middle" nowrap class="header2Bg"><?php echo getlang(204); ?> </td>
                    <td width="8%" align="center" valign="middle" nowrap class="header2Bg"><?php echo getlang(226); ?></td>
                    </tr>
                  <!-- Begin Table row -->
                  <?php echo $affichage;?>
                  <!-- End Table row -->
          ...
          <table border="0" align="right" cellpadding="5" cellspacing="0" class="botBorder">
            <tbody>
              <tr align="left" valign="top">
                <td align="right"><input name="Enregistrer2" type="button" class="button" id="Enregistrer2"  value='<?php echo getlang(187); ?>'  onClick="OpenBigWin('printetatrapficheproduit.php','');" /></td>
                <td align="right"><span class="leftHeader">
                  <input name="Enregistrer3" type="button" class="button" id="Enregistrer3"  value='<?php echo getlang(188); ?>'   onclick="OpenWin('genererexcelrapficheproduit.php','Fichier Excel');" />
                  </span></td>
                </tr>
              </tbody>
          </table>       </td> </tr>
