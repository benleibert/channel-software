...
function ligneConEtatStock($nbre=1, $data=array()){
	...
	for ($i=1; $i <= $nbre; $i++){
		...
		<tr align="left" valign="middle" class="'.$col.'">
            ...
            <td class="text" align="center">'.(stripslashes($unite)).'</td>
        </tr>';
	}
	return $ret;
}
...
function ligneConEtatStockLot($nbre=1, $data=array()){
	...
	for ($i=1; $i <= $nbre; $i++){
		...
		<tr align="left" valign="middle" class="'.$col.'">
			...
			<td class="text" align="right" >'.(stripslashes($transfertsort)).'&nbsp;</td>
			<td class="text" align="right" >'.(stripslashes($bonsortie)).'&nbsp;</td>
			<td class="text" align="right" >'.(stripslashes($perte)).'&nbsp;</td>
			<td class="text" align="right" >'.(stripslashes($declass)).'&nbsp;</td>
			<td class="text" align="right">'.(stripslashes($qtesortie)).'&nbsp;</td>
			<td class="text" align="right">'.(stripslashes($qteperime)).'&nbsp;</td>
            <td class="text" align="right">'.(stripslashes($ecart)).'&nbsp;</td>
...
function ligneConraprupture($nbre=1, $data=array()){
	...
	for ($i=1; $i <= $nbre; $i++){
		...
		<tr align="left" valign="middle" class="'.$col.'">
			<td class="text" align="center" nowrap="nowrap">'.stripslashes($codeproduit).'&nbsp;</td>
			<td class="text" align="left" nowrap="nowrap">'.stripslashes($produit).'&nbsp;</td>
			<td class="text" align="center">'.stripslashes($jour).'&nbsp;</td>
			<td class="text" align="center">'.stripslashes($semaine).'&nbsp;</td>
            <td class="text" align="center">'.stripslashes($mois).'</td>
        </tr>';
	}
	return $ret;
}
...
function ligneConrapsortiemensuelle($nbre=1, $data=array()){
	...
	for ($i=1; $i <= $nbre; $i++){
		...
		<tr align="left" valign="middle" class="'.$col.'">
			...
			<td class="text" align="center" nowrap="nowrap">'.stripslashes($codeproduit).'&nbsp;</td>
			<td class="text" align="left" nowrap="nowrap">'.stripslashes($produit).'&nbsp;</td>
			<td class="text" align="center">'.stripslashes($qtesortie12).'&nbsp;</td>
            <td class="text" align="center">'.stripslashes($qtesortie6).'</td>
			<td class="text" align="center">'.stripslashes($qtesortie3).'&nbsp;</td>
       </tr>';
	}
	return $ret;
}
...
function ligneConRapportMensuel($nbre=1, $data=array()){
	...
	for ($i=1; $i <= $nbre; $i++){
		...
		<tr align="left" valign="middle" class="'.$col.'">
			...
			<td class="text" align="right">'.(stripslashes($Pperte)).'&nbsp;</td>
...
function ligneEtatprdcommande($nbre=1, $data=array()){
	...
	for ($i=1; $i <= $nbre; $i++){
		...
		<tr align="left" valign="middle">
            ...
            <td class="botBorderTdall" align="center" >'.(stripslashes($codeproduit)).'</td>
	        <td class="botBorderTdall" >'.(stripslashes($produit)).'&nbsp;</td>
			<td class="botBorderTdall" align="center" >'.(stripslashes($stock)).'&nbsp;</td>
            <td class="botBorderTdall" align="center" >'.(stripslashes($Amin)).'&nbsp;</td>
            <td class="botBorderTdall" align="right" >'.(stripslashes($Amax)).'&nbsp;</td>
            <td class="botBorderTdall" align="center" >'.(stripslashes($Acmm)).'&nbsp;</td>
...
function ligneEtatStock($nbre=1, $data=array()){
	...
	for ($i=1; $i <= $nbre; $i++){
		...
		<tr align="left" valign="middle" class="'.$col.'">
			...
			<td class="botBorderTdall" align="right" >'.(stripslashes($perte)).'&nbsp;</td>
			...
			<td class="botBorderTdall" align="right">'.(stripslashes($ecart)).'&nbsp;</td>
...
function ligneEtatrapsyntheseinventaire($nbre=1, $data=array()){
	...
	for ($i=1; $i <= $nbre; $i++){
		...
		<tr align="left" valign="middle" class="'.$col.'">
			...
			<td class="botBorderTdall" align="left" >'.(stripslashes($codeproduit)).'&nbsp;</td>
			<td class="botBorderTdall" align="left" >'.(stripslashes($produit)).'&nbsp;</td>
			<td class="botBorderTdall" align="center" >'.(stripslashes($qteentree)).'&nbsp;</td>
			<td class="botBorderTdall" align="center">'.(stripslashes($qtesortie)).'&nbsp;</td>
   			<td class="botBorderTdall" align="right" >'.(stripslashes($qteperime)).'&nbsp;</td>
			<td class="botBorderTdall" align="right">'.(stripslashes($stocks)).'&nbsp;</td>
...
function ligneEtatrapsortiemensuelle($nbre=1, $data=array()){
	...
	for ($i=1; $i <= $nbre; $i++){
		...
		<tr align="left" valign="middle" class="'.$col.'">
			...
			<td class="botBorderTdall" align="left" >'.(stripslashes($codeproduit)).'&nbsp;</td>
			<td class="botBorderTdall" align="left" >'.(stripslashes($produit)).'&nbsp;</td>
			<td class="botBorderTdall" align="center" >'.(stripslashes($qtesortie12)).'&nbsp;</td>
			<td class="botBorderTdall" align="center">'.(stripslashes($qtesortie6)).'&nbsp;</td>
   			<td class="botBorderTdall" align="center" >'.(stripslashes($qtesortie3)).'&nbsp;</td>
        </tr>';
	}
	return $ret;
}
...
function ligneEtatraprupture($nbre=1, $data=array()){
	...
	for ($i=1; $i <= $nbre; $i++){
		...
		<tr align="left" valign="middle" class="'.$col.'">
			...
			<td class="botBorderTdall" align="left" >'.(stripslashes($codeproduit)).'&nbsp;</td>
			<td class="botBorderTdall" align="left" >'.(stripslashes($produit)).'&nbsp;</td>
   			<td class="botBorderTdall" align="center" >'.(stripslashes($jour)).'&nbsp;</td>
			<td class="botBorderTdall" align="center">'.(stripslashes($semaine)).'&nbsp;</td>
   			<td class="botBorderTdall" align="center" >'.(stripslashes($mois)).'&nbsp;</td>
        </tr>';
	}
	return $ret;
}
...
function ligneEtatStockLot($nbre=1, $data=array()){
	...
	for ($i=1; $i <= $nbre; $i++){
		...
		<tr align="left" valign="middle" class="'.$col.'">
			...
			<td class="botBorderTdall" nowrap="nowrap">'.stripslashes($reflot).'&nbsp;</td>
			<td class="botBorderTdall" nowrap="nowrap">'.stripslashes($produit).'&nbsp;</td>
			<td class="botBorderTdall" align="center" >'.stripslashes($reportentree).'&nbsp;</td>
			<td class="botBorderTdall" align="center" >'.stripslashes($transfertent).'&nbsp;</td>
			<td class="botBorderTdall" align="center" >'.stripslashes($livraison).'&nbsp;</td>
			<td class="botBorderTdall" align="center">'.stripslashes($qteentre).'&nbsp;</td>

            <td class="botBorderTdall" align="center" >'.(stripslashes($reportsortie)).'&nbsp;</td>
			<td class="botBorderTdall" align="center" >'.(stripslashes($transfertsort)).'&nbsp;</td>
			<td class="botBorderTdall" align="center" >'.(stripslashes($bonsortie)).'&nbsp;</td>
			<td class="botBorderTdall" align="center" >'.(stripslashes($perte)).'&nbsp;</td>
			<td class="botBorderTdall" align="center" >'.(stripslashes($declass)).'&nbsp;</td>
			<td class="botBorderTdall" align="center">'.(stripslashes($qtesortie)).'&nbsp;</td>

			<td class="botBorderTdall" align="center">'.(stripslashes($qteperime)).'&nbsp;</td>
			<td class="botBorderTdall" align="center">'.(stripslashes($ecart)).'&nbsp;</td>

            <td class="botBorderTdall" align="center">'.(stripslashes($stocks)).'&nbsp;</td>
            <td class="botBorderTdall" align="center">'.(stripslashes($unite)).'</td>
        </tr>';	}
	return $ret;
}
