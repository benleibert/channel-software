...
function validateForm(){
        var codegrpservice = trimAll(document.formadd.codegrpservice.value);
		var grpservice = trimAll(document.formadd.grpservice.value);
		var dependance = trimAll(document.formadd.dependance.options[document.formadd.dependance.selectedIndex].value);
		var msg = '';
		
		if(codegrpservice == '' && grpservice=='' && dependance=='0') {
        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="2">
          <tr>
            <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
              <tr>
                <td width="43" bgcolor="#FFCC66" class="leftHeader"><?php echo getlang(106); ?> &rarr; Les types de service</td>
              </tr>
              <tr>
                <td colspan="2" align="left" valign="top"><form action="grpservice.php?selectedTab=par&amp;do=search" method="post" name="formadd" id="formadd">
                  <table width="100%" border="0" cellpadding="5" cellspacing="0" class="tableBorder">
                    <tr class="header2Bg">
                      <td align="left" valign="top" class="boldText" >&nbsp;<?php echo getlang(139); ?> un type de service</td>
                    </tr>
                    <tr>
                      <td class="text" align="center"><table width="600" border="0" align="left" cellpadding="5" cellspacing="0" class="botBorder">
                        <tbody>
                          <tr align="left" valign="top">
                            <td width="200" align="right" valign="middle" class="text">Code type service&nbsp;:&nbsp;</td>
                            <td width="358" align="left" class="text"><input name="codegrpservice" type="text" class="formStyle" id="codegrpservice"  /></td>
                          </tr>
                          <tr align="left" valign="top">
                            <td width="200" align="right" valign="middle" class="text">Libell&eacute; type service&nbsp;:&nbsp;</td>
                            <td align="left" class="text"><input name="grpservice" type="text" class="formStyle" id="grpservice" /></td>
                          </tr>
                          <tr align="left" valign="top">
