...
(isset($_SESSION['DATA_ETAT']['DATEJ']) 		? $libelle 	= $libel.$_SESSION['DATA_ETAT']['DATEJ']: $libelle ='');
...
//Ligne
$ligne = ligneEtatJournal($nbreLigne,$data);
    ...
    <table width="723" border="0" align="left"  cellpadding="3" cellspacing="0"  class="botBorderTdall">
                              <tbody>
                                <tr align="left" valign="top" nowrap>
                                  ...
                                  <td width="10" align=right valign="middle" class="botBorderTdall header2Bg"><div align="left"><strong><?php echo getlang(54); ?></strong></div></td>
                                  ...
                                  <td width="48" align=center valign="middle" class="botBorderTdall header2Bg"><div align="center"><strong><?php echo getlang(305); ?></strong></div></td>
