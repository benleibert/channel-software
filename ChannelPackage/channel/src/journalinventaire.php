...
//Data
(isset($_SESSION['DATA_INV']['xid']) 		? $xid 	= $_SESSION['DATA_INV']['xid']: $xid ='');
...
(isset($_SESSION['DATA_INV']['statut']) 	? $statut = $_SESSION['DATA_INV']['statut']: $statut ='');
...
(isset($_SESSION['DATA_INV']['nbreLigne2']) 		? $nbreLigne2 	= $_SESSION['DATA_INV']['nbreLigne2']: $nbreLigne2 ='');

(isset($_SESSION['DATA_INV']['ligne']) ? $data= $_SESSION['DATA_INV']['ligne'] : $data=array());

//var_dump($_SESSION['DATA_INV']['journal']);
(isset($_SESSION['DATA_INV']['journal']) ? $data2= $_SESSION['DATA_INV']['journal'] : $data2=array());
//Ligne
$ligne = lignedetailInventaire($nbreLigne,$statut, $data);

$Journal = lignejournalInventaire($nbreLigne2,$data2);

//Annulation
$Annuler = sousMenuAnnuler($statut , $tab='int', $droitMAJ);
?>
...
function go(){
	if(document.getElementById('refinventaire').value != document.getElementById('oldrefinventaire').value){
	var xhr = getXhr();
        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="2">
          <tr>
            <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
              ...
              <tr>
                <td colspan="2" align="left" valign="top"><form action="dbinventaire.php" method="post" name="formadd" id="formadd">
                  <table width="100%" border="0" cellpadding="5" cellspacing="0" class="tableBorder">
                    <tr class="header2Bg">
                      <td align="left" valign="top" class="boldText" ><?php echo getlang(440); ?>  <?php echo getlang(298); ?></td>
                    </tr>
                    <tr>
                      <td class="text" align="center"><table width="600" border="0" align="left" cellpadding="5" cellspacing="0" class="botBorder">
                        <tbody>
                          ...
                          <tr align="left" valign="top">
                            ...
                            <td align="left" class="text"><input name="dateinventaire" type="text" class="formStyle" id="datepicker1" value="<?php echo $dateinventaire; ?>" /></td>
                          </tr>
                          <tr align="left" valign="top">
                          ...
                          <tr align="left" valign="top">
                            ...
                            <td align="left" class="text"><input name="inventaire" type="text" class="formStyle" id="inventaire" value="<?php echo $inventaire; ?>" /></td>
                          </tr>
                          <!--
                          <tr align="left" valign="top">
                          ...
                          -->
                          <tr>
                            <td align="right" valign="middle" class="text"><?php echo getlang(298); ?>  <?php echo getlang(180); ?></td>
                            <td align="left" class="text"><input name="statut" type="checkbox" id="statut" value="1" <?php echo  $checked; ?> disabled /></td>
                          </tr>
                        </tbody>
                      </table></td>
                    </tr>
                          ...
                          <td align="left" valign="top" class="text"><table width="623" border="0" align="left" cellpadding="5" cellspacing="0" class="botBorder">
                            <tbody>
                              <tr align="left" valign="top" nowrap="nowrap">
                                ...
                                <td width="64" align="right" valign="middle" nowrap="nowrap" class="text"><div align="center">Réf. lot </div></td>
                                <td width="264" align="right" valign="middle" class="text"><div align="left"><?php echo getlang(199); ?></div></td>
                                <td width="48" align="center" valign="middle" class="text" nowrap="nowrap"><div align="center"><?php echo getlang(288); ?></div></td>
                                <td width="48" align="center" valign="middle" class="text"><div align="center"><?php echo getlang(289); ?></div></td>
                                <td width="48" align="center" valign="middle" class="text"><div align="center"><?php echo getlang(455); ?></div></td>
                                <td width="48" align="center" valign="middle" class="text"><div align="center"><?php echo getlang(204); ?></div></td>
                                </tr>
                              <tr align="left" valign="middle">
                                <td colspan="9" class="text" nowrap="nowrap"><?php echo $ligne ; ?></td>
                                </tr>
                              <tr>
                              ...
                              <tr align="left" valign="top">
                                <td width="4">&nbsp;</td>
                                <td colspan="8"><!-- <input name="Precedent" type="button" class="button" id="Precedent"  value='&lt;&lt; Pr&eacute;c&eacute;dent' onClick="javascript:window.location.href='addBonentree.php?selectedTab=inputs';"> -->
                                  <input name="AjouterLign" type="button" class="button" id="AjouterLign"  value='<?php echo getlang(187); ?>' onclick="OpenBigWin('printinventaire.php','');" />
                                  <?php echo $Annuler; ?></td>
                                </tr>
                              </tbody>
                          </table></td>
