...
$libellecde = getlang(383); //'Liste des sous-catégories';
//Ligne
if(isset($_SESSION['WHERE']) && $_SESSION['WHERE']!='') {
	$ligne = ligneEtatListeSousCategorie($_SESSION['WHERE']);
}
else {
$ligne = ligneEtatListeSousCategorie('');
}
?>
...
<table width="700" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <tr>
    <td>
    <table width="800" border="0" align="left"  cellpadding="3" cellspacing="1"  class="botBorder">
                              <tbody>
                                <tr align="left" valign="top" nowrap>
                                  <td width="10" align=right valign="middle" class="botBorderTdall"><div align="center"><strong>N&deg;</strong></div></td>
                                  <td width="50" align=right valign="middle" class="botBorderTdall"nowrap="nowrap"><div align="center"><strong>Code</strong></div></td>
                                  <td width="200" align=right valign="middle" class="botBorderTdall"><div align="left"><strong><?php echo getlang(357); ?> <?php echo getlang(19); ?></strong> </div></td>
                                  <td width="50" align=right valign="middle" class="botBorderTdall" nowrap="nowrap"><div align="center"><strong>Code <?php echo getlang(157); ?></strong></div></td>
                                  <td width="200" align=right valign="middle" class="botBorderTdall"><div align="left"><strong><?php echo getlang(357); ?> <?php echo getlang(159); ?></strong></div></td>
