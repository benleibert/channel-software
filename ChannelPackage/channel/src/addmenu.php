...
if($_SESSION['GL_USER']['DROIT']['par_men']['AJOUT']!=1) header("location:accessinterdit.php?selectedTab=home");
...
<table width="100%" height="80%"  border="0" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="85%" align="left" valign="top"><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
      ...
      <tr>
        <td colspan="2" align="left" valign="top"><form action="dbmenu.php?do=add" method="post" name="formadd" id="formadd">
          <table width="100%" border="0" cellpadding="5" cellspacing="0" class="tableBorder">
            <tr class="header2Bg">
              <td align="left" valign="top" class="boldText" ><?php echo getlang(11); ?> menu</td>
            </tr>
            <tr>
              <td class="text" align="center"><table width="100%" border="0" align="left" cellpadding="5" cellspacing="0" class="botBorder">
                <tbody>
                  <tr align="left" valign="top">
                    ...
                    <td width="358" align="left" class="text"><input name="codemenu" type="text" class="formStyle" id="codefonc" onblur="go();" />
                      <span class="mandatory" id="msg"></span><span class="mandatory">*</span></td>
                  </tr>
                  <tr align="left" valign="top">
                    <td width="30%" align="right" valign="middle" class="text">Menu&nbsp;:&nbsp;</td>
                    <td align="left" class="text"><input name="libmenu" type="text" class="formStyle" id="libfonc" />
