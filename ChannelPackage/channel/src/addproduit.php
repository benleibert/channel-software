...
if($_SESSION['GL_USER']['DROIT']['par_prd']['AJOUT']!=1) header("location:accessinterdit.php?selectedTab=home");
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td width="505" height="20" valign="top"><?php echo $menu['Top']; ?></td>
    <td width="635" align="right"><?php echo LOGOUT; ?>&nbsp;</td>
  </tr>
</table>
    </td>
</tr>
        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="2">
          <tr>
            <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
              <tr>
                <td height="20" bgcolor="#FFCC66" class="leftHeader"><?php echo getlang(106); ?> -> <?php echo getlang(119); ?></td>
              </tr>
              <tr>
                <td colspan="2" align="left" valign="top"><form action="dbproduit.php?do=add" method="post" name="formadd" id="formadd">
                  <table width="100%" border="0" cellpadding="5" cellspacing="0" class="tableBorder">
                    <tr class="header2Bg">
                      <td align="left" valign="top" class="boldText" ><?php echo getlang(11); ?></td>
                    </tr>
                    <tr>
                      <td class="text" align="center"><table width="600" border="0" align="left" cellpadding="5" cellspacing="0" class="botBorder">
                        <tbody>
                          <tr align="left" valign="top">
                            ...
                            <td width="358" align="left" class="text"><input name="codeproduit" type="text" class="formStyle" id="codeproduit" onblur="go();" />
                          ...
                          <tr align="left" valign="top">
                            ...
                            <td align="left" class="text"><select name="sousgroupe" id="sousgroupe" class="formStyle" >
                              <option value="0"></option>
                              <?php echo selectsousGroupe(); ?>
                            </select></td>
                          </tr>
                          <tr align="left" valign="top">
                            <td align="right" valign="middle" class="text"><?php echo getlang(199); ?>&nbsp;:&nbsp;</td>
                            <td align="left" class="text"><input name="produit" type="text" class="formStyle" id="nomCategorie3" />
                              <span class="mandatory">*</span></td>
                          </tr>
                          <tr align="left" valign="top">
                            <td align="right" valign="middle" class="text">Description&nbsp;:&nbsp;</td>
                            <td align="left" class="text"><input name="description" type="text" class="formStyle" id="description"  /></td>
                          </tr>
                          <tr align="left" valign="top">
                          ...
                          <tr align="left" valign="top">
                            ...
                            <td align="left" class="text"><input name="seuilmin" type="text" class="formStyle" id="seuilmin" /> <span class="mandatory">*</span></td>
                          </tr>
                          <tr align="left" valign="top">
                            <td align="right" valign="middle" class="text"><?php echo getlang(261); ?>&nbsp;:&nbsp;</td>
                            <td align="left" class="text"><input name="seuilmax" type="text" class="formStyle" id="seuilmax"  /> <span class="mandatory">*</span></td>
                          </tr>
                          <tr align="left" valign="top">
                            <td align="right" valign="middle" class="text"><?php echo getlang(221); ?>&nbsp;:&nbsp;</td>
                            <td align="left" class="text"><input name="prixachat" type="text" class="formStyle" id="prixachat" /></td>
                          </tr>
                          <tr align="left" valign="top">
                            <td align="right" valign="middle" class="text"><?php echo getlang(262); ?>&nbsp;:&nbsp;</td>
                            <td align="left" class="text"><input name="prixrevient" type="text" class="formStyle" id="prixrevient" /></td>
                          </tr>
                          <tr align="left" valign="top">
                            <td align="right" valign="middle" class="text"><?php echo getlang(220); ?>&nbsp;:&nbsp;</td>
                            <td align="left" class="text"><input name="prixvente" type="text" class="formStyle" id="prixvente" /></td>
                          </tr>
                          <!--
                          <tr align="left" valign="top">
                          ...
                          <tr align="left" valign="top">
                            <td align="right" valign="middle" class="text"><?php echo getlang(260); ?>&nbsp;:&nbsp;</td>
                            <td align="left" class="text"><input name="seuilminn2" type="text" class="formStyle" id="seuilmin3" /></td>
                          </tr>
                          <tr align="left" valign="top">
                            <td align="right" valign="middle" class="text"><?php echo getlang(261); ?>&nbsp;:&nbsp;</td>
                            <td align="left" class="text"><input name="seuilmaxn2" type="text" class="formStyle" id="seuilmax3" /></td>
                          </tr>
                          <tr align="left" valign="top">
                            <td align="right" valign="middle" class="text"><?php echo getlang(221); ?>&nbsp;:&nbsp;</td>
                            <td align="left" class="text"><input name="prixachatn2" type="text" class="formStyle" id="prixachatn2" /></td>
                          </tr>
                          <tr align="left" valign="top">
                            <td align="right" valign="middle" class="text"><?php echo getlang(262); ?>&nbsp;:&nbsp;</td>
                            <td align="left" class="text"><input name="prixrevientn2" type="text" class="formStyle" id="prixrevientn2"  /></td>
                          </tr>
                          <tr align="left" valign="top">
                            <td align="right" valign="middle" class="text"><?php echo getlang(220); ?>&nbsp;:&nbsp;</td>
                            <td align="left" class="text"><input name="prixventen2" type="text" class="formStyle" id="prixventen2"  /></td>
                          </tr>
                          <tr align="left" valign="top">
                            <td align="right" valign="middle" class="text"><?php echo getlang(116); ?> <?php echo getlang(384); ?>&nbsp;:&nbsp;</td>
                            <td align="left" class="text"><input name="traceur" type="checkbox" id="traceur" value="TRACEUR" />
                              <label for="condionne2"></label>
                              <span class="mandatory"></span></td>
                          </tr>
                          <tr>
                            <td>&nbsp;</td>
