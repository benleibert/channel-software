...
if(isset($_GET['do']) && $_GET['do']=="search") {
	$where ="";
	(isset($_POST['grplocalite']) && $_POST['grplocalite']!='0' 	? 	$where .="localite.ID_GRPLOC LIKE '".addslashes(trim($_POST['grplocalite']))."' AND " 	: $where .="");
	(isset($_POST['localite']) && $_POST['localite']!='' 	? 	$where .="localite.LOC_NOM LIKE '".addslashes(trim($_POST['localite']))."%' AND " 	: $where .="");
	
	if($where != '')  {$where = substr($where,0, strlen($where)-4);
		$_SESSION['WHERE'] = $where;
	}
	elseif($_SESSION['WHERE'] !='') {$where = $_SESSION['WHERE'];}
	$link ='localite.php?selectedTab=par&do=search';
	$retour = ligneConLocalite($where,'','', $page, $_SESSION['GL_USER']['ELEMENT']); //$where, $order, $sens, $page=1, $nelt
}
else {
	$link ='localite.php?selectedTab=par';
	$retour = ligneConLocalite('','','', $page, $_SESSION['GL_USER']['ELEMENT']); //$where, $order, $sens, $page=1, $nelt
}
    ...
    <td width="85%" height="80%" align="left" valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="2">
      <tr>
        <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
          <tr>
            <td width="43"  bgcolor="#FFCC66" class="leftHeader"><?php echo getlang(106); ?> &rarr; Les localités</td>
          </tr>
          <tr>
      ...
      <tr>
        <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
		  ...
		  <form name="ListingForm" action="dblocalite.php" method="POST">
          <tr>
            <td width="43%"><?php echo  sousMenuDroitSansVlider($page='localite', $tab='param', $droitMAJ); ?></td>
          ...
          <tr>
            <td colspan=3 align="left" valign="top">
                ...
                <table width="100%" border="0" cellpadding="2" cellspacing="1" class="tableBorder">
                  ...
                  <tr class="header2">
                    ...
                    <td width="10%" height="25" align="center" valign="middle" class="header2Bg">Code localité</td>
                    <td width="30%" height="25" align="left" valign="middle" class="header2Bg">&nbsp;&nbsp;Nom localité</td>
                    <td width="25%" align="left" valign="middle" class="header2Bg">&nbsp;&nbsp;Type localité</td>
                    <td width="25%" height="25" align="left" valign="middle" class="header2Bg">&nbsp;&nbsp;<?php echo getlang(154); ?></td>
                   </tr>
                  <!-- Begin Table row -->
                  <?php echo $affichage;?>
                  <!-- End Table row -->
            ...
            <tbody>
              <tr align="left" valign="top">
                <td><input name="Enregistrer2" type="button" class="button" id="Enregistrer2"  value='<?php echo getlang(187); ?>'   onClick="OpenBigWin('printlocalite.php','');"></td>
                </tr>
            </tbody>
          </table>
            <!-- Fin Affichage -->
