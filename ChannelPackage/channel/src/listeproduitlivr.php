	...
	if($lg != '') {
		$code .= '<script language="JavaScript"> 
					function pickUp(idArticle,designat,unite,prixUnit){
						...
						if(parseFloat(window.opener.document.formadd.qtelvr'.$lg.'.value)>0 && parseFloat(window.opener.document.formadd.prix'.$lg.'.value)>0) {
						window.opener.document.formadd.total'.$lg.'.value = parseInt(window.opener.document.formadd.qtelvr'.$lg.'.value) * parseFloat(window.opener.document.formadd.prix'.$lg.'.value);
						}
						else {
							window.opener.document.formadd.total'.$lg.'.value =\'\';
						}
						//window.opener.document.formadd.qtelvr'.$lg.'.focus;
						//if(window.opener.document.formadd.qtelvr'.$lg.'.value =="") {window.opener.document.formadd.qtelvr'.$lg.'.value = 1;}
						window.close();
					}
					</script>';
	}
...
<script> writeTableStartTagBasedOnResolution(); </script>
  ...
  <tr>
    ...
    <table width="400" border="0" align="left" cellpadding="1" cellspacing="1">
      <tr>
        <td height="20" colspan="2" class="leftHeader"><?php echo getlang(385); ?></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <table width="400" border="0" cellpadding="5" cellspacing="1" class="tableBorder">
          <!-- Begin Table Header -->
          <tr class="header2">
            <td width="46" height="25" align="left" valign="middle" class="header2Bg">Code</td>
            <td width="63" height="25" align="center" valign="middle" class="header2Bg"><?php echo getlang(221); ?></td>
            <td width="208" height="25" align="left" valign="middle" class="header2Bg"><?php echo getlang(199); ?></td>
            <td width="36" height="25" align="center" valign="middle" class="header2Bg" nowrap="nowrap"><?php echo getlang(204); ?></td>
          </tr>
		  <?php 
		  	(isset($_GET['wh']) ? $wh=$_GET['wh'] : $wh = '');
			echo listeDesProduits($wh);
			?>
