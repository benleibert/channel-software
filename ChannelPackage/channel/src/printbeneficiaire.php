...
(isset($INFO['INF_SIGNATEUR4']) ? $directeur = $INFO['INF_SIGNATEUR4']: $directeur ='');
...
$libelle = getlang(397); // 'Liste des bénéficiaires';
$where =$_SESSION['WHERE'];
$affichage= ligneEtatBeneficiaire($where,'','', '', '');
//$affichage = $T['L'];
//$total = $T['T'];
?>
...
<table width="900" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <tr>
    <td>
    <table width="900" border="0" align="left"  cellpadding="3" cellspacing="1"  class="botBorder">
                              <tbody>
                               
                                <tr align="left" valign="top" nowrap>
                                  <td width="10" align=center valign="middle" class="botBorderTdall"><strong>N°</strong></td>
                                  <td width="10" align=right valign="middle" class="botBorderTdall"><div align="left"><strong>Code</strong></div></td>
                                  <td width="200" align=right valign="middle" class="botBorderTdall"><div align="left"><strong><?php echo getlang(16); ?></strong> </div></td>
                                  <td width="150" align=center valign="middle" class="botBorderTdall"><div align="center"><strong>Type</strong></div></td>
                                  <td width="100" align=center valign="middle" class="botBorderTdall"><div align="center"><strong><?php echo getlang(102); ?> </strong></div></td>
                                  <td width="100" align=center valign="middle" class="botBorderTdall"><div align="center"><strong><?php echo getlang(154); ?> </strong></div></td>
                                </tr>
                                <?php echo $affichage; ?>                                
        </tbody>
      </table>
