...
$libellecde = getlang(403); // 'Liste des exercices budgétaires';
//Ligne
if(isset($_SESSION['WHERE']) && $_SESSION['WHERE']!='') {
	$ligne = ligneEtatExercice($_SESSION['WHERE']);
}
else {
$ligne = ligneEtatExercice('','','');
}
?>
...
<table width="700" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <tr>
    <td>
    <table width="100%" border="0" align="left"  cellpadding="3" cellspacing="1"  class="botBorder">
                              <tbody>
                                <tr align="left" valign="top" nowrap>
                                  <td width="18%" align=right valign="middle" class="botBorderTdall"><div align="center"><strong>Code</strong></div></td>
                                  <td width="30%" align=left valign="middle" class="botBorderTdall"><div><strong><?php echo getlang(62); ?></strong></div></td>
                                  <td width="10%" align=left valign="middle" class="botBorderTdall"><div align="center"><strong><?php echo getlang(398); ?></strong></div></td>
                                  <td width="10%" align=left valign="middle" class="botBorderTdall"><div><strong><?php echo getlang(399); ?></strong></div></td>
                                  <td width="10%" align=left valign="middle" class="botBorderTdall"><div><strong><?php echo getlang(401); ?></strong></div></td>
                                  <td width="10%" align=left valign="middle" class="botBorderTdall"><div><strong><?php echo getlang(400); ?></strong></div></td>
                                  <td width="10%" align=left valign="middle" class="botBorderTdall"><div><strong><?php echo getlang(314); ?></strong></div></td>
                                </tr>
                                <?php echo $ligne; ?>
        </tbody>
      </table>
