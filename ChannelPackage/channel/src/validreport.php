...
if($_SESSION['GL_USER']['DROIT']['bds_rep']['VALID']!=1) header("location:accessinterdit.php?selectedTab=home");
...
$droitMAJ = getDroitMAJ('GRP_REPORT', $_SESSION['GL_USER']['GROUPE']);

//Data
(isset($_SESSION['DATA_REP']['xid']) 		? $xid 	= $_SESSION['DATA_REP']['xid']: $xid ='');(isset($_SESSION['DATA_REP']['exercice']) 		? $exercice 	= $_SESSION['DATA_REP']['exercice']: $exercice ='');
        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="2">
          <tr>
            <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
              ...
              <tr>
                <td colspan="2" align="left" valign="top"><form action="dbreport.php?do=validate" method="post" name="formadd" id="formadd">
                  <table width="100%" border="0" cellpadding="5" cellspacing="0" class="tableBorder">
                    <tr class="header2Bg">
                      <td align="left" valign="top" class="boldText" ><?php echo getlang(180); ?> r un report</td>
                    </tr>
                    <tr>
                      <td class="text" align="center"><table width="600" border="0" align="left" cellpadding="5" cellspacing="0" class="botBorder">
                        <tbody>
                          ...
                          <tr align="left" valign="top">
                            ...
                            <td align="left" class="text"><input name="datereport" type="text" class="formStyle" id="datereport" value="<?php echo $datereport; ?>" readonly="readonly" />
                              <span class="mandatory">*
                          ...
                          <td class="text" align="center"><table width="623" border="0" align="left" cellpadding="5" cellspacing="0" class="botBorder">
                              <tbody>
                                ...
                                <tr align="left" valign="middle">
                                  <td colspan="6" class="text" nowrap="nowrap"><?php echo $ligne ; ?>
								  </td>
                                  </tr>
                              	<tr>
                                <td colspan="6"><input name='myaction' type='hidden' id="myaction">
