...
$libellecde = 'Liste des natures déeclassement';
//Ligne
if(isset($_SESSION['WHERE']) && $_SESSION['WHERE']!='') {
	$ligne = ligneEtatListeNatdeclassement($_SESSION['WHERE']);
}
else {
$ligne = ligneEtatListeNatdeclassement('','','');
}
?>
...
<table width="700" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
                <tr>
                  <td width="100%" width="43" bgcolor="#FFCC66" class="leftHeader"><h2><?php echo (stripslashes($libellecde)); ?></h2></td>
                </tr>
      </table>
    <p>&nbsp;</p>
    <tr>
    ...
    <table width="100%" border="0" align="left"  cellpadding="3" cellspacing="0"  class="botBorderTdall">
                              <tbody>
                                <tr align="left" valign="top" nowrap>
                                  <td width="14%" align=right valign="middle" class="botBorderTdall header2Bg"><div align="center"><strong>Code </strong></div></td>
                                  <td width="86%" align=left valign="middle" class="botBorderTdall header2Bg"><div><strong><?php echo getlang(206); ?> déclassment</strong></div></td>
                                </tr>
                                <?php echo $ligne; ?>
        </tbody>
      </table>
