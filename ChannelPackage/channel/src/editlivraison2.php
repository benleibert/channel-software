        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="2">
          <tr>
            <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
              <tr>
                <td height="20" bgcolor="#FFCC66" class="leftHeader"><?php echo getlang(106); ?> -><?php echo getlang(86); ?></td>
              </tr>
              <tr>
                      ...
                      <td class="text" align="center"><table width="600" border="0" align="left" cellpadding="5" cellspacing="0" class="botBorder">
                        <tbody>
                          ...
                          <tr align="left" valign="top">
                            ...
                            <td align="left" class="text"><input name="datelivraison" type="text" class="formStyle" id="datepicker1" value="<?php echo date($datelivraison); ?>" />
                          ...
                          <tr align="left" valign="top">
                            ...
                            <td align="left" class="text"><input name="fournisseur" type="text" class="formStyle" id="fournisseur" readonly="readonly" value="<?php echo  $fournisseur; ?>"/>
                              ...
                              <input name="commande" type="hidden" class="formStyle"  id="commande" value="<?php echo  $commande; ?>"/></td>
                          </tr>
                          <tr align="left" valign="top">
