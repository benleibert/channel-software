...
function validateForm(){
	...
	var dateentree 	= trimAll(document.formadd.raison.value);
	var raison 	= trimAll(document.formadd.raison.value);
	var codereconditionnement = trimAll(document.formadd.codereconditionnement.value);
	var msg = '';

	if(codereconditionnement == "" && datesortie=='' && dateentree=='' && document.formadd.statut.checked==false) {
...
function go(){
	...
	xhr.send("codereconditionnement="+id);
}
        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="2">
          <tr>
            <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
              ...
              <tr>
                <td colspan="2" align="left" valign="top"><form action="../src/reconditionnement.php?selectedTab=mvt&amp;do=search" method="post" name="formadd" id="formadd">
                  <table width="100%" border="0" cellpadding="5" cellspacing="0" class="tableBorder">
                    <tr class="header2Bg">
                      <td align="left" valign="top" class="boldText" >&nbsp;<?php echo getlang(139); ?> un reconditionnement</td>
                    </tr>
                    <tr>
                      <td class="text" align="center"><table width="600" border="0" align="left" cellpadding="5" cellspacing="0" class="botBorder">
                        <tbody>
                          ...
                          <tr align="left" valign="top">
                            ...
                            <td align="left" class="text"><input name="codereconditionnement" type="text" class="formStyle" id="codereconditionnement" value="" />
                          ...
                          <tr align="left" valign="top">
                            ...
                            <td align="left" class="text"><input name="datesortie" type="text" class="formStyle" id="datepicker1" value="" /></td>
                          </tr>
                          <tr align="left" valign="top">
                            <td align="right" valign="middle" class="text"><?php echo getlang(202); ?>&nbsp;:&nbsp;</td>
                            <td align="left" class="text"><input name="dateentree" type="text" class="formStyle" id="datepicker2" value="" /></td>
                          </tr>
                          <tr>
                            <td align="right" valign="middle" class="text">Reconditionnement  <?php echo getlang(180); ?> :</td>
