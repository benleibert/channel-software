...
if(isset($_GET['do']) && $_GET['do']=="search") {
	$where ="";
	$_SESSION['WHERE']='';
	(isset($_POST['codemenu']) && $_POST['codemenu']!='' 	? 	$where .="menu.IDMENU LIKE '".addslashes(trim($_POST['codemenu']))."%' AND " 	: $where .="");
	(isset($_POST['libmenu']) && $_POST['libmenu']!='' 	? 	$where .="menu.LIBMENU LIKE '".addslashes(trim($_POST['libmenu']))."%' AND " 	: $where .="");
	...
	$link ='menu.php?selectedTab=par&do=search';
	$retour = ligneConMenu($where,'','', $page, $_SESSION['GL_USER']['ELEMENT']); //$where, $order, $sens, $page=1, $nelt
}
else {
	$link ='menu.php?selectedTab=par';
	$retour = ligneConMenu('','','', $page, $_SESSION['GL_USER']['ELEMENT']); //$where, $order, $sens, $page=1, $nelt
}
...
<table width="100%" height="80%"  border="0" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="85%" align="left" valign="top"><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
      <tr>
        <td height="23" class="leftHeader"><?php echo getlang(178); ?> <?php echo getlang(92); ?></td>
      </tr>
      <tr>
        <td align="left" valign="top" height="3"></td>
      </tr>
      <tr>
        <td align="left" valign="top" class="text"><!--  Debut affichage -->
          <table width="100%"  border="0" cellspacing="0" cellpadding="2">
            <tr>
              <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
                <tr>
                  <form action='' method="post" name="pageLengthform" id="pageLengthform">
                    <td colspan="2" align="right"><?php echo getlang(7); ?>
                      <select name="viewLength"class="selectVerySmall" onchange="document.pageLengthform.submit();">
                        <?php echo $pageLengh; ?>
                      </select></td>
                  </form>
                </tr>
                <form action="dbmenu.php" method="post" name="ListingForm" id="ListingForm">
                  <tr>
                    <td width="43%"><?php echo  sousMenuDroitSansVlider($page='menu', $tab='par', $droitMAJ); ?></td>
                    <td nowrap="nowrap" align="right" class="text"><?php echo  $barre; ?></td>
                  </tr>
                  <!-- Data Tbale contener -->
                  <tr>
                    <td colspan="3" align="left" valign="top"><!-- Data Table  -->
                      <table width="100%" border="0" cellpadding="2" cellspacing="1" class="tableBorder">
                        ...
                        <tr class="header2">
                          ...
                          <td width="15%" height="25" align="center" valign="middle" class="header2Bg">Code menu</td>
                          <td width="75%" height="25" align="left" valign="middle" class="header2Bg">&nbsp;&nbsp;Menu</td>
                          </tr>
                        <!-- Begin Table row -->
                        <?php echo $affichage;?>
                        <!-- End Table row -->
