...
function jscode() {
	...
	$code .= '<script language="JavaScript"> 
					function pickUp(idcde,libelle,idfour,fournisseur){
						window.opener.document.formadd.commande.value = idcde;
						window.opener.document.formadd.libcommande.value = libelle;
						window.opener.document.formadd.idfournisseur.value = idfour;
						window.opener.document.formadd.fournisseur.value = fournisseur;		
						window.close();
					}
			</script>';
	return $code;
...
<script> writeTableStartTagBasedOnResolution(); </script>
  ...
  <tr>
    ...
    <table width="400" border="0" align="left" cellpadding="1" cellspacing="1">
      <tr>
        <td height="20" colspan="2" class="leftHeader"><?php echo getlang(361); ?></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <table width="400" border="0" cellpadding="5" cellspacing="1" class="tableBorder">
          <!-- Begin Table Header -->
          <tr class="header2">
            <td width="46" height="25" align="left" valign="middle" class="header2Bg" nowrap="nowrap">Réf. cde</td>
            <td width="63" height="25" align="center" valign="middle" class="header2Bg"><?php echo getlang(44); ?> :</td>
            <td width="208" height="25" align="left" valign="middle" class="header2Bg"><?php echo getlang(82); ?> :</td>
            </tr>
		  <?php 
		  	(isset($_GET['wh']) ? $wh=$_GET['wh'] : $wh = '');
			echo listeDesCdes($wh, $_SESSION['GL_USER']['MAGASIN']);
			?>
