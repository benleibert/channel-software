...
$droitMAJ = getDroitMAJ('GRP_RECONDITIONNEMENT', $_SESSION['GL_USER']['GROUPE']); //PAGE COURANTE
...
function validateForm(){
	var datesortie 	= trimAll(document.formadd.datesortie.value);
	var raison	= trimAll(document.formadd.raison.value);
	var msg = '';

	if( datesortie == "") {
      	msg += '- Veuillez saisir le date sortie.\n';
    }
	if(raison == "") {
...
function go(){
	...
	id = document.getElementById('codereconditionnement').value;
      ...
      <tr>
        ...
        <td width="180" align="left" valign="top"><table width="200" border="0" cellpadding="1" cellspacing="0">
          <tr>
			...
			echo mouvementMenus($selectedTab , $droit);
