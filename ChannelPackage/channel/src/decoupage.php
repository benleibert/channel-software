...
if(isset($_GET['do']) && $_GET['do']=="search") {
	...
	$retour = ligneCondecoupage($where,'','', $page, $_SESSION['GL_USER']['ELEMENT']); //$where, $order, $sens, $page=1, $nelt
}
else {
	$link ='decoupage.php?selectedTab=par';
	$retour = ligneCondecoupage('','','', $page, $_SESSION['GL_USER']['ELEMENT']); //$where, $order, $sens, $page=1, $nelt
}
    ...
    <td width="85%" height="80%" align="left" valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="2">
      <tr>
        <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
          <tr>
            <td width="43"  bgcolor="#FFCC66" class="leftHeader"><?php echo getlang(106); ?> &rarr; Les découpages GL_USERistratives</td>
          </tr>
          <tr>
      ...
      <tr>
        <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
		  ...
		  <form name="ListingForm" action="dbdecoupage.php" method="POST">
          <tr>
            <td width="43%"><?php echo  sousMenuDroitSansVlider($page='decoupage', $tab='param', $droitMAJ); ?></td>
            ...
            <td colspan=3 align="left" valign="top">
                ...
                <table width="100%" border="0" cellpadding="2" cellspacing="1" class="tableBorder">
                  ...
                  <tr class="header2">
                    ...
                    <td width="10%" height="25" align="center" valign="middle" class="header2Bg">Code decoupage</td>
                    <td width="30%" height="25" align="left" valign="middle" class="header2Bg">&nbsp;&nbsp;Nom découpage</td>
                    <td width="25%" align="left" valign="middle" class="header2Bg">&nbsp;&nbsp;Type découpage</td>
                    <td width="25%" height="25" align="left" valign="middle" class="header2Bg">&nbsp;&nbsp;Dépendance</td>
                   </tr>
                  <!-- Begin Table row -->
                  <?php echo $affichage;?>
                  <!-- End Table row -->
