...
if($_SESSION['GL_USER']['DROIT']['par_grp']['MODIF']!=1) header("location:accessinterdit.php?selectedTab=home");
...
//DATA
$id = $_SESSION['DATA_PROF']['IDPROFIL'];
$libprofil = stripslashes($_SESSION['DATA_PROF']['LIBPROFIL']);

//Grp
$ligneDroit = ligneDroitProfil($_SESSION['DATA_PROF_MENU']);
...
function go(){
	if(document.getElementById('codeprofil').value != document.getElementById('id').value){
	var xhr = getXhr();
	...
	xhr.onreadystatechange = function(){
		...
		if(xhr.readyState == 4 && xhr.status == 200){
			...
			if(retour !='') document.getElementById('codeprofil').focus();
		}
	}
...
<table width="100%" height="80%"  border="0" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="85%" align="left" valign="top"><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
      ...
      <tr>
        <td colspan="2" align="left" valign="top"><form action="dbprofil.php?do=update" method="post" name="formadd" id="formadd">
          <table width="100%" border="0" cellpadding="5" cellspacing="0" class="tableBorder">
            <tr class="header2Bg">
              <td align="left" valign="top" class="boldText" ><?php echo getlang(458); ?></td>
            </tr>
            <tr>
              <td class="text" align="center"><table width="600" border="0" align="left" cellpadding="5" cellspacing="0" class="botBorder">
                <tbody>
                  <tr align="left" valign="top">
                    ...
                    <td align="left" class="text"><input name="codeprofil" type="text" class="formStyle" id="codeprofil" onblur="go();"  value='<?php echo $id; ?>' />
                      <span class="mandatory" id="msg"></span><span class="mandatory">*</span></td>
                  </tr>
                  <tr align="left" valign="top">
                    <td width="200" align="right" valign="middle" class="text"><?php echo getlang(84); ?>&nbsp;:&nbsp;</td>
                    <td width="358" align="left" class="text"><input name="libprofil" type="text" class="formStyle" id="libprofil" value='<?php echo $libprofil; ?>' />
            ...
            <tr>
              <td class="text" align="center"><table width="700" border="0" align="left" cellpadding="5" cellspacing="0" class="botBorder">
                ...
                <tr align="left" valign="top">
                  ...
                  <tr align="left" valign="top">
                    <td width="200">&nbsp;</td>
                    <td width="450"><input name="Suivant" type="button" class="button" id="Suivant"  value="<?php echo getlang(190); ?>" onclick="validateForm();" />
