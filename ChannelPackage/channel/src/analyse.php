...
function fillMe(){
	...
	xhr.open("POST","dbetat.php?do=fill",true);
        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="2">
          <tr>
            <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
              ...
              <tr>
                <td colspan="2" align="left" valign="top"><form action="dbetat.php?do=analyse" method="post" name="formadd" id="formadd">
                    ...
                    <tr>
                      <td class="text" align="center"><table width="600" border="0" align="left" cellpadding="5" cellspacing="0" class="botBorder">
                        <tbody>
                          ...
                          <tr align="left" valign="top">
                            <td align="right" valign="middle" class="text">Type de mouvement&nbsp;:&nbsp;</td>
                            <td align="left" class="text"><select name="typemouvement" id="typemouvement" class="formStyle">
                              <option value="0"></option>
                              <?php echo selectAnalyse(); ?>
                              </select></td>
                          </tr>
                         <!--
                          <tr align="left" valign="top">
