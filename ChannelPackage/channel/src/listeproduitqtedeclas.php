...
//echo $_SESSION['GL_USER']['JOUR'];

//Number of ligne
(isset($_GET['lg']) ? $lg = $_GET['lg']: $lg ='');

//Next link
$urlAlph = "listeproduitqtedeclas.php?lg=$lg&wh=";
...
function jscode($lg) {
	...
	if($lg != '') {
		$code .= '<script language="JavaScript"> 
					function pickUp(idArticle,designat,unite,qteDispo,prixUnit,prixUnitn2,refLot,Datep,MonLot){
...
//$whereAll=" AND mouvement.MVT_DATE<='".$_SESSION['GL_USER']['JOUR']."'  AND mouvement.CODE_MAGASIN LIKE '".$_SESSION['GL_USER']['MAGASIN']."' AND mouvement.ID_EXERCICE='".$_SESSION['GL_USER']['EXERCICE']."' ";

(isset($_GET['wh']) ? $wh=$_GET['wh'] : $wh = '');
$listeDesProduits =  listeDesProduitsMvtQteDecl($wh,$whereAll);
...
<script> writeTableStartTagBasedOnResolution(); </script>
  ...
  <tr>
    <td width="400" align="left" valign="top"><table width="400" border="0" align="left" cellpadding="1" cellspacing="1">
      <tr>
        <td height="20" colspan="3" class="leftHeader"><?php echo getlang(385); ?></td>
      </tr>
      <tr>
      ...
      <!-- Data Tbale contener -->
      <tr>
        <td colspan="3" align="left" valign="top"><table width="620" border="0" cellpadding="5" cellspacing="1" class="tableBorder">
          <!-- Begin Table Header -->
          <tr class="header2">
            <td width="38" height="25" align="left" valign="middle" class="header2Bg">Code</td>
            <td width="42" align="center" valign="middle" class="header2Bg">Lot</td>
            <td width="176" height="25" align="left" valign="middle" class="header2Bg"><?php echo getlang(199); ?></td>
            <td width="42" align="center" valign="middle" class="header2Bg">Qté disp.</td>
            <td width="42" align="center" valign="middle" class="header2Bg">Qté réser.</td>
            <td width="42" align="center" valign="middle" class="header2Bg">Stock</td>
            <td width="52" align="center" valign="middle" class="header2Bg">Prix CSPS</td>
            <td width="52" align="center" valign="middle" class="header2Bg">Prix DISTR</td>
