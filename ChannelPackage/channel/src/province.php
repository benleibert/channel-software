...
if(isset($_GET['do']) && $_GET['do']=="search") {
	$where ="";
	$_SESSION['WHERE'] = "";
	(isset($_POST['region']) && $_POST['region']!='0' 	? 	$where .="province.IDREGION = '".addslashes(trim($_POST['region']))."' AND " 	: $where .="");
	(isset($_POST['province']) && $_POST['province']!='' 	? 	$where .="province.PROVINCE LIKE '".addslashes(trim($_POST['province']))."%' AND " 	: $where .="");
	
	if($where != '')  {$where = substr($where,0, strlen($where)-4);
		$_SESSION['WHERE'] = $where;
	}
	elseif($_SESSION['WHERE'] !='') {$where = $_SESSION['WHERE'];}
	$link ='province.php?selectedTab=par&do=search';
	$retour = ligneConProvinces($where,'','', $page, $_SESSION['GL_USER']['ELEMENT']); //$where, $order, $sens, $page=1, $nelt
}
else {
	$link ='province.php?selectedTab=par';
	$retour = ligneConProvinces('','','', $page, $_SESSION['GL_USER']['ELEMENT']); //$where, $order, $sens, $page=1, $nelt
}
    ...
    <td width="85%" height="80%" align="left" valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="2">
      <tr>
        <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
          <tr>
            <td width="43"  bgcolor="#FFCC66" class="leftHeader"><?php echo getlang(154); ?></td>
          </tr>
          <tr>
      ...
      <tr>
        <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
		  ...
		  <form name="ListingForm" action="dbprovince.php" method="POST">
          <tr>
            <td width="43%"><?php echo  sousMenuDroitSansVlider($page='province', $tab='par', $droitMAJ); ?></td>
            ...
            <td colspan=3 align="left" valign="top">
                ...
                <table width="100%" border="0" cellpadding="2" cellspacing="1" class="tableBorder">
                  ...
                  <tr class="header2">
                    ...
                    <td width="10%" height="25" align="center" valign="middle" class="header2Bg">Code <?php echo getlang(152); ?> </td>
                    <td width="40%" height="25" align="left" valign="middle" class="header2Bg"><?php echo getlang(102); ?> </td>
                    <td width="40%" height="25" align="left" valign="middle" class="header2Bg">&nbsp;&nbsp;Site <?php echo getlang(66); ?></td>
                   </tr>
                  <!-- Begin Table row -->
                  <?php echo $affichage;?>
                  <!-- End Table row -->
            ...
            <table border="0" align="right" cellpadding="5" cellspacing="0" class="botBorder">
              <tbody>
                <tr align="left" valign="top">
                  <td><input name="Enregistrer2" type="button" class="button" id="Enregistrer2"  value='<?php echo getlang(187); ?>'   onclick="OpenBigWin('printlisteprovince.php','');" /></td>
                </tr>
              </tbody>
            </table>            <!-- Fin Affichage -->
          </tr>
