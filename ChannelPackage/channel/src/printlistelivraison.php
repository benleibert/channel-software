...
$libellecde = $libel.' - '.getField('CODE_MAGASIN',$_SESSION['GL_USER']['MAGASIN'],'SER_NOM','magasin');

//Ligne
if(isset($_SESSION['WHERE']) && $_SESSION['WHERE']!='') {
	$ligne = ligneEtatListeLivraison($_SESSION['WHERE'],'','');
}
else {
$ligne = ligneEtatListeLivraison("livraison.ID_EXERCICE=".$_SESSION['GL_USER']['EXERCICE']."  AND livraison.CODE_MAGASIN LIKE '".$_SESSION['GL_USER']['MAGASIN']."'",'','');
}
?>
    ...
    <table width="723" border="0" align="left"  cellpadding="3" cellspacing="0"  class="botBorderTdall">
                              <tbody>
                                <tr align="left" valign="top" nowrap>
                                  ...
                                  <td width="100" align=right valign="middle" class="botBorderTdall header2Bg"><div align="left"><strong><?php echo getlang(35); ?></strong> </div></td>
                                  ...
                                  <td width="48" align=center valign="middle" class="botBorderTdall header2Bg"><div align="center"><strong><?php echo getlang(30); ?></strong></div></td>
                                  ...
                                  <td width="80" align=center valign="middle" class="botBorderTdall header2Bg"><div align="center"><strong><?php echo getlang(66); ?></strong></div></td>
							    </tr>
                                <?php echo $ligne; ?>
        </tbody>
      </table>
