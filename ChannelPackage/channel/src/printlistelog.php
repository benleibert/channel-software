...
$libellecde = 'Liste du logs';
//Ligne
if(isset($_SESSION['WHERE']) && $_SESSION['WHERE']!='') {
	$ligne = ligneEtatListeLog($_SESSION['WHERE']);
}
else {
$ligne = ligneEtatListeLog('');
}
?>
    ...
    <table width="890" border="0" align="left"  cellpadding="3" cellspacing="1"  class="botBorder">
                              <tbody>
                                <tr align="left" valign="top" nowrap>
                                  ...
                                  <td width="50" align=right valign="middle" class="botBorderTdall"><div align="center"><strong>Compte</strong></div></td>
                                  <td width="120" align=right valign="middle" class="botBorderTdall"><div align="left"><strong><?php echo getlang(103); ?> et pr&eacute;noms</strong> </div></td>
                                  <td width="80" align=center valign="middle" class="botBorderTdall"><div align="center"><strong><?php echo getlang(42); ?></strong></div></td>
                                  <td width="80" align=center valign="middle" class="botBorderTdall"><div align="center"><strong><?php echo getlang(305); ?></strong></div></td>
                                  <td width="200" align=center valign="middle" class="botBorderTdall"><div align="center"><strong><?php echo getlang(165); ?></strong></div></td>
                                </tr>
                                <?php echo $ligne; ?>
        </tbody>
      </table>
