              ...
              <td colspan=3 align="left" valign="top">
                ...
                <table width="100%" border="0" cellpadding="2" cellspacing="1" class="tableBorder">
                  ...
                  <tr class="header2">
                    ...
                    <td width="5%" align="center" valign="middle" class="header2Bg">Cde en cours</td>
                    <td width="5%" align="center" valign="middle" class="header2Bg">Sortie  mensuel attendue</td>
                    <td width="5%" align="center" valign="middle" class="header2Bg"><?php echo getlang(315); ?> de stock en cours</td>
                    <td width="5%" align="center" valign="middle" class="header2Bg">Stock  maxi à avoir</td>
                    <td width="5%" align="center" valign="middle" class="header2Bg">Stock  à commander</td>
