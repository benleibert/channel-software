...
function validateForm(){
	...
	var nature1	= trimAll(document.formadd.nature1.value);
        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="2">
          <tr>
            <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
              ...
              <tr>
                <td colspan="2" align="left" valign="top"><form action="dbtransfert.php?do=trs1" method="post" name="formadd" id="formadd">
