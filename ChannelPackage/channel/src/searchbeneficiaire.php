...
function validateForm(){
		...
		var abbrege = trimAll(document.formadd.abbrege.value);
		...
		if(beneficiaire == '' && typebeneficiaire == "0" && adresse=="" && email=="" && tel=="" && codebeneficiaire=="" && abbrege=="") {
        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="2">
          <tr>
            <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
              ...
              <tr>
                <td colspan="2" align="left" valign="top"><form action="beneficiaire.php?selectedTab=par&amp;do=search" method="post" name="formadd" id="formadd">
                      ...
                      <td class="text" align="center"><table width="600" border="0" align="left" cellpadding="5" cellspacing="0" class="botBorder">
                        <tbody>
                          <tr align="left" valign="top">
                            ...
                            <td width="358" align="left" class="text"><input name="codebeneficiaire" type="text" class="formStyle" id="codebeneficiaire"  value="" />
                              <span class="mandatory" id="msg"></span></td>
                          </tr>
                          <tr align="left" valign="top">
                            <td align="right" valign="middle" class="text"><?php echo getlang(16); ?>&nbsp;:&nbsp;</td>
                            <td align="left" class="text"><input name="beneficiaire" type="text" class="formStyle" id="beneficiaire" value="" /></td>
                          </tr>
                          <tr align="left" valign="top">
                            <td align="right" valign="middle" class="text"><?php echo getlang(103); ?> <?php echo getlang(464); ?>&eacute;&nbsp;:&nbsp;</td>
                            <td align="left" class="text"><input name="abbrege" type="text" class="formStyle" id="abbrege" value="" /></td>
                          </tr>
                          <tr align="left" valign="top">
                          ...
                          <tr align="left" valign="top">
                            ...
                            <td align="left" class="text"><input name="tel" type="text" class="formStyle" id="tel" value="" /></td>
                          </tr>
                          <tr align="left" valign="top">
