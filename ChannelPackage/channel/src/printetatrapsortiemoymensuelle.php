...
$libellecde 	= 'Rapport Sorties moyennes mensuelles';

//Ligne
$ligne = ligneEtatrapsortiemoymensuelle($nbreLigne,$data);
    ...
    <table width="723" border="0" align="left"  cellpadding="3" cellspacing="0"  class="botBorderTdall">
                              <tbody>
                                <tr align="left" valign="top" nowrap>
                                  ...
                                  <td width="48" align=center valign="middle" class="botBorderTdall header2Bg"><div align="center"><strong><?php echo getlang(237); ?> des 12 derniers mois</strong></div></td>

                                 
                                  <td width="48" align=center valign="middle" class="botBorderTdall header2Bg"><div align="center"><strong><?php echo getlang(237); ?> des 6 derniers mois</strong></div></td>
                                  <td width="20" align=center valign="middle" class="botBorderTdall header2Bg"><div align="center"><strong><?php echo getlang(237); ?> des 3 derniers mois</strong></div></td>
                                </tr>
                                <?php echo $ligne; ?>
        </tbody>
      </table>
