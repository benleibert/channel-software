...
if(isset($_GET['do']) && $_GET['do']=="search") {
	...
	(isset($_POST['sousgroupe']) && $_POST['sousgroupe']!='' 	? 	$where .="sousgroupe.SOUSGROUPE LIKE '".addslashes(trim($_POST['sousgroupe']))."%' AND " 	: $where .="");
	...
	$link ='sousgroupe.php?selectedTab=par&do=search';
	$retour = ligneConSousgroupe($where,'','', $page, $_SESSION['GL_USER']['ELEMENT']); //$where, $order, $sens, $page=1, $nelt
}
else {
	$link ='sousgroupe.php?selectedTab=par';
	$retour = ligneConSousgroupe('','','', $page, $_SESSION['GL_USER']['ELEMENT']); //$where, $order, $sens, $page=1, $nelt
}
    ...
    <td width="85%" height="80%" align="left" valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="2">
      ...
      <tr>
        <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
		  ...
		  <form name="ListingForm" action="dbsousgroupe.php" method="POST">
          <tr>
            <td width="43%"><?php echo  sousMenuDroitSansRech($page='sousgroupe', $tab='par', $droitMAJ); ?></td>
            ...
            <td colspan=3 align="left" valign="top">
                ...
                <table width="100%" border="0" cellpadding="2" cellspacing="1" class="tableBorder">
                  ...
                  <tr class="header2">
                    ...
                    <td width="80%" height="25" align="left" valign="middle" class="header2Bg"><?php echo getlang(158); ?></td>
                    </tr>
                  <!-- Begin Table row -->
                  <?php echo $affichage;?>
                  <!-- End Table row -->
            ...
            <table border="0" align="right" cellpadding="5" cellspacing="0" class="botBorder">
              <tbody>
                <tr align="left" valign="top">
                  <td><input name="Enregistrer2" type="button" class="button" id="Enregistrer2"  value='<?php echo getlang(187); ?>'   onclick="OpenBigWin('printlistesousgroupe.php','');" /></td>
                </tr>
              </tbody>
            </table>            <!-- Fin Affichage -->
          </tr>
