...
if($_SESSION['GL_USER']['DROIT']['par_uti']['MODIF']!=1) header("location:accessinterdit.php?selectedTab=home");
...
(isset($_SESSION['DATA_LOC']['ID_DECOUPAGE']) ? $codelocalite = $_SESSION['DATA_LOC']['ID_DECOUPAGE']: $codelocalite ='');
(isset($_SESSION['DATA_LOC']['ID_GRPLOC']) ? $grplocalite = $_SESSION['DATA_LOC']['ID_GRPLOC']: $grplocalite ='');
(isset($_SESSION['DATA_LOC']['LOC_DECOUPAGE']) ? $decoupage = $_SESSION['DATA_LOC']['LOC_DECOUPAGE']: $decoupage ='');
(isset($_SESSION['DATA_LOC']['LOC_LIEN']) ? $dependance = $_SESSION['DATA_LOC']['LOC_LIEN']: $dependance ='');
$xdependance = getDependance($dependance);
...
function validateForm(){
		...
		var decoupage = trimAll(document.formadd.decoupage.value);
		var msg = '';

		if(grplocalite == '0') {
        	msg += '- Veuillez sélectionner le type de localié.\n';
        }
		if(decoupage == "") {
        	msg += '- Veuillez saisir le nom du découpage GL_USERistratif.\n';
        }
		if(msg !=''){
			alert(msg);
		}
        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="2">
          <tr>
            <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
              <tr>
                <td width="43" bgcolor="#FFCC66" class="leftHeader"><?php echo getlang(106); ?> &rarr;Les d&eacute;coupages GL_USERistratives</td>
              </tr>
              <tr>
                <td colspan="2" align="left" valign="top"><form action="dbdecoupage.php?do=update" method="post" name="formadd" id="formadd">
                  <table width="100%" border="0" cellpadding="5" cellspacing="0" class="tableBorder">
                    <tr class="header2Bg">
                      <td align="left" valign="top" class="boldText" ><?php echo getlang(440); ?> r un d&eacute;coupage</td>
                    </tr>
                    <tr>
                        ...
                        <tbody>
                          <tr align="left" valign="top">
                            ...
                            <td width="358" align="left" class="text"><select name="grplocalite" id="grplocalite" class="formStyle">
                              ...
                              <?php echo selectTypeLocalite($grplocalite); ?>
                              </select>
                            <span class="mandatory"> *
                            <input name="oldcodedecoupage" type="hidden" id="oldcodedecoupage" value="<?php echo  $codelocalite; ?>" />
                            </span></td>
                          </tr>
                          <tr align="left" valign="top">
                            <td align="right" valign="middle" class="text"><?php echo getlang(103); ?> d&eacute;coupage&nbsp;:&nbsp;</td>
                            <td align="left" class="text"><input name="decoupage" type="text" class="formStyle" id="decoupage" value="<?php echo  $decoupage; ?>" />
                              <span class="mandatory">*</span></td>
                          </tr>
                          <tr align="left" valign="top">
                            <td align="right" valign="middle" class="text">D&eacute;pendance :&nbsp;</td>
                            <td align="left" class="text"><input name="xdependance" type="text" class="formStyle" id="xdependance" readonly="readonly" value="<?php echo  ($xdependance); ?>" />
                              <input name="dependance" type="hidden" class="formStyle" id="dependance" value="<?php echo  $dependance; ?>" />
                              <input name="openf" type="button" class="button"  title="Loclités" value="..." onclick="OpenWin('listedependance.php','Liste');" /></td>
                          </tr>
                          <tr>
                            <td colspan="2"><input name="exercicecourant" type="hidden" id="exercicecourant" value="<?php echo $_SESSION['GL_USER']['EXERCICE']; ?>" />
                              ...
                              <input name='id' type='hidden' id="id" value="<?php echo  $codelocalite; ?>"  /></td>
                          </tr>
                          <tr align="left" valign="top">
                            <td width="200">&nbsp;</td>
