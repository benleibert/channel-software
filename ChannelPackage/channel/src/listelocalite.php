...
//Next link
$urlAlph = "listelocalite.php?lg=$lg&wh=";
//JS code to send data in form
function jscode($lg) {
	$code ='';
		$code .= '<script language="JavaScript"> 
					function pickUp(idArticle,designat){
						window.opener.document.formadd.localite.value = idArticle;
						window.opener.document.formadd.xlocalite.value = designat;
...
<script> writeTableStartTagBasedOnResolution(); </script>
  ...
  <tr>
    ...
    <table width="400" border="0" align="left" cellpadding="1" cellspacing="1">
      <tr>
        <td height="20" colspan="2" class="leftHeader">Liste des localit&eacute;s </td>
      </tr>
      <tr>
