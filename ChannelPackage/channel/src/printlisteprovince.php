...
$libellecde = getlang(391); // 'Liste des sites fournisseurs';
//Ligne
if(isset($_SESSION['WHERE']) && $_SESSION['WHERE']!='') {
	$ligne = ligneEtatListeProvinces($_SESSION['WHERE']);
}
else {
$ligne = ligneEtatListeProvinces('','','');
}
?>
...
<script type="text/javascript" src="../lib/jsfuncLib.js"></script></head>
<body>
    ...
    <table width="100%" border="0" align="left"  cellpadding="3" cellspacing="1"  class="botBorder">
                              <tbody>
                                <tr align="left" valign="top" nowrap>
                                  <td width="20%" align=right valign="middle" class="botBorderTdall"><div align="center"><strong>Code</strong></div></td>
                                  <td width="40%" align=left valign="middle" class="botBorderTdall"><div><strong><?php echo getlang(154); ?> </strong></div></td>
                                  <td width="40%" align=left valign="middle" class="botBorderTdall"><div><strong><?php echo getlang(102); ?> </strong></div></td>
                                </tr>
                                <?php echo $ligne; ?>
        </tbody>
      </table>
