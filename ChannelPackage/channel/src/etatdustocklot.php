...
//Next link
$urlAlph = "etatdustocklot.php?selectedTab=home&lg=$lg&wh=";
...
$listeDesProduits =  listeDesProduitsStockparLot($wh,$whereAll);
    ...
    <td width="85%" height="80%" align="left" valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="2">
      <tr>
        <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
          <tr>
            <td width="43" bgcolor="#FFCC66" class="leftHeader"><?php echo getlang(58); ?></td>
          </tr>
          <tr>
      ...
      <table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
        ...
        <!-- Data Tbale contener -->
        <tr>
          <td colspan="3" align="left" valign="top"><table width="100%" border="0" cellpadding="2" cellspacing="1" class="tableBorder">
            <!-- Begin Table Header -->
            <tr class="header2">
              <td width="10%" align="center" valign="middle" class="header2Bg" nowrap="nowrap">Ref. lot</td>
              ...
              <td width="10%" align="center" valign="middle" class="header2Bg" nowrap="nowrap"><?php echo getlang(220); ?></td>
              <td width="10%" height="25" align="center" valign="middle" class="header2Bg" nowrap="nowrap">Stocks</td>
              <td width="10%" height="25" align="center" valign="middle" class="header2Bg"><?php echo getlang(204); ?></td>
            </tr>
            <!-- Begin Table row -->
            <?php echo $listeDesProduits;?>
            <!-- End Table row -->
          </table></td>
        </tr>
    </table></td>
