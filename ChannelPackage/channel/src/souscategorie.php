...
if(isset($_GET['do']) && $_GET['do']=="search") {
	$where ="";
	$_SESSION['WHERE'] = "";
	(isset($_POST['categorie']) && $_POST['categorie']!='0' 	? 	$where .="souscategorie.CODE_CATEGORIE LIKE '".addslashes(trim($_POST['categorie']))."' AND " 	: $where .="");
	(isset($_POST['codesouscategorie']) && $_POST['codesouscategorie']!='' 	? 	$where .="souscategorie.CODE_SOUSCATEGORIE LIKE '".addslashes(trim($_POST['codesouscategorie']))."%' AND " 	: $where .="");
	(isset($_POST['souscategorie']) && $_POST['souscategorie']!='' 	? 	$where .="souscategorie.SOUSCAT_LIBELLE LIKE '".addslashes(trim($_POST['souscategorie']))."%' AND " 	: $where .="");
	...
	$link ='souscategorie.php?selectedTab=par&do=search';
	$retour = ligneConsousCategorie($where,'','', $page, $_SESSION['GL_USER']['ELEMENT']); //$where, $order, $sens, $page=1, $nelt
}
else {
	$link ='souscategorie.php?selectedTab=par';
	$retour = ligneConsousCategorie('','','', $page, $_SESSION['GL_USER']['ELEMENT']); //$where, $order, $sens, $page=1, $nelt
}
...
function IsLink(ok,prd){
	if(ok==1) {
		alert('Impossible de supprimer le <?php echo getlang(152); ?><'+prd+'>, il est lié une autre donnée\n qu\'il faut au préalable supprimer');
    ...
    <td width="85%" height="80%" align="left" valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="2">
      <tr>
        <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
          <tr>
            <td width="43"  bgcolor="#FFCC66" class="leftHeader"><?php echo getlang(106); ?> -> <?php echo getlang(157); ?></td>
          </tr>
          <tr>
      ...
      <tr>
        <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
		  ...
		  <form name="ListingForm" action="dbsouscategorie.php" method="POST">
          <tr>
            <td width="43%"><?php echo  sousMenuDroitSansVlider($page='souscategorie', $tab='par', $droitMAJ); ?></td>
            ...
            <td colspan=3 align="center" valign="top">
                ...
                <table width="100%" border="0" cellpadding="2" cellspacing="1" class="tableBorder">
                  ...
                  <tr class="header2">
                    ...
                    <td width="10%" height="25" align="center" valign="middle" class="header2Bg">Code <?php echo getlang(19); ?></td>
                    <td width="25%" align="left" valign="middle" class="header2Bg"><?php echo getlang(19); ?></td>
                    <td width="10%" align="center" valign="middle" class="header2Bg">Code <?php echo getlang(159); ?></td>
                    <td width="25%" height="25" align="left" valign="middle" class="header2Bg"><?php echo getlang(159); ?></td>
                    </tr>
                  <!-- Begin Table row -->
                  <?php echo $affichage;?>
                  <!-- End Table row -->
            ...
            <table border="0" align="right" cellpadding="5" cellspacing="0" class="botBorder">
              <tbody>
                <tr align="left" valign="top">
                  <td><input name="Enregistrer2" type="button" class="button" id="Enregistrer2"  value='<?php echo getlang(187); ?>'   onclick="OpenBigWin('printlistesouscategorie.php','');" /></td>
                </tr>
              </tbody>
            </table>            <!-- Fin Affichage -->
          </tr>
