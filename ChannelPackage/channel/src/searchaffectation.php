...
function validateForm(){
		...
		if(personnel == '0' && compte == '0') {
        	msg += '- Veuillez saisir les critères de <?php echo getlang(139); ?>.\n';
        }
        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="2">
          <tr>
            <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
              ...
              <tr>
                <td colspan="2" align="left" valign="top"><form action="affectation.php?selectedTab=par&do=search" method="post" name="formadd" id="formadd">
                  <table width="100%" border="0" cellpadding="5" cellspacing="0" class="tableBorder">
                    <tr class="header2Bg">
                      <td align="left" valign="top" class="boldText" >&nbsp;<?php echo getlang(139); ?> une affectation</td>
                    </tr>
                    <tr>
