        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="2">
          <tr>
            <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
              <tr>
                <td width="43" bgcolor="#FFCC66" class="leftHeader"><?php echo getlang(237); ?> -><?php echo getlang(125); ?></td>
              </tr>
              <tr>
                <td colspan="2" align="left" valign="top"><form action="dbetat.php?do=rapdetaillesortie" method="post" name="formadd" id="formadd">
                  <table width="100%" border="0" cellpadding="5" cellspacing="0" class="tableBorder">
                    <tr class="header2Bg">
                      <td align="left" valign="top" class="boldText" ><?php echo getlang(225); ?> <?php echo getlang(125); ?></td>
                    </tr>
                    <tr>
                      <td class="text" align="center"><table width="600" border="0" align="left" cellpadding="5" cellspacing="0" class="botBorder">
                        <tbody>
                          <tr align="left" valign="top">
                            <td width="247" align="right" valign="middle" class="text"><?php echo getlang(62); ?> :</td>
                            <td width="333" align="left" class="text"><select name="xexercice" id="xexercice" class="formStyle" readonly="readonly"  disabled="disabled">
                          ...
                          <tr align="left" valign="top">
                            ...
                            <td align="left" class="text"><div id="listearticle"><select name="produit[]" size="10" class="formStyle" id="produit[]" multiple="multiple">
                              </select> </div><br>
                              <i><?php echo getlang(227); ?></i></td>
                          </tr>
                          <tr align="left" valign="top">
                            <td width="247"><input name='debutexercice' type='hidden' id="debutexercice" value="<?php echo $_SESSION['GL_USER']['DEBUT_EXERCICE']; ?>" />
