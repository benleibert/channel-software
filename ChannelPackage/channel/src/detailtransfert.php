...
//Annulation
$Annuler ='' //$Annuler = sousMenuAnnuler($statut , $tab='bds', $droitMAJ);
?>
              ...
              <tr>
                <td colspan="2" align="left" valign="top"><form action="dbtransfert.php" method="post" name="formadd" id="formadd">
                  <table width="100%" border="0" cellpadding="5" cellspacing="0" class="tableBorder">
                    <tr class="header2Bg">
                      <td align="left" valign="top" class="boldText" ><?php echo getlang(245); ?> <?php echo getlang(166); ?></td>
                    </tr>
                    <tr>
						...
						<input name="statusexercice" type="hidden" id="statusexercice" value="<?php echo $_SESSION['GL_USER']['STATUT_EXERCICE']; ?>">
							  ...
							  <tr align="left" valign="top">
							    ...
							    <td colspan="10">
							      ...
							      <input name="Enregistrer" type="button" class="button" id="Enregistrer"  value='<?php echo getlang(187); ?>' onClick="OpenBigWin('printtransfert.php','');"> <?php echo $Annuler; ?></td>
							    </tr>
                          </table></td>
                        </tr>
                      </table>
