...
if($_SESSION['GL_USER']['DROIT']['par_ben']['VISIBLE']!=1) header("location:accessinterdit.php?selectedTab=home");
...
if(isset($_GET['do']) && $_GET['do']=="search") {
	$where ="";
	$_SESSION['WHERE'] ='';
	(isset($_POST['codebeneficiaire']) && $_POST['codebeneficiaire']!='' 	? 	$where .="beneficiaire.CODE_BENEF LIKE '".addslashes(trim($_POST['codebeneficiaire']))."' AND " 	: $where .="");
	(isset($_POST['beneficiaire']) && $_POST['beneficiaire']!='' 			? 	$where .="beneficiaire.BENEF_NOM LIKE '".addslashes(trim($_POST['beneficiaire']))."%' AND " 	: $where .="");
	(isset($_POST['abbrege']) && $_POST['abbrege']!='' 			? 	$where .="beneficiaire.BENEF_EBREVIATION LIKE '".addslashes(trim($_POST['abbrege']))."%' AND " 	: $where .="");
	(isset($_POST['typebeneficiaire']) && $_POST['typebeneficiaire']!='0' 			? 	$where .="beneficiaire.CODE_NOMBENF LIKE '".addslashes(trim($_POST['typebeneficiaire']))."' AND " 	: $where .="");
	(isset($_POST['tel']) && $_POST['tel']!='' 			? 	$where .="beneficiaire.BENEF_TEL LIKE '".addslashes(trim($_POST['tel']))."%' AND " 	: $where .="");
	(isset($_POST['adresse']) && $_POST['adresse']!='' 			? 	$where .="beneficiaire.BENEF_ADRESSE LIKE '".addslashes(trim($_POST['adresse']))."%' AND " 	: $where .="");
	(isset($_POST['email']) && $_POST['email']!='' 			? 	$where .="beneficiaire.BENEF_EMAIL LIKE '".addslashes(trim($_POST['email']))."%' AND " 	: $where .="");

	if($where != '')  {$where = substr($where,0, strlen($where)-4);
		$_SESSION['WHERE'] = $where;
	}
	elseif($_SESSION['WHERE'] !='') {$where = $_SESSION['WHERE'];}
	$link ='beneficiaire.php?selectedTab=par&do=search';
	$retour = ligneConBeneficiaire($where,'','', $page, $_SESSION['GL_USER']['ELEMENT']); //$where, $order, $sens, $page=1, $nelt
}
else {
	$link ='beneficiaire.php?selectedTab=par';
	$retour = ligneConBeneficiaire('','','', $page, $_SESSION['GL_USER']['ELEMENT']); //$where, $order, $sens, $page=1, $nelt
}
...
function IsLink(ok,prd){
	if(ok==1) {
		alert('Impossible de supprimer le bénéficiaire <'+prd+'>, il est lié à une autre donnée\n qu\'il faut au préalable supprimer');
    ...
    <td width="85%" height="80%" align="left" valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="2">
      <tr>
        <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
          <tr>
            <td height="20" bgcolor="#FFCC66" class="leftHeader"><?php echo getlang(106); ?> -> <?php echo getlang(16); ?></td>
          </tr>
          <tr>
      ...
      <tr>
        <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
          ...
          <tr>
            <td width="43%"><?php echo  sousMenuDroitSansVlider($page='beneficiaire', $tab='par', $droitMAJ); ?></td>
            ...
            <td colspan=3 align="left" valign="top">
                ...
                <table width="100%" border="0" cellpadding="2" cellspacing="1" class="tableBorder">
                  ...
                  <tr class="header2">
                    ...
                    <td width="8%" height="25" align="center" valign="middle" class="header2Bg">Code</td>
                    <td width="20%" height="25" align="left" valign="middle" class="header2Bg">&nbsp;&nbsp;<?php echo getlang(16); ?></td>
                    <td width="15%" height="25" align="left" valign="middle" class="header2Bg">&nbsp;&nbsp;<?php echo getlang(170); ?></td>
                    <td width="10%" align="left" valign="middle" class="header2Bg">&nbsp;&nbsp;<?php echo getlang(154); ?></td>
                   <td width="10%" height="25" align="left" valign="middle" class="header2Bg">&nbsp;&nbsp;<?php echo getlang(165); ?></td>
                    <td width="15%" height="25" align="left" valign="middle" class="header2Bg"><?php echo getlang(51); ?> </td>
                    </tr>
                  <!-- Begin Table row -->
                  <?php echo $affichage;?>
                  <!-- End Table row -->
          ...
          <table border="0" align="right" cellpadding="5" cellspacing="0" class="botBorder">
            <tbody>
              <tr align="left" valign="top">
                <td><input name="Enregistrer2" type="button" class="button" id="Enregistrer2"  value='<?php echo getlang(187); ?>'   onClick="OpenBigWin('printbeneficiaire.php','');"></td>
                </tr>
            </tbody>
          </table></td>
      </tr>
