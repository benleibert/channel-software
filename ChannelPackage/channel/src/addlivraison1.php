...
//Ligne
$t= ligneaddLivraison1($nbreLigne, $data);
$ligne = $t[1];
$verif = $t[0];
$lotVid =  $t[2];
...
function validateForm(){
	...
	//var commande = trimAll(document.formadd.commande.options[document.formadd.commande.selectedIndex].value);
	var commande = trimAll(document.formadd.commande.value);
	...
	if( commande == "0") {
      	msg += '- Veuillez sélectionner la commande concernée.\n';
    }
	if( libelle == "") {
...
function go(){
	...
	xhr.onreadystatechange = function(){
		...
		if(xhr.readyState == 4 && xhr.status == 200){
			...
			if(retour !='') document.getElementById('codelivraison').focus();
		}
	}
        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="2">
          <tr>
            <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
              ...
              <tr>
                <td colspan="2" align="left" valign="top"><form action="dblivraison.php?do=add" method="post" name="formadd" id="formadd">
                  <table width="100%" border="0" cellpadding="5" cellspacing="0" class="tableBorder">
                    <tr class="header2Bg">
                      <td align="left" valign="top" class="boldText" ><?php echo getlang(366); ?></td>
                    </tr>
                    <tr>
                      <td class="text" align="center"><table width="600" border="0" align="left" cellpadding="5" cellspacing="0" class="botBorder">
                        <tbody>
                          ...
                          <tr align="left" valign="top">
                            ...
                            <td align="left" class="text"><input name="datelivraison" type="text" class="formStyle placeholder" id="datepicker1" value="<?php echo $datelivraison; ?>" />
                          ...
                          <tr align="left" valign="top">
                            ...
                            <td align="left" class="text"><input name="fournisseur" type="text" class="formStyle" id="fournisseur" readonly="readonly" value="<?php echo  $fournisseur; ?>"/>
                              <input name="idfournisseur" type="hidden" class="formStyle"  id="idfournisseur" value="<?php echo  $idfournisseur; ?>"/>
                          ...
                          <td class="text" align="center"><table width="623" border="0" align="left" cellpadding="5" cellspacing="0" class="botBorder">
                            <tbody>
                              <tr align="left" valign="top" nowrap="nowrap">
                                ...
                                <td width="48" align="center" valign="middle" class="text"><div align="center">Qt&eacute; dde</div></td>
                                <td width="48" align="center" valign="middle" class="text"><div align="center">Qt&eacute;  <?php echo getlang(249); ?></div></td>
                              ...
                              <tr align="left" valign="top">
                                <td width="4">&nbsp;</td>
                                <td colspan="12"><!-- <input name="Precedent" type="button" class="button" id="Precedent"  value='&lt;&lt; Pr&eacute;c&eacute;dent' onClick="javascript:window.location.href='addBonentree.php?selectedTab=inputs';"> -->
