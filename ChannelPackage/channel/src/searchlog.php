...
function validateForm(){
       	var datelog1 = trimAll(document.formadd.datelog1.value);
		var datelog2 = trimAll(document.formadd.datelog2.value);
		var utilisateur = trimAll(document.formadd.utilisateur.options[document.formadd.utilisateur.selectedIndex].value);
		var msg = '';

		if(utilisateur=='0' && datelog1=='' && datelog2=='') {
        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="2">
          <tr>
            <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
              <tr>
                <td width="43" bgcolor="#FFCC66" class="leftHeader"><?php echo getlang(106); ?> &rarr;  <?php echo getlang(88); ?></td>
              </tr>
              <tr>
                <td colspan="2" align="left" valign="top"><form action="../src/log.php?selectedTab=par&amp;do=search" method="post" name="formadd" id="formadd">
                  <table width="100%" border="0" cellpadding="5" cellspacing="0" class="tableBorder">
                    <tr class="header2Bg">
                      <td align="left" valign="top" class="boldText" >&nbsp;<?php echo getlang(139); ?> <?php echo getlang(87); ?></td>
                    </tr>
                    <tr>
                      <td class="text" align="center"><table width="600" border="0" align="left" cellpadding="5" cellspacing="0" class="botBorder">
                        <tbody>
                          <tr align="left" valign="top">
                            ...
                            <td width="358" align="left" class="text"><select name="utilisateur" id="utilisateur" class="formStyle">
                              <option value="0"></option>
                              <?php echo selectUtilisateur(); ?>
                              </select></td>
                          </tr>
                          <tr align="left" valign="top">
                            <td rowspan="2" align="right" valign="middle" class="text"><?php echo getlang(43); ?>&nbsp;:&nbsp;</td>
                            <td align="left" class="text"><input name="datelog1" type="text" class="formStyle"  id="datepicker1" /></td>
                          </tr>
                          <tr align="left" valign="top">
                            <td><input name="datelog2" type="text" class="formStyle"  id="datepicker2" /></td>
                          </tr>
                          <tr align="left" valign="top">
