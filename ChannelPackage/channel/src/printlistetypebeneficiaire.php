...
$libellecde = getlang(394); // 'Liste des types de bénéficiaires';
//Ligne
if(isset($_SESSION['WHERE']) && $_SESSION['WHERE']!='') {
	$ligne = ligneEtatTypeBeneficiaire($_SESSION['WHERE']);
}
else {
$ligne = ligneEtatTypeBeneficiaire('','','');
}
?>
    ...
    <table width="100%" border="0" align="left"  cellpadding="3" cellspacing="1"  class="botBorder">
                              <tbody>
                                <tr align="left" valign="top" nowrap>
                                  <td width="14%" align=right valign="middle" class="botBorderTdall"><div align="center"><strong>Code </strong></div></td>
                                  <td width="86%" align=left valign="middle" class="botBorderTdall"><div><strong><?php echo getlang(357); ?> type<?php echo getlang(16); ?></strong></div></td>
                                </tr>
                                <?php echo $ligne; ?>
        </tbody>
      </table>
