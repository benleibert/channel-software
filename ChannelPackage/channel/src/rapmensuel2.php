    ...
    <td width="85%" height="80%" align="left" valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="2">
      <tr>
        <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
          <tr>
            <td width="43"  bgcolor="#FFCC66" class="leftHeader"><?php echo getlang(228); ?> <?php echo $periode; ?></td>
          </tr>
          <tr>
      ...
      <tr>
        <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
          ...
          <form name="ListingForm" action="../src/phpfuncunites.php" method="POST">
            <tr>
              <td width="43%" class="text">	<strong><?php echo $libelle; ?>&nbsp;</strong></td>
              ...
              <td colspan=3 align="left" valign="top">
                ...
                <table width="100%" border="0" cellpadding="2" cellspacing="1" class="tableBorder">
                  ...
                  <tr class="header2">
                    ...
                    <td width="15%" align="center" valign="middle" nowrap class="header2Bg"><?php echo getlang(210); ?> </td>
                    <td width="15%" align="center" valign="middle" nowrap class="header2Bg"><?php echo getlang(211); ?> </td>
          ...
          <table border="0" align="right" cellpadding="5" cellspacing="0" class="botBorder">
            <tbody>
              <tr align="left" valign="top">
                <td align="right"><input name="Enregistrer2" type="button" class="button" id="Enregistrer2"  value='<?php echo getlang(187); ?>'  onClick="OpenBigWin('printrapmensuel2.php','');" /></td>
                <td align="right"><span class="leftHeader">
                  <input name="Enregistrer3" type="button" class="button" id="Enregistrer3"  value='<?php echo getlang(188); ?>'   onclick="OpenWin('genererexcelrapmensuel2.php','Fichier Excel');" />
                </span></td>
                </tr>
            </tbody>
          </table>        </tr>
