...
if($_SESSION['GL_USER']['DROIT']['bde_cde']['VALID']!=1) header("location:accessinterdit.php?selectedTab=home");
        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="2">
          <tr>
            <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
              ...
              <tr>
                <td colspan="2" align="left" valign="top"><form action="dbcommande.php?do=validate" method="post" name="formadd" id="formadd">
                  <table width="100%" border="0" cellpadding="5" cellspacing="0" class="tableBorder">
                    <tr class="header2Bg">
                      <td align="left" valign="top" class="boldText" ><?php echo getlang(180); ?> <?php echo getlang(36); ?></td>
                    </tr>
                    <tr>
                      <td class="text" align="center"><table width="600" border="0" align="left" cellpadding="5" cellspacing="0" class="botBorder">
                        <tbody>
                          ...
                          <tr align="left" valign="top">
                            ...
                            <td align="left" class="text"><input name="datecommande" type="text" class="formStyle" id="datepicker1" readonly="readonly" value="<?php echo $datecommande; ?>" /></td>
                          </tr>
                          <tr align="left" valign="top">
                            <td align="right" valign="middle" class="text"><?php echo getlang(140); ?> :</td>
                            <td align="left" class="text"><input name="refcommande"  id="refcommande" type="text" class="formStyle" readonly="readonly" value="<?php echo $refcommande; ?>" /> <span class="mandatory" id="msg"></span></td>
                          </tr>
                          <tr align="left" valign="top">
                            <td align="right" valign="middle" class="text"><?php echo getlang(82); ?> :</td>
                            <td align="left" class="text"><input name="libellecde" type="text" class="formStyle" id="libellecde" readonly="readonly" value="<?php echo $libellecde; ?>" /></td>
                          </tr>
                          <tr align="left" valign="top">
                          ...
                          <td class="text" align="center"><table width="623" border="0" align="left" cellpadding="5" cellspacing="0" class="botBorder">
                              <tbody>
                                <tr align="left" valign="top" nowrap>
								  ...
								  <td width="100" align=center valign="middle" class="text"><div align="center"><?php echo getlang(221); ?></div></td>
                                 <!-- <td width="82"  valign="middle" class="text"><div align="center">Mnt total</div></td> -->
                                  </tr>

								  <?php echo $ligne ; ?>
                              	<tr>
                                <td colspan="8"><input name='myaction' type='hidden' id="myaction">
