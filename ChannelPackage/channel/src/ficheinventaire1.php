...
//Ligne
$ligne = ligneFicheInventaire($nbreLigne,$statut='', $data);
        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="2">
          <tr>
            <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
              ...
              <tr>
                <td colspan="2" align="left" valign="top"><form action="dbinventaire.php" method="post" name="formadd" id="formadd"><br />
<table width="100%" border="0" cellpadding="5" cellspacing="0" class="tableBorder">
                        <tr class="header2Bg">
                          <td align="left" valign="top" class="boldText" ><?php echo getlang(319); ?></td>
                        </tr>
                        <tr>
                          <td class="text" align="center"><table width="623" border="0" align="left" cellpadding="5" cellspacing="0" class="botBorder">
                              <tbody>
                                <tr align="left" valign="top" nowrap>
                                 ...
                                 <td width="60" align=right valign="middle" class="text"><div align="center">Réf. lot</div></td>
								  ...
								  <td width="48" align=center valign="middle" class="text"  nowrap="nowrap"><div align="center"><?php echo getlang(289); ?></div></td>
						...
						<input name="statusexercice" type="hidden" id="statusexercice" value="<?php echo $_SESSION['GL_USER']['STATUT_EXERCICE']; ?>"></td>
							  ...
							  <tr align="left" valign="top">
							    ...
							    <td colspan="8">
							     ...
							     <input name="AjouterLign" type="button" class="button" id="AjouterLign"  value='<?php echo getlang(187); ?>' onClick="OpenBigWin('printficheinventaire.php','');"></td>
  								</tr>
                          </table></td>
                        </tr>
                      </table>
