...
$libellecde 	= getlang(132);

//Ligne
$ligne = ligneEtatrapdeclassement($nbreLigne,$data);
...
<table width="700" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
                <tr>
                   <td height="20"  bgcolor="#FFCC66" class="leftHeader"><h2><?php echo (stripslashes($libellecde)); ?> : <?php echo $_SESSION['DATA_ETAT']['choix']; ?></h2></td>
                </tr>
	<tr class="header2">
    ...
    <table width="723" border="0" align="left"  cellpadding="3" cellspacing="0"  class="botBorderTdall">
                              <tbody>
                                <tr align="left" valign="top" nowrap>
                                  <td width="10" align=center valign="middle" class="botBorderTdall header2Bg"><div align="left"><strong>Code</strong></div></td>
                                  <td width="10" align=center valign="middle" class="botBorderTdall header2Bg" nowrap="nowrap"><div align="left"><strong>Réf. lot</strong></div></td>
                                  ...
                                  <td width="48" align=center valign="middle" class="botBorderTdall header2Bg"><div align="center"><strong><?php echo getlang(101); ?></strong></div></td>
                                  <td width="48" align=center valign="middle" class="botBorderTdall header2Bg" nowrap="nowrap"><div align="center"><strong><?php echo getlang(262); ?> </strong></div></td>
                                  <td width="20" align=center valign="middle" class="botBorderTdall header2Bg"><div align="center"><strong><?php echo getlang(235); ?></strong></div></td>
                                  ...
                                  <td width="20" align=center valign="middle" class="botBorderTdall header2Bg"><div align="center"><strong><?php echo getlang(224); ?></strong></div></td>
                                </tr>
                                <?php echo $ligne; ?>
        </tbody>
      </table>
