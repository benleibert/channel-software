...
$beneficiaire = listeTousBeneficaires($where);

//Next link
$urlAlph = "listetousbeneficiaire.php?lg=$lg&wh=";
      ...
      <tr>
        ...
        <table width="400" border="0" cellpadding="5" cellspacing="1" class="tableBorder">
          ...
          <tr class="header2">
            ...
            <td width="30" height="25" align="center" valign="middle" class="header2Bg" nowrap>Type</td>
          </tr>
		  <?php 
		  	(isset($_GET['wh']) ? $wh=$_GET['wh'] : $wh = '');
			echo $beneficiaire;
