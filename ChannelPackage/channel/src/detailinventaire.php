...
<table width="100%" border="0" cellpadding="5" cellspacing="0" class="tableBorder">
                              ...
                              <tbody>
                                <tr align="left" valign="top" nowrap>
                                 ...
                                 <td width="64" align=right valign="middle" nowrap class="text"><div align="center">Réf. lot </div></td>
                                  ...
                                  <td width="48" align=center valign="middle" class="text"><div align="center"><?php echo getlang(200); ?> th&eacute;orique</div></td>
								  <td width="48" align=center valign="middle" class="text"><div align="center"><?php echo getlang(200); ?> physique</div></td>
                                ...
                                <tr align="left" valign="middle">
                                  <td colspan="9" class="text" nowrap="nowrap"><?php echo $ligne ; ?>
								  </td>
                                  </tr>
                              	<tr>
						...
						<input name="statusexercice" type="hidden" id="statusexercice" value="<?php echo $_SESSION['GL_USER']['STATUT_EXERCICE']; ?>">
                                ...
                                <input name="oldrefinventaire" type='hidden' id="oldrefinventaire" value="<?php echo $refinventaire; ?>" /></td>
                              </tr>
							  <tr align="left" valign="top">
							    <td width="4">&nbsp;</td>
							    <td colspan="8">
							     ...
							     <input name="AjouterLign" type="button" class="button" id="AjouterLign"  value='<?php echo getlang(187); ?>' onClick="OpenBigWin('printinventaire.php','');"> <?php echo $Annuler; ?></td>
  								</tr>
                          </table></td>
                        </tr>
                      </table>
