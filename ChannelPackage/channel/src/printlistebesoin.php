...
$libellecde = 'Liste des besoins exprimés - '.getField('CODE_MAGASIN',$_SESSION['GL_USER']['MAGASIN'],'SER_NOM','magasin');;
//Ligne
if(isset($_SESSION['WHERE']) && $_SESSION['WHERE']!='') {
	$ligne = ligneEtatListeBesoin($_SESSION['WHERE'],'','');
}
else {
$ligne = ligneEtatListeBesoin("besoin.ID_EXERCICE=".$_SESSION['GL_USER']['EXERCICE']."  AND besoin.CODE_MAGASIN LIKE '".$_SESSION['GL_USER']['MAGASIN']."'",'','');
}
?>
    ...
    <table width="723" border="0" align="left"  cellpadding="3" cellspacing="0"  class="botBorderTdall">
                              <tbody>
                                <tr align="left" valign="top" nowrap>
                                  ...
                                  <td width="100" align=center valign="middle" class="botBorderTdall header2Bg"><div align="center"><strong>Bébéficiaire</strong></div></td>
							    </tr>
                                <?php echo $ligne; ?>
        </tbody>
      </table>
