...
if($_SESSION['GL_USER']['DROIT']['bde_cde']['MODIF']!=1) header("location:accessinterdit.php?selectedTab=home");
...
(isset($_SESSION['DATA_CDE']['CDE_STATUT']) 	? $statut 	= $_SESSION['DATA_CDE']['CDE_STATUT']: $statut ='');
...
function go(){
	if(document.getElementById('refcommande').value != document.getElementById('oldrefcommande').value){
		var xhr = getXhr();
        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="2">
          <tr>
            <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
              ...
              <tr>
                <td colspan="2" align="left" valign="top"><form action="dbcommande.php?do=update" method="post" name="formadd" id="formadd">
                  <table width="100%" border="0" cellpadding="5" cellspacing="0" class="tableBorder">
                    <tr class="header2Bg">
                      <td align="left" valign="top" class="boldText" ><?php echo getlang(441); ?> </td>
                    </tr>
                    <tr>
