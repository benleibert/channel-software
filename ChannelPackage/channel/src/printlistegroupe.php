...
$libellecde = 'Liste des groupes d\'utilisateur';
//Ligne
if(isset($_SESSION['WHERE']) && $_SESSION['WHERE']!='') {
	$ligne = ligneEtatListeGroupe($_SESSION['WHERE']);
}
else {
$ligne = ligneEtatListeGroupe('','','');
}
?>
    ...
    <table width="100%" border="0" align="left"  cellpadding="3" cellspacing="1"  class="botBorder">
                              <tbody>
                                <tr align="left" valign="top" nowrap>
                                  ...
                                  <td align=left valign="middle" class="botBorderTdall"><div><strong><?php echo getlang(103); ?> <?php echo getlang(68); ?></strong></div></td>
                                </tr>
                                <?php echo $ligne; ?>
        </tbody>
      </table>
