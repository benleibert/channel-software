...
require_once('functypeservice.php');
...
$libellecde = 'Liste des types de service';
//Ligne
if(isset($_SESSION['WHERE']) && $_SESSION['WHERE']!='') {
	$ligne = ligneEtatTypeService($_SESSION['WHERE']);
}
else {
$ligne = ligneEtatTypeService('','','');
}
?>
    ...
    <table width="100%" border="0" align="left"  cellpadding="3" cellspacing="1"  class="botBorder">
                              <tbody>
                                <tr align="left" valign="top" nowrap>
                                  <td width="20%" align=right valign="middle" class="botBorderTdall"><div align="center"><strong>Code type</strong></div></td>
                                  <td width="40%" align=left valign="middle" class="botBorderTdall"><div><strong><?php echo getlang(357); ?> type de service</strong></div></td>
                                  <td width="40%" align=left valign="middle" class="botBorderTdall"><div><strong>D&eacute;pendance</strong></div></td>
                                </tr>
                                <?php echo $ligne; ?>
        </tbody>
      </table>
