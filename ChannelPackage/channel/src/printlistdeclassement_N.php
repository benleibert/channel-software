...
$libellecde = 'Liste des pertes';

//Ligne
if(isset($_SESSION['WHERE']) && $_SESSION['WHERE']!='') {
	$ligne = ligneEtatListeDeclassement($_SESSION['WHERE'],'','');
}
else {
$ligne = ligneEtatListeDeclassement("declass.ID_EXERCICE=".$_SESSION['GL_USER']['EXERCICE']."  AND declass.CODE_MAGASIN LIKE '".$_SESSION['GL_USER']['MAGASIN']."'",'','');
}
?>
...
<table width="700" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
                <tr>
                  <td width="100%" width="43" bgcolor="#FFCC66" class="leftHeader"><h3><?php echo (stripslashes($libellecde)); ?></h3></td>
                </tr>
      </table>
    <p>&nbsp;</p>
    <tr>
    ...
    <table width="723" border="0" align="left"  cellpadding="3" cellspacing="0"  class="botBorderTdall">
                              <tbody>
                                <tr align="left" valign="top" nowrap>
                                  ...
                                  <td width="5%" height="25" align="center" valign="middle" class="botBorderTdall header2Bg" nowrap>...</td>
                    <td width="15%" height="25" align="center" valign="middle" class="botBorderTdall header2Bg"><strong>Code decalssement</strong></td>
                    <td width="10%" height="25" align="left" valign="middle" class="botBorderTdall header2Bg"><strong><?php echo getlang(42); ?></strong> </td>
                    <td width="35%" height="25" align="left" valign="middle" class="botBorderTdall header2Bg"><strong>&nbsp;&nbsp;Raison</strong></td>
							    </tr>
                                <?php echo $ligne; ?>
        </tbody>
      </table>
