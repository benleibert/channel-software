...
$libellecde 	= getlang(123);

//Ligne
$ligne = ligneEtatraprupture($nbreLigne,$data);
...
<table width="700" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
                <tr>
                   <td height="20"  bgcolor="#FFCC66" class="leftHeader"><h2><?php echo (stripslashes($libellecde)); ?> : <?php echo getSiteBénéf($_SESSION['GL_USER']['MAGASIN']); ?></h2></td>
                </tr>
	<tr class="header2">
    ...
    <table width="723" border="0" align="left"  cellpadding="3" cellspacing="0"  class="botBorderTdall">
                              <tbody>
                                <tr align="left" valign="top" nowrap>
                                  ...
                                  <td width="48" align=center valign="middle" class="botBorderTdall header2Bg"><div align="center"><strong><?php echo getlang(314); ?></strong></div></td>
                                  <td width="48" align=center valign="middle" class="botBorderTdall header2Bg"><div align="center"><strong><?php echo getlang(316); ?> </strong></div></td>

                                 
                                  <td width="48" align=center valign="middle" class="botBorderTdall header2Bg"><div align="center"><strong><?php echo getlang(315); ?> </strong></div></td>
                                </tr>
                                <?php echo $ligne; ?>
        </tbody>
      </table>
