...
//Ligne
$ligne = ligneEtatInventaire($nbreLigne,$data);
...
<body>
<table width="876" align="center" cellpadding="0" cellspacing="0">
  <tr>
  ...
  <tr>
    ...
    <table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
                <tr>
                  <td height="20" class="leftHeader" colspan="2"><h2><?php echo (stripslashes($inventaire)); ?></h2></td>
                </tr>
	<tr class="header2">
                      ...
                      <td height="25" align="left" valign="middle" nowrap="nowrap"  class="header2Bg">&nbsp;Date : <strong><?php echo $dateinventaire; ?></strong></td>
        </tr>
      </table>
    <p>&nbsp;</p>
  <tr>
    <td>
    <table width="876" border="0" align="left"  cellpadding="3" cellspacing="0"  class="botBorderTdall">
                              <tbody>
                                <tr align="left" valign="top" nowrap>
                                  <td width="23" align=center valign="middle" class="botBorderTdall header2Bg"><strong>N°</strong></td>
                                  <td width="340" align=right valign="middle" class="botBorderTdall header2Bg"><div align="left"><strong><?php echo getlang(199); ?></strong> </div></td>
                                  <td width="63" align=center valign="middle" class="botBorderTdall header2Bg"><div align="center"><strong>Réf. Lot</strong></div></td>

                                 
                                  <td width="63" align=center valign="middle" class="botBorderTdall header2Bg"><div align="center"><strong><?php echo getlang(288); ?></strong></div></td>
                                  <td width="27" align=center valign="middle" class="botBorderTdall header2Bg"><div align="center"><strong><?php echo getlang(289); ?></strong></div></td>
                                  <td width="27" align=center valign="middle" class="botBorderTdall header2Bg"><div align="center"><strong><?php echo getlang(455); ?></strong></div></td>
                                  <td width="27" align=center valign="middle" class="botBorderTdall header2Bg"><div align="center"><strong><?php echo getlang(204); ?></strong></div></td>
                                  <td width="256" align=center valign="middle" class="botBorderTdall header2Bg"><div align="center"><strong>Observations</div></td>
                                </tr>
                                <?php echo $ligne; ?>
        </tbody>
      </table>
