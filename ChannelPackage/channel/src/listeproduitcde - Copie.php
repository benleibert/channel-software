...
//Next link
$urlAlph = "listeproduitcde.php?lg=$lg&wh=";
...
function jscode($lg) {
	...
	if($lg != '') {
		$code .= '<script language="JavaScript"> 
					function pickUp(idArticle,designat,unite){
    ...
    <table width="400" border="0" align="left" cellpadding="1" cellspacing="1">
      ...
      <tr>
        ...
        <table width="400" border="0" cellpadding="5" cellspacing="1" class="tableBorder">
          <!-- Begin Table Header -->
          <tr class="header2">
            <td width="43" align="left" valign="middle" class="header2Bg">Code</td>
            <td width="44" height="25" align="center" valign="middle" class="header2Bg">Qté</td>
            <td width="198" height="25" align="left" valign="middle" class="header2Bg"><?php echo getlang(199); ?></td>
            <td width="68" height="25" align="center" valign="middle" class="header2Bg" nowrap="nowrap"><?php echo getlang(204); ?></td>
          </tr>
		  <?php 
		  	(isset($_GET['wh']) ? $wh=$_GET['wh'] : $wh = '');
			echo listeDesProduitsCde($wh);
			?>
