    ...
    <td width="85%" height="80%" align="left" valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="2">
      <tr>
        <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
          <tr>
            <td width="43"  bgcolor="#FFCC66" class="leftHeader"><?php echo getlang(411); ?> -> <?php echo $_SESSION['DATA_ETAT']['datedebut'];?> - <?php echo $_SESSION['DATA_ETAT']['datefin'];?> : <?php echo $_SESSION['DATA_ETAT']['choix']; ?></td>
          </tr>
          <tr>
            ...
            <tr>
              <td colspan=3 align="left" valign="top">
                ...
                <table width="100%" border="0" cellpadding="2" cellspacing="1" class="tableBorder">
                  <!-- Begin Table Header -->
                  <tr class="header2">
                    <td width="7%" align="center" valign="middle" class="header2Bg">Réf. lot</td>
                    <td width="8%" height="25" align="center" valign="middle" class="header2Bg">Code</td>
                    <td width="51%" align="left" valign="middle" class="header2Bg" nowrap="nowrap"><?php echo getlang(199); ?></td>
                    <td width="16%" height="25" align="left" valign="middle" class="header2Bg" nowrap="nowrap"><div align="center">Qté</div></td>
                    <td width="18%" align="center" valign="middle" class="header2Bg" nowrap="nowrap"><?php echo getlang(201); ?></td>
                    </tr>
                  <!-- Begin Table row -->
                  <?php echo $affichage;?>
                  <!-- End Table row -->
