...
$libellecde = 'Liste des magasins';
//Ligne
if(isset($_SESSION['WHERE']) && $_SESSION['WHERE']!='') {
	$ligne = ligneEtatmagasin($_SESSION['WHERE']);
}
else {
$ligne = ligneEtatmagasin('','','');
}
?>
    ...
    <table width="100%" border="0" align="left"  cellpadding="3" cellspacing="1"  class="botBorder">
                              <tbody>
                                <tr align="left" valign="top" nowrap>
                                  <td width="15%" align=right valign="middle" class="botBorderTdall"><div align="center"><strong>Code <?php echo getlang(152); ?></strong></div></td>
                                  <td width="25%" align=left valign="middle" class="botBorderTdall"><div><strong><?php echo getlang(152); ?></strong></div></td>
                                  ...
                                  <td width="30%" align=left valign="middle" class="botBorderTdall"><div><strong><?php echo getlang(151); ?></strong></div></td>
                                </tr>
                                <?php echo $ligne; ?>
        </tbody>
      </table>
