...
if($_SESSION['GL_USER']['DROIT']['par_uti']['VISIBLE']!=1) header("location:accessinterdit.php?selectedTab=home");
...
if(isset($_GET['do']) && $_GET['do']=="search") {
	...
	(isset($_POST['groupe']) && $_POST['groupe']!='0' 	? 	$where .="compte.ID_GROUPE LIKE '".addslashes(trim($_POST['groupe']))."' AND " 	: $where .="");
	(isset($_POST['compte']) && $_POST['compte']!='' 	? 	$where .="compte.LOGIN 	 LIKE '".addslashes(trim($_POST['compte']))."%' AND " 	: $where .="");
	...
	$link ='user.php?selectedTab=par&do=search';
	$retour = ligneConUser($where,'','', $page, $_SESSION['GL_USER']['ELEMENT']); //$where, $order, $sens, $page=1, $nelt
}
else {
	$link ='user.php?selectedTab=par';
	$retour = ligneConUser('','','', $page, $_SESSION['GL_USER']['ELEMENT']); //$where, $order, $sens, $page=1, $nelt
}
    ...
    <td width="85%" height="80%" align="left" valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="2">
      ...
      <tr>
        <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
		  ...
		  <form name="ListingForm" action="dbuser.php" method="POST">
          <tr>
            <td width="43%"><?php echo  sousMenuDroitSansVlider($page='user', $tab='par', $droitMAJ); ?></td>
            ...
            <td colspan=3 align="left" valign="top">
                ...
                <table width="100%" border="0" cellpadding="2" cellspacing="1" class="tableBorder">
                  ...
                  <tr class="header2">
                    ...
                    <td width="10%" height="25" align="left" valign="middle" class="header2Bg">&nbsp;&nbsp;Compte</td>
                    <td width="15%" height="25" align="left" valign="middle" class="header2Bg"><?php echo getlang(68); ?></td>
                    ...
                    <td width="20%" align="left" valign="middle" class="header2Bg">&nbsp;&nbsp;Statut</td>
                    </tr>
                  <!-- Begin Table row -->
                  <?php echo $affichage;?>
                  <!-- End Table row -->
           ...
           <table border="0" align="right" cellpadding="5" cellspacing="0" class="botBorder">
            <tbody>
              <tr align="left" valign="top">
                <td><input name="Enregistrer2" type="button" class="button" id="Enregistrer2"  value='<?php echo getlang(187); ?>'   onClick="OpenBigWin('printlisteutilisateur.php','');"></td>
                </tr>
            </tbody>
          </table>
            <!-- Fin Affichage -->
