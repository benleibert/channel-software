...
$affichage = ligneConQteCommande($_SESSION['DATA_ETAT']['nbreLigne'],$_SESSION['DATA_ETAT']['ligne']); //$where, $order, $sens, $page=1, $nelt
    ...
    <td width="85%" height="80%" align="left" valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="2">
      <tr>
        <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
          <tr>
            <td width="43"  bgcolor="#FFCC66" class="leftHeader"><?php echo getlang(310); ?> : <?php echo $_SESSION['DATA_ETAT']['choix']; ?></td>
          </tr>
          <tr>
              ...
              <td colspan=3 align="left" valign="top">
                ...
                <table width="100%" border="0" cellpadding="2" cellspacing="1" class="tableBorder">
                  ...
                  <tr class="header2">
                    ...
                    <td width="6%" height="25" align="center" valign="middle" bgcolor="#33CC66" class="header2Bg" nowrap="nowrap">Stock</td>
                    <td width="5%" align="center" valign="middle" class="header2Bg" nowrap="nowrap"><?php echo getlang(306); ?></td>
                    <td width="5%" align="center" valign="middle" class="header2Bg" nowrap="nowrap"><?php echo getlang(307); ?> </td>
                    <td width="9%" align="center" valign="middle" class="header2Bg" nowrap>CMM</td>
                    <td width="6%" align="center" valign="middle" class="header2Bg" nowrap="nowrap"><?php echo getlang(308); ?></td>
                    <td width="6%" height="25" align="center" valign="middle" class="header2Bg" nowrap="nowrap"><?php echo getlang(309); ?></td>
                    <td width="5%" align="center" valign="middle" class="header2Bg" nowrap="nowrap"><?php echo getlang(204); ?></td>
                    </tr>
                  <!-- Begin Table row -->
                  <?php echo $affichage;?>
                  <!-- End Table row -->
