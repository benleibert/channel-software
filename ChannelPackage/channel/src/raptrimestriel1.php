...
$affichage = ligneConRapportMensuel($_SESSION['DATA_ETAT']['nbreLigne'],$_SESSION['DATA_ETAT']['ligne']); //$where, $order, $sens, $page=1, $nelt
              ...
              <td colspan=3 align="left" valign="top">
                ...
                <table width="100%" border="0" cellpadding="2" cellspacing="1" class="tableBorder">
                  ...
                  <tr class="header2">
                    ...
                    <td width="6%" align="center" valign="middle" nowrap class="header2Bg"><?php echo getlang(111); ?></td>
                    <td width="6%" align="center" valign="middle"  nowrap class="header2Bg"><?php echo getlang(212); ?></td>
                    <td width="5%" align="center" valign="middle" nowrap class="header2Bg"><?php echo getlang(204); ?></td>
                  </tr>
                  <!-- Begin Table row -->
                  <?php echo $affichage;?>
                  <!-- End Table row -->
          ...
          <table border="0" align="right" cellpadding="5" cellspacing="0" class="botBorder">
            <tbody>
              <tr align="left" valign="top">
                <td align="right"><input name="Enregistrer2" type="button" class="button" id="Enregistrer2"  value='<?php echo getlang(187); ?>'  onClick="OpenBigWin('printraptrimestriel1.php','');" /></td>
                <td align="right"><span class="leftHeader">
                  <input name="Enregistrer3" type="button" class="button" id="Enregistrer3"  value='<?php echo getlang(188); ?>'   onclick="OpenWin('genererexcelraptrimestriel1.php','Fichier Excel');" />
                </span></td>
                </tr>
            </tbody>
          </table>        </tr>
