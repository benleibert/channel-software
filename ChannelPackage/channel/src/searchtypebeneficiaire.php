...
function validateForm(){
		...
		if(codetypebeneficiaire == '' && typebeneficiaire=='') {
        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="2">
          <tr>
            <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
              ...
              <tr>
                <td colspan="2" align="left" valign="top"><form action="../src/typebeneficiaire.php?selectedTab=par&amp;do=search" method="post" name="formadd" id="formadd">
                  <table width="100%" border="0" cellpadding="5" cellspacing="0" class="tableBorder">
                    <tr class="header2Bg">
                      <td align="left" valign="top" class="boldText" >&nbsp;<?php echo getlang(139); ?> <?php echo getlang(16); ?></td>
                    </tr>
                    <tr>
                      <td class="text" align="center"><table width="600" border="0" align="left" cellpadding="5" cellspacing="0" class="botBorder">
                        <tbody>
                          <tr align="left" valign="top">
                            ...
                            <td width="358" align="left" class="text"><input name="codetypebeneficiaire" type="text" class="formStyle" id="codetypebeneficiaire" onblur="go();" /></td>
                          </tr>
                          <tr align="left" valign="top">
                            <td width="200" align="right" valign="middle" class="text"><?php echo getlang(169); ?>&nbsp;:&nbsp;</td>
                            <td align="left" class="text"><input name="typebeneficiaire" type="text" class="formStyle" id="typebeneficiaire" /></td>
                          </tr>
                          <tr align="left" valign="top">
