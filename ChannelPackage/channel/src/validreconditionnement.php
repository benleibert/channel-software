...
if($_SESSION['GL_USER']['DROIT']['bds_rec']['VALID']!=1) header("location:accessinterdit.php?selectedTab=home");
...
//Ligne
$ligne = lignedetailReconditionnement($nbreLigne, $data);
        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="2">
          <tr>
            <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
              ...
              <tr>
                <td colspan="2" align="left" valign="top"><form action="dbreconditionnement.php?do=validate" method="post" name="formadd" id="formadd">
                  <table width="100%" border="0" cellpadding="5" cellspacing="0" class="tableBorder">
                    <tr class="header2Bg">
                      <td align="left" valign="top" class="boldText" ><?php echo getlang(180); ?> r un reconditionnement</td>
                    </tr>
                    <tr>
                          ...
                          <td class="text" align="center"><table width="623" border="0" align="left" cellpadding="5" cellspacing="0" class="botBorder">
                              <tbody>
                                ...
                                <tr align="left" valign="middle">
                                  <td colspan="8" class="text" nowrap="nowrap"><?php echo $ligne ; ?>
								  </td>
                                  </tr>
                              	<tr>
						...
						<input name="statusexercice" type="hidden" id="statusexercice" value="<?php echo $_SESSION['GL_USER']['STATUT_EXERCICE']; ?>">
							  ...
							  <tr align="left" valign="top">
							    ...
							    <td colspan="7">
							      ...
							      <input name="Enregistrer" type="button" class="button" id="Enregistrer"  value='Valider les donn&eacute;es'  onClick="validateForm();"></td>
  								</tr>
                          </table></td>
                        </tr>
                      </table>
