...
function validateForm(){
        var codenature = trimAll(document.formadd.codenature.value);
		var nature = trimAll(document.formadd.nature.value);
		var sens = trimAll(document.formadd.sens.options[document.formadd.sens.selectedIndex].value);
		var msg = '';
		...
		if(sens == "0") {
        	msg += '- Veuillez sélectionner le sens.\n';
        }
		if(msg !=''){
			alert(msg);
		}
        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="2">
          <tr>
            <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
              <tr>
                <td height="20" bgcolor="#FFCC66" class="leftHeader"><?php echo getlang(106); ?> -> <?php echo getlang(304); ?> -Stock</td>
              </tr>
              <tr>
                <td colspan="2" align="left" valign="top"><form action="dbnaturemvt.php?do=add" method="post" name="formadd" id="formadd">
                  <table width="100%" border="0" cellpadding="5" cellspacing="0" class="tableBorder">
                    <tr class="header2Bg">
                      <td align="left" valign="top" class="boldText" ><?php echo getlang(11); ?> <?php echo getlang(304); ?></td>
                    </tr>
                    <tr>
                      <td class="text" align="center"><table width="600" border="0" align="left" cellpadding="5" cellspacing="0" class="botBorder">
                        <tbody>
                          <tr align="left" valign="top">
                            <td width="200" align="right" valign="middle" class="text">Code <?php echo getlang(98); ?> &nbsp;:&nbsp;</td>
                            <td width="358" align="left" class="text"><input name="codenature" type="text" class="formStyle" id="codenature" onblur="go();" />
                              <span class="mandatory" id="msg">*</span></td>
                          </tr>
                          <tr align="left" valign="top">
                            <td align="right" valign="middle" class="text"><?php echo getlang(98); ?>&nbsp;:&nbsp;</td>
                            <td align="left" class="text"><input name="nature" type="text" class="formStyle" id="nature" />
                              <span class="mandatory">*</span></td>
                          </tr>
                          <tr align="left" valign="top">
                            <td align="right" valign="middle" class="text">Sens&nbsp;:&nbsp;</td>
                            <td align="left" class="text">
                              <select name="sens" id="sens" class="formStyle">
                                <option value="0"></option>
                                <option value="Entrée">Entr&eacute;e</option>
                                <option value="Sortie">Sortie</option>
                                <option value="Entrée/sortie">Entr&eacute;e/sortie</option>
                              </select>
                              <span class="mandatory"> *</span></td>
                          </tr>
                          <tr>
