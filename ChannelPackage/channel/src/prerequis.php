    ...
    <td width="85%" height="80%" align="left" valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="2">
      <tr>
        <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
          <tr>
            <td width="43"  bgcolor="#FFCC66" class="leftHeader">Aide de Stock Pro v1.0 &rarr; Prérequis</td>
          </tr>
          <tr>
      ...
      <tr>
        <td><p><strong>Matériels</strong><br />
            <br />
            Avant d'installer «&nbsp;Cantine  Pro&nbsp;», vous devez disposer&nbsp;:</p>
          <ul>
            <li>Un ordinateur avec Windows 98/XP/7 ou un  ordinateur avec Linux</li>
            <li>Un navigateur (Internet explorer, Firefox, Netscape,  Opera, …)</li>
          </ul>
          <p><strong>Logiciels tiers</strong></p>
          <ul>
            <li>Au minimum, vous avez besoin d'un serveur web  (Apache, par exemple), </li>
            <li>un moteur de base de données (MySQL), </li>
            <li>et PHP 5.2.4 ou plus.</li>
          </ul></td>
      </tr>
    </table>
          <!-- Fin Affichage -->
