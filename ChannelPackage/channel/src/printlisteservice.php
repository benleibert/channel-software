...
$libellecde = getlang(392); // 'Liste des sites bénéficiaires';
//Ligne
if(isset($_SESSION['WHERE']) && $_SESSION['WHERE']!='') {
	$ligne = ligneEtatService($_SESSION['WHERE']);
}
else {
$ligne = ligneEtatService('','','');
}
?>
    ...
    <table width="100%" border="0" align="left"  cellpadding="3" cellspacing="1"  class="botBorder">
                              <tbody>
                                <tr align="left" valign="top" nowrap>
                                  <td width="15%" align=right valign="middle" class="botBorderTdall"><div align="center"><strong>Code </strong></div></td>
                                  <td width="25%" align=left valign="middle" class="botBorderTdall"><div><strong><?php echo getlang(153); ?> </strong></div></td>
                                  <td width="20%" align=left valign="middle" class="botBorderTdall"><div><strong><?php echo getlang(154); ?> </strong></div></td>
                                  <td width="20%" align=left valign="middle" class="botBorderTdall"><div><strong><?php echo getlang(344); ?></strong></div></td>
                                  <td width="30%" align=left valign="middle" class="botBorderTdall"><div><strong><?php echo getlang(165); ?></strong></div></td>
                                </tr>
                                <?php echo $ligne; ?>
        </tbody>
      </table>
