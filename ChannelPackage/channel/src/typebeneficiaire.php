...
//DOIT MAJ
$droitMAJ = $_SESSION['GL_USER']['DROIT']['par_tse'];
...
if(isset($_POST['viewLength']))  $_SESSION['GL_USER']['ELEMENT']= $_POST['viewLength'];//Numuro page
(isset($_GET['page']) ? $page = $_GET['page'] : $page=1);
//Nbre d'élément par page
...
if(isset($_GET['do']) && $_GET['do']=="search") {
	$where ="";
	$_SESSION['WHERE'] ='';
	(isset($_POST['codetypebeneficiaire']) && $_POST['codetypebeneficiaire']!='' 	? 	$where .="typebeneficiaire.CODE_TYPEBENEF LIKE '".addslashes(trim($_POST['codetypebeneficiaire']))."' AND " 	: $where .="");
	(isset($_POST['typebeneficiaire']) && $_POST['typebeneficiaire']!='' 			? 	$where .="typebeneficiaire.NOM_TYPEBENEF LIKE '".addslashes(trim($_POST['typebeneficiaire']))."%' AND " 	: $where .="");

	if($where != '')  {$where = substr($where,0, strlen($where)-4);
		$_SESSION['WHERE'] = $where;
	}
	elseif($_SESSION['WHERE'] !='') {$where = $_SESSION['WHERE'];}
	$link ='typebeneficiaire.php?selectedTab=par&do=search';
	$retour = ligneConTypeBeneficiaire($where,'','', $page, $_SESSION['GL_USER']['ELEMENT']); //$where, $order, $sens, $page=1, $nelt
}
else {
	$link ='typebeneficiaire.php?selectedTab=par';
	$retour = ligneConTypeBeneficiaire('','','', $page, $_SESSION['GL_USER']['ELEMENT']); //$where, $order, $sens, $page=1, $nelt
}
    ...
    <td width="85%" height="80%" align="left" valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="2">
      <tr>
        <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
          <tr>
            <td width="43"  bgcolor="#FFCC66" class="leftHeader"><?php echo getlang(106); ?> -> <?php echo getlang(170); ?></td>
          </tr>
          <tr>
      ...
      <tr>
        <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
		  ...
		  <form name="ListingForm" action="dbtypebeneficiaire.php" method="POST">
          <tr>
            <td width="43%"><?php echo  sousMenuDroitSansVlider($page='typebeneficiaire', $tab='par', $droitMAJ); ?></td>
            ...
            <td colspan=3 align="left" valign="top">
                ...
                <table width="100%" border="0" cellpadding="2" cellspacing="1" class="tableBorder">
                  ...
                  <tr class="header2">
                    ...
                    <td width="90%" height="25" align="left" valign="middle" class="header2Bg">&nbsp;&nbsp;<?php echo getlang(170); ?></td>
                   </tr>
                  <!-- Begin Table row -->
                  <?php echo $affichage;?>
                  <!-- End Table row -->
          ...
          <table border="0" align="right" cellpadding="5" cellspacing="0" class="botBorder">
                  <tbody>
                    <tr align="left" valign="top">
                      <td><input name="Enregistrer2" type="button" class="button" id="Enregistrer2"  value='<?php echo getlang(187); ?>'   onclick="OpenBigWin('printlistetypebeneficiaire.php','');" /></td>
                    </tr>
                  </tbody>
                </table>
            <!-- Fin Affichage -->
