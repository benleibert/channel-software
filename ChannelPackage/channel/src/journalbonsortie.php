...
(isset($_SESSION['DATA_BDS']['nbreLigne2']) 		? $nbreLigne2 	= $_SESSION['DATA_BDS']['nbreLigne2']: $nbreLigne2 ='');
(isset($_SESSION['DATA_BDS']['journal']) ? $data2= $_SESSION['DATA_BDS']['journal'] : $data2=array());
//Ligne
$t = lignedetailBonsortie($nbreLigne,$data);
$ligne = $t[1];
$verif = $t[0];
//Ligne
$Journal = lignejournalBonsortie($nbreLigne2,$data2);
//Annulation
...
<table width="100%" border="0" cellpadding="5" cellspacing="0" class="tableBorder">
						...
						<input name="statusexercice" type="hidden" id="statusexercice" value="<?php echo $_SESSION['GL_USER']['STATUT_EXERCICE']; ?>">
								...
								<input name="oldrefbonsortie" type='hidden' id="oldrefbonsortie" value="<?php echo $refbonsortie; ?>" /></td>
                              </tr>
							  <tr align="left" valign="top">
							    <td width="4">&nbsp;</td>
							    <td colspan="9">
							      ...
							      <input name="Enregistrer" type="button" class="button" id="Enregistrer"  value='<?php echo getlang(187); ?>'  onClick="OpenBigWin('printbonsortie.php','');"> </td>
  								</tr>
                          </table></td>
