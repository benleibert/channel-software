...
function validateForm(){
	var msg = '';
	var livraison = trimAll(document.formadd.livraison.options[document.formadd.livraison.selectedIndex].value);

	if( livraison == "0") {
      	msg += '- Veuillez sélectionner la livraison.\n';
    }
        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="2">
          <tr>
            <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
              <tr>
                <td height="20" bgcolor="#FFCC66" class="leftHeader"><?php echo getlang(86); ?>/Lots  &rarr; Les lots</td>
              </tr>
              <tr>
                <td colspan="2" align="left" valign="top"><form action="dblot.php?do=next" method="post" name="formadd" id="formadd">
                  <table width="100%" border="0" cellpadding="5" cellspacing="0" class="tableBorder">
                    <tr class="header2Bg">
                      <td align="left" valign="top" class="boldText" >&nbsp;Ajouter les lots (Etape n&deg;1)</td>
                    </tr>
                    <tr>
                      <td class="text" align="center"><table width="600" border="0" align="left" cellpadding="5" cellspacing="0" class="botBorder">
                        <tbody>
                          ...
                          <tr align="left" valign="top">
                            <td align="right" valign="middle" class="text">R&eacute;férence livraison :&nbsp;</td>
                            <td align="left" class="text"><select name="livraison" id="livraison" class="formStyle">
                              <option value="0"></option>
                              <?php echo selectLivraison(0,"ID_EXERCICE = '".$_SESSION['GL_USER']['EXERCICE']."' AND LVR_VALIDE=1"); ?>
                            </select></td>
                          </tr>
                          <tr>
