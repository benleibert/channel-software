...
function validateForm(){
		...
		var prenom = trimAll(document.formadd.prenom.value);
		...
		var fonction = trimAll(document.formadd.fonction.value);
		var msg = '';
		
		if(nummlle == '' && fonction== '' && email=='' && tel=='' && adresse=='' && nom=='' && nummlle=='' && service=='0' && prenom=='') {
        	msg += '- Veuillez saisir unn critère de <?php echo getlang(139); ?>.\n';
        }
		if(msg !=''){
			alert(msg);
		}
        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="2">
          <tr>
            <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
              ...
              <tr>
                <td colspan="2" align="left" valign="top"><form action="../src/personnel.php?selectedTab=par&amp;do=search" method="post" name="formadd" id="formadd">
                  <table width="100%" border="0" cellpadding="5" cellspacing="0" class="tableBorder">
                    <tr class="header2Bg">
                      <td align="left" valign="top" class="boldText" > <?php echo getlang(139); ?> <?php echo getlang(109); ?></td>
                    </tr>
                    <tr>
                      <td class="text" align="center"><table width="600" border="0" align="left" cellpadding="5" cellspacing="0" class="botBorder">
                        <tbody>
                          <tr align="left" valign="top">
                            ...
                            <td width="358" align="left" class="text"><input name="nummlle" type="text" class="formStyle" id="nummlle" />
                              <span class="mandatory" id="msg"></span></td>
                          </tr>
                          <tr align="left" valign="top">
                            <td align="right" valign="middle" class="text"><?php echo getlang(103); ?>&nbsp;:&nbsp;</td>
                            <td align="left" class="text"><input name="nom" type="text" class="formStyle" id="nom" /></td>
                          </tr>
                          <tr align="left" valign="top">
                            <td align="right" valign="middle" class="text"><?php echo getlang(115); ?>&nbsp;:&nbsp;</td>
                            <td align="left" class="text"><input name="prenom" type="text" class="formStyle" id="prenom" />
