...
if(isset($_GET['do']) && $_GET['do']=="search") {
	...
	(isset($_POST['commande']) && $_POST['commande']!='0' 	? 	$where .="livraison.ID_COMMANDE = '".addslashes(trim($_POST['commande']))."' AND " 	: $where .="");
	(isset($_POST['codelivraison']) && $_POST['codelivraison']!='' 	? 	$where .="livraison.CODE_LIVRAISON = '".addslashes(trim($_POST['codelivraison']))."' AND " 	: $where .="");
	...
	$link ='lot.php?selectedTab=bde&do=search';
	$retour = ligneConLot($where,'','', $page, $_SESSION['GL_USER']['ELEMENT']); //$where, $order, $sens, $page=1, $nelt
}
else {
	$link ='lot.php?selectedTab=bde';
	$retour = ligneConLot('livraison.ID_EXERCICE='.$_SESSION['GL_USER']['EXERCICE']."  AND livraison.CODE_MAGASIN LIKE '".$_SESSION['GL_USER']['MAGASIN']."'",'','', $page, $_SESSION['GL_USER']['ELEMENT']); //$where, $order, $sens, $page=1, $nelt
}
//echo $_SESSION['WHERE'];
    ...
    <td width="85%" height="80%" align="left" valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="2">
      <tr>
        <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
          <tr>
            <td height="20" bgcolor="#FFCC66" class="leftHeader"><?php echo getlang(36); ?>/livraisons/Lots&rarr; Les Lots &amp; Date de pérentions</td>
          </tr>
          <tr>
      ...
      <tr>
        <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
          ...
          <tr>
            <td width="43%"><?php echo  sousMenuDroit($page='lot', $tab='bde', $droitMAJ); ?></td>
            ...
            <td colspan=3 align="left" valign="top">
                ...
                <table width="100%" border="0" cellpadding="2" cellspacing="1" class="tableBorder">
                  ...
                  <tr class="header2">
                    ...
                    <td width="10%" height="25" align="left" valign="middle" class="header2Bg" nowrap="nowrap"> Code livraison</td>
                    <td width="10%" height="25" align="left" valign="middle" class="header2Bg">&nbsp;&nbsp;Code produit</td>
                    <td width="20%" height="25" align="left" valign="middle" class="header2Bg">&nbsp;&nbsp;Désignation</td>
                    <td width="10%" height="25" align="center" valign="middle" class="header2Bg">Réf. Lot</td>                    <td width="10%" height="25" align="center" valign="middle" class="header2Bg"><?php echo getlang(42); ?> pérempt.</td>
                    <td width="10%" align="center" valign="middle" class="header2Bg">&nbsp;Qté</td>
                    <td width="8%" height="25" align="center" valign="middle" class="header2Bg">...</td>
                   </tr>
                  <!-- Begin Table row -->
                  <?php echo $affichage;?>
                  <!-- End Table row -->
          ...
          <table border="0" align="right" cellpadding="5" cellspacing="0" class="botBorder">
            <tbody>
              <tr align="left" valign="top">
                <td><input name="Imprimer" type="button" class="button" id="Imprimer"  value='<?php echo getlang(187); ?>'   onclick="OpenBigWin('printlistedelivery.php','');" /></td>
                </tr>
            </tbody>
          </table></td>
      </tr>
