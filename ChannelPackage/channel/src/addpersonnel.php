...
if($_SESSION['GL_USER']['DROIT']['par_per']['AJOUT']!=1) header("location:accessinterdit.php?selectedTab=home");
        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="2">
          <tr>
            <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
              <tr>
                <td height="20" bgcolor="#FFCC66" class="leftHeader"><?php echo getlang(106); ?> -> <?php echo getlang(110); ?></td>
              </tr>
              <tr>
                <td colspan="2" align="left" valign="top"><form action="dbpersonnel.php?do=add" method="post" name="formadd" id="formadd">
                  <table width="100%" border="0" cellpadding="5" cellspacing="0" class="tableBorder">
                    <tr class="header2Bg">
                      <td align="left" valign="top" class="boldText" ><?php echo getlang(11); ?>e personne</td>
                    </tr>
                    <tr>
                      <td class="text" align="center"><table width="600" border="0" align="left" cellpadding="5" cellspacing="0" class="botBorder">
                        <tbody>
                          <tr align="left" valign="top">
                            ...
                            <td width="358" align="left" class="text"><input name="nummlle" type="text" class="formStyle" id="nummlle" onblur="go();" />
                          ...
                          <tr align="left" valign="top">
                            ...
                            <td align="left" class="text"><input name="tel" type="text" class="formStyle" id="tel" />
                              <span class="mandatory">*</span></td>
                          </tr>
                          <tr align="left" valign="top">
