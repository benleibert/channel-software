...
function validateForm(){
	...
	var datetransfert1 	= trimAll(document.formadd.datetransfert1.value);
	var camion 			= trimAll(document.formadd.camion.value);

	var codetransfert	= trimAll(document.formadd.codetransfert.value);
	var msg = '';

	if( datetransfert == "" && datetransfert1 == "" && camion == "" && document.formadd.statut.checked==false) {
        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="2">
          <tr>
            <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
              <tr>
                <td height="20" bgcolor="#FFCC66" class="leftHeader Style3"><?php echo getlang(336); ?> -> <?php echo getlang(166); ?></td>
              </tr>
              <tr>
                <td colspan="2" align="left" valign="top"><form action="transfert.php?selectedTab=bds&do=search" method="post" name="formadd" id="formadd">
                  <table width="100%" border="0" cellpadding="5" cellspacing="0" class="tableBorder">
                    <tr class="header2Bg">
                      <td align="left" valign="top" class="boldText" >&nbsp;<?php echo getlang(139); ?> <?php echo getlang(295); ?></td>
                    </tr>
                    <tr>
                      <td class="text" align="center"><table width="600" border="0" align="left" cellpadding="5" cellspacing="0" class="botBorder">
                        <tbody>
                          ...
                          <tr align="left" valign="top">
                            <td rowspan="2" align="right" valign="middle" class="text"><?php echo getlang(253); ?>&nbsp;:&nbsp;</td>
                            <td align="left" class="text"><input name="datetransfert" type="text" class="formStyle" id="datepicker1" /></td>
                          </tr>
                          <tr align="left" valign="top">
                            <td align="left" class="text"><input name="datetransfert1" type="text" class="formStyle" id="datepicker2" /></td>
                          </tr>
                          <tr align="left" valign="top">
                            <td align="right" valign="middle" class="text">Ref. <?php echo getlang(295); ?>&nbsp;:&nbsp;</td>
                            <td align="left" class="text"><input name="codetransfert" type="text" class="formStyle" id="codetransfert" value="" maxlength="20" /></td>
                          </tr>
                          <tr>
                            <td align="left" class="text"><input name="camion" type="hidden" class="formStyle" id="camion" value="" /></td>
                          </tr>
                          <tr>
