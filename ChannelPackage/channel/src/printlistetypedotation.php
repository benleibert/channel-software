    ...
    <table width="100%" border="0" align="left"  cellpadding="3" cellspacing="1"  class="botBorder">
                              <tbody>
                                <tr align="left" valign="top" nowrap>
                                  <td width="18%" align=right valign="middle" class="botBorderTdall"><div align="center"><strong>Code dotation</strong></div></td>
                                  <td width="82%" align=left valign="middle" class="botBorderTdall"><div><strong><?php echo getlang(357); ?> type de dotation</strong></div></td>
                                </tr>
                                <?php echo $ligne; ?>
        </tbody>
      </table>
