        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="2">
          <tr>
            <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
              <tr>
                <td width="43" bgcolor="#FFCC66" class="leftHeader"><?php echo getlang(336); ?> -> <?php echo getlang(166); ?></td>
              </tr>
              <tr>
                <td colspan="2" align="left" valign="top"><form action="dbtransfert.php?do=update" method="post" name="formadd" id="formadd">
