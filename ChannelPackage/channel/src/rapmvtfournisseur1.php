...
(isset($_SESSION['DATA_ETAT']['idfournisseur']) ? $idfournisseur = $_SESSION['DATA_ETAT']['idfournisseur']: $idfournisseur ='');
(isset($_SESSION['DATA_ETAT']['fournisseur']) ? $fournisseur = $_SESSION['DATA_ETAT']['fournisseur']: $fournisseur ='');

$mag=getSiteBénéf($_SESSION['GL_USER']['MAGASIN']);
$affichage = ligneConrapmvtfournisseur($_SESSION['DATA_ETAT']['nbreLigne'], $idfournisseur, $fournisseur,$_SESSION['DATA_ETAT']['ligne']); //$where, $order, $sens, $page=1, $nelt
    ...
    <td width="85%" height="80%" align="left" valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="2">
      <tr>
        <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
          <tr>
            <td width="43"  bgcolor="#FFCC66" class="leftHeader"><?php echo getlang(313); ?> : <?php echo $mag; ?></td>
          </tr>
          <tr>
        ...
        <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
            ...
            <tr>
              <td><table width="100%" border="0" cellpadding="2" cellspacing="1" class="tableBorder">
                <!-- Begin Table Header -->
                <tr class="header2">
                  <td height="25" valign="middle"  nowrap="nowrap"><?php echo getlang(66); ?> <?php echo $fournisseur; ?></td>
                </tr>
              </table></td>
              </tr>
            <!-- Data Tbale contener -->
              ...
              <td colspan=2 align="left" valign="top">
                ...
                <table width="100%" border="0" cellpadding="2" cellspacing="1" class="tableBorder">
                  ...
                  <tr class="header2">
                    ...
                    <td width="6%" align="center" valign="middle" nowrap class="header2Bg"><?php echo getlang(202); ?></td>
                    <td width="4%" align="center" valign="middle" nowrap class="header2Bg"><?php echo getlang(207); ?></td>
         ...
         <table border="0" align="right" cellpadding="5" cellspacing="0" class="botBorder">
            <tbody>
              <tr align="left" valign="top">
                <td align="right"><input name="Enregistrer2" type="button" class="button" id="Enregistrer2"  value='<?php echo getlang(187); ?>'  onClick="OpenBigWin('printetatrapmvtfournisseur.php','');" /></td>
                <td align="right"><span class="leftHeader">
                  <input name="Enregistrer3" type="button" class="button" id="Enregistrer3"  value='<?php echo getlang(188); ?>'   onclick="OpenWin('genererexcelrapmvtfournisseur.php','Fichier Excel');" />
                </span></td>
                </tr>
            </tbody>
          </table>       </td> </tr>
