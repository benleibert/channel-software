...
if(isset($_GET['do']) && $_GET['do']=="search") {
	$where ="";
	$_SESSION['WHERE'] = "";
	(isset($_POST['codeproduit']) && $_POST['codeproduit']!='' 	? 	$where .="produit.CODE_PRODUIT LIKE '".addslashes(trim($_POST['codeproduit']))."' AND " 	: $where .="");

	(isset($_POST['produit']) && $_POST['produit']!='' 			? 	$where .="produit.PRD_LIBELLE LIKE '".addslashes(trim($_POST['produit']))."%' AND " 	: $where .="");
	...
	$link ='produit.php?selectedTab=par&do=search';
	$retour = ligneConProduit($where,'','', $page, $_SESSION['GL_USER']['ELEMENT']); //$where, $order, $sens, $page=1, $nelt
}
else {
	$link ='produit.php?selectedTab=par';
	$retour = ligneConProduit('','','', $page, $_SESSION['GL_USER']['ELEMENT']); //$where, $order, $sens, $page=1, $nelt
}
...
function IsLink(ok,prd){
	if(ok==1) {
		alert('Impossible de supprimer le produit <'+prd+'>, il est lié à une autre donnée\n qu\'il faut au préalable supprimer');
    ...
    <td width="85%" height="80%" align="left" valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="2">
      ...
      <tr>
        <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
		  ...
		  <form name="ListingForm" action="dbproduit.php" method="POST">
          <tr>
            <td width="43%"><?php echo  sousMenuDroitSansVlider($page='produit', $tab='par', $droitMAJ); ?></td>
            ...
            <td colspan=3 align="left" valign="top">
                ...
                <table width="100%" border="0" cellpadding="2" cellspacing="1" class="tableBorder">
                  ...
                  <tr class="header2">
                    ...
                    <td width="5%" height="25" align="center" valign="middle" class="header2Bg">Code </td>
                    <td width="20%" height="25" align="left" valign="middle" class="header2Bg"><?php echo getlang(199); ?></td>
                    <td width="15%" height="25" align="left" valign="middle" class="header2Bg"><?php echo getlang(19); ?></td>
                    <td width="15%" align="left" valign="middle" class="header2Bg"><?php echo getlang(159); ?></td>
                    <td width="5%" align="center" valign="middle" class="header2Bg"><?php echo getlang(204); ?></td>
                    <td width="5%" align="center" valign="middle" class="header2Bg">PA</td>
                    <td width="5%" align="center" valign="middle" class="header2Bg">PR</td>
                    <td width="5%" height="25" align="left" valign="middle" class="header2Bg">&nbsp;&nbsp;PV</td>
                    <td width="10%" height="25" align="left" valign="middle" class="header2Bg"><?php echo getlang(384); ?> </td>
                    </tr>
                  <!-- Begin Table row -->
                  <?php echo $affichage;?>
                  <!-- End Table row -->
            ...
            <table border="0" align="right" cellpadding="5" cellspacing="0" class="botBorder">
              <tbody>
                <tr align="left" valign="top">
                  <td><input name="Enregistrer2" type="button" class="button" id="Enregistrer2"  value='<?php echo getlang(187); ?>'   onclick="OpenBigWin('printlisteproduit.php','');" /></td>
                </tr>
              </tbody>
            </table>            <!-- Fin Affichage -->
          </tr>
