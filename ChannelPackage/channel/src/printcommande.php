...
//Ligne
$ligne = ligneEtatCommande($nbreLigne,$data);
...
<table width="700" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	<tr class="header2">
                      ...
                      <td width="24%" class="header2Bg" align="left" valign="middle" nowrap>&nbsp;N&deg;: <strong><?php echo $refcommande; ?>&nbsp;&nbsp;</strong></td>
          <td width="56%" height="25" align="left" valign="middle" nowrap class="header2Bg">&nbsp;Date : <strong><?php echo $datecommande; ?></strong></td>
           </tr>
      </table>
    <p>&nbsp;</p>
    <tr>
  ...
  <tr><td>
    ...
    <table width="100%" cellspacing="5" cellpadding="10" >
      <tr valign="top" class="EtatText">
        <td width="30%" height="56" align="left"><div></div></td>
        <td width="30%" align="left"><div></div></td>
        <td width="30%" align="left"><div><strong><u><?php echo strtoupper($signateur1); ?></u></strong></div></td>
      </tr>
      <tr valign="top" class="EtatText">
      ...
      <tr valign="top" class="EtatText">
        <td width="30%" align="left">&nbsp;</td>
        <td width="30%" align="left">&nbsp;</td>
        <td width="30%" align="left"><strong><u><?php echo $nomsignateur1; ?></u></strong></td>
      </tr>
    </table></td>
  </tr>
