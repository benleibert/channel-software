...
if($_SESSION['GL_USER']['DROIT']['bds_trf']['VALID']!=1) header("location:accessinterdit.php?selectedTab=home");
...
function go(){
	if(document.getElementById('reftransfert').value != document.getElementById('oldreftransfert').value){
	var xhr = getXhr();
        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="2">
          <tr>
            <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
              ...
              <tr>
                <td colspan="2" align="left" valign="top"><form action="dbtransfert.php?do=validate" method="post" name="formadd" id="formadd">
                  <table width="100%" border="0" cellpadding="5" cellspacing="0" class="tableBorder">
                    <tr class="header2Bg">
                      <td align="left" valign="top" class="boldText" ><?php echo getlang(180); ?> <?php echo getlang(295); ?></td>
                    </tr>
                    <tr>
                      <td class="text" align="center"><table width="600" border="0" align="left" cellpadding="5" cellspacing="0" class="botBorder">
                        <tbody>
                          ...
                          <tr align="left" valign="top">
                            ...
                            <td align="left" class="text"><input name="reftransfert" type="text" class="formStyle" id="reftransfert" value="<?php echo $reftransfert; ?>" maxlength="20" onblur="go();"  />
