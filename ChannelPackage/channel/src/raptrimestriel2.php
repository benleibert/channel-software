...
$affichage = ligneConRapportMensuel2($_SESSION['DATA_ETAT']['nbreLigne'],$_SESSION['DATA_ETAT']['ligne']); //$where, $order, $sens, $page=1, $nelt
...
(isset($_SESSION['DATA_ETAT']['LIBELLEETAT'])  ? $libelle= $_SESSION['DATA_ETAT']['LIBELLEETAT']: $libelle = ''); 
    ...
    <td width="85%" height="80%" align="left" valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="2">
      <tr>
        <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
          <tr>
            <td width="43"  bgcolor="#FFCC66" class="leftHeader"><?php echo getlang(229); ?> <?php echo $periode; ?> : <?php echo $_SESSION['DATA_ETAT']['choix']; ?></td>
          </tr>
          <tr>
      ...
      <tr>
        <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
          ...
          <form name="ListingForm" action="../src/phpfuncunites.php" method="POST">
            <tr>
              <td width="43%"><strong><?php echo $libelle; ?></strong></td>
            ...
            <tr>
              <td colspan=3 align="left" valign="top">
                ...
                <table width="100%" border="0" cellpadding="2" cellspacing="1" class="tableBorder">
                  <!-- Begin Table Header -->
                  <tr class="header2">
                    <td width="4%" align="center" valign="middle" class="header2Bg" nowrap="nowrap">Réf lot </td>
                    ...
                    <td width="6%" align="center" valign="middle" nowrap class="header2Bg"><?php echo getlang(209); ?></td>
                    <td width="8%" align="center" valign="middle" nowrap class="header2Bg"><?php echo getlang(210); ?> </td>
                    <td width="4%" align="center" valign="middle" nowrap class="header2Bg"><?php echo getlang(211); ?> </td>
                    <td width="6%" height="25" align="center" valign="middle" bgcolor="#33CC66" class="header2Bg"><?php echo getlang(111); ?></td>
                    <td width="6%" align="center" valign="middle" class="header2Bg" nowrap="nowrap"><?php echo getlang(212); ?></td>
          ...
          <table border="0" align="right" cellpadding="5" cellspacing="0" class="botBorder">
            <tbody>
              <tr align="left" valign="top">
                <td align="right"><input name="Enregistrer2" type="button" class="button" id="Enregistrer2"  value='<?php echo getlang(187); ?>'  onClick="OpenBigWin('printraptrimestriel2.php','');" /></td>
                <td align="right"><span class="leftHeader">
                  <input name="Enregistrer3" type="button" class="button" id="Enregistrer3"  value='<?php echo getlang(188); ?>'   onclick="OpenWin('genererexcelraptrimestriel2.php','Fichier Excel');" />
                </span></td>
                </tr>
            </tbody>
          </table>        </tr>
