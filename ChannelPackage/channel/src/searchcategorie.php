...
function validateForm(){
		...
		if(codecategorie == '' && categorie == "") {
        	msg += '- Veuillez entrer un critère de <?php echo getlang(139); ?>.\n';
       		alert(msg);
		}
		else {
			//document.formadd.myaction.value='search';
        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="2">
          <tr>
            <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
              ...
              <tr>
                <td colspan="2" align="left" valign="top"><form action="categorie.php?selectedTab=par&amp;do=search" method="post" name="formadd" id="formadd">
                  <table width="100%" border="0" cellpadding="5" cellspacing="0" class="tableBorder">
                    <tr class="header2Bg">
                      <td align="left" valign="top" class="boldText" >&nbsp;<?php echo getlang(139); ?> <?php echo getlang(19); ?></td>
                    </tr>
                    <tr>
                      <td class="text" align="center"><table width="600" border="0" align="left" cellpadding="5" cellspacing="0" class="botBorder">
                        <tbody>
                          <tr align="left" valign="top">
                            ...
                            <td width="358" align="left" class="text"><input name="codecategorie" type="text" class="formStyle" id="codecategorie" onblur="go();" /></td>
                          </tr>
                          <tr align="left" valign="top">
                            <td width="200" align="right" valign="middle" class="text"><?php echo getlang(19); ?>&nbsp;:&nbsp;</td>
                            <td align="left" class="text"><input name="categorie" type="text" class="formStyle" id="categorie" /></td>
                          </tr>
                          <tr align="left" valign="top">
