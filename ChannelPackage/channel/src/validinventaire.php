...
if($_SESSION['GL_USER']['DROIT']['int_int']['VALID']!=1) header("location:accessinterdit.php?selectedTab=home");
...
function go(){
	if(document.getElementById('codeinventaire').value != document.getElementById('oldcodeinventaire').value){
	var xhr = getXhr();
	...
	xhr.onreadystatechange = function(){
		...
		if(xhr.readyState == 4 && xhr.status == 200){
			...
			if(retour !='') document.getElementById('codeinventaire').focus();
		}
	}
	...
	id = document.getElementById('codeinventaire').value;
	xhr.send("codeinventaire="+id);
}
}
        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="2">
          <tr>
            <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
              ...
              <tr>
                <td colspan="2" align="left" valign="top"><form action="dbinventaire.php?do=validate" method="post" name="formadd" id="formadd">
                  <table width="100%" border="0" cellpadding="5" cellspacing="0" class="tableBorder">
                    <tr class="header2Bg">
                      <td align="left" valign="top" class="boldText" ><?php echo getlang(180); ?>  <?php echo getlang(298); ?></td>
                    </tr>
                    <tr>
