...
require_once('funcresponsable.php');
...
if(isset($_GET['do']) && $_GET['do']=="search") {
	$where ="";
	(isset($_POST['personnel']) && $_POST['personnel']!='0' 	? 	$where .="respmagasin.NUM_MLLE = '".addslashes(trim($_POST['personnel']))."' AND " 	: $where .="");
	(isset($_POST['magasin']) && $_POST['magasin']!='0' 	? 	$where .="respmagasin.CODE_MAGASIN LIKE '".addslashes(trim($_POST['magasin']))."' AND " 	: $where .="");
	(isset($_POST['datedebut']) && $_POST['datedebut']!='' 	? 	$where .="respmagasin.RES_DATEDEBUT >= '".mysqlFormat(trim($_POST['datedebut']))."' AND " 	: $where .="");
	(isset($_POST['datefin']) && $_POST['datefin']!='' 	? 	$where .="respmagasin.RES_DATEFIN <= '".mysqlFormat(trim($_POST['datefin']))."' AND " 	: $where .="");
	...
	$link ='magasin.php?selectedTab=par&do=search';
	$retour = ligneConResponsable($where,'','', $page, $_SESSION['GL_USER']['ELEMENT']); //$where, $order, $sens, $page=1, $nelt
}
else {
	$link ='magasin.php?selectedTab=par';
	$retour = ligneConResponsable('','','', $page, $_SESSION['GL_USER']['ELEMENT']); //$where, $order, $sens, $page=1, $nelt
}
...
function IsLink(ok,prd){
	if(ok==1) {
		alert('Impossible de supprimer le site<'+prd+'>, il est lié à une autre donnée\n qu\'il faut au préalable supprimer');
    ...
    <td width="85%" height="80%" align="left" valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="2">
      ...
      <tr>
        <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
		  ...
		  <form name="ListingForm" action="dbresponsable.php" method="POST">
          <tr>
            <td width="43%"><?php echo  sousMenuDroitSansVlider($page='responsable', $tab='param', $droitMAJ); ?></td>
            ...
            <td colspan=3 align="left" valign="top">
                ...
                <table width="100%" border="0" cellpadding="2" cellspacing="1" class="tableBorder">
                  ...
                  <tr class="header2">
                    ...
                    <td width="20%" height="25" align="left" valign="middle" class="header2Bg">&nbsp;&nbsp;Nom <?php echo getlang(152); ?></td>
                    <td width="15%" height="25" align="left" valign="middle" class="header2Bg"><?php echo getlang(151); ?></td>
                    <td width="15%" align="left" valign="middle" class="header2Bg"><?php echo getlang(398); ?></td>
                    <td width="10%" align="left" valign="middle" class="header2Bg"><?php echo getlang(399); ?></td>
                    <td width="10%" height="25" align="left" valign="middle" class="header2Bg">&nbsp;&nbsp;<?php echo getlang(396); ?></td>
                    <td width="15%" height="25" align="left" valign="middle" class="header2Bg">&nbsp;&nbsp;<?php echo getlang(165); ?></td>
                    <td width="10%" height="25" align="left" valign="middle" class="header2Bg"><?php echo getlang(51); ?> </td>
                   </tr>
                  <!-- Begin Table row -->
                  <?php echo $affichage;?>
                  <!-- End Table row -->
            ...
            <table border="0" align="right" cellpadding="5" cellspacing="0" class="botBorder">
              <tbody>
                <tr align="left" valign="top">
                  <td><input name="Enregistrer2" type="button" class="button" id="Enregistrer2"  value='<?php echo getlang(187); ?>'   onclick="OpenBigWin('printlisteresponsable.php','');" /></td>
                </tr>
              </tbody>
            </table>            <!-- Fin Affichage -->
          </tr>
