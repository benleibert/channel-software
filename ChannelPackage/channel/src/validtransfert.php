                    ...
                    <tr>
                      <td class="text" align="center"><table width="600" border="0" align="left" cellpadding="5" cellspacing="0" class="botBorder">
                        <tbody>
                          ...
                          <tr align="left" valign="top">
                            <td align="right" valign="middle" class="text"><?php echo getlang(153); ?> &eacute;metteur :&nbsp;</td>
                            <td align="left" class="text"><select name="service_srce" id="service_srce" class="formStyle">
                              <option value="0"></option>
                              <?php echo selectService($service_srce); ?>
                            </select>
                              <span class="mandatory">*</span></td>
                          </tr>
                          <tr align="left" valign="top">
