...
$affichage = ligneConrapprdperime($_SESSION['DATA_ETAT']['nbreLigne'], $_SESSION['DATA_ETAT']['ligne']); //$where, $order, $sens, $page=1, $nelt
    ...
    <td width="85%" height="80%" align="left" valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="2">
      <tr>
        <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
          <tr>
            <td width="43"  bgcolor="#FFCC66" class="leftHeader"><?php echo getlang(131); ?> : <?php echo $mag; ?></td>
          </tr>
          <tr>
              ...
              <td colspan=2 align="left" valign="top">
                ...
                <table width="100%" border="0" cellpadding="2" cellspacing="1" class="tableBorder">
                  ...
                  <tr class="header2">
                    ...
                    <td width="4%" align="center" valign="middle" nowrap class="header2Bg"><?php echo getlang(201); ?></td>
                    <td width="4%" align="center" valign="middle" nowrap class="header2Bg"><?php echo getlang(200); ?> Stock </td>
                    </tr>
                  <!-- Begin Table row -->
                  <?php echo $affichage;?>
                  <!-- End Table row -->
         ...
         <table border="0" align="right" cellpadding="5" cellspacing="0" class="botBorder">
            <tbody>
              <tr align="left" valign="top">
                <td align="right"><input name="Enregistrer2" type="button" class="button" id="Enregistrer2"  value='<?php echo getlang(187); ?>'  onClick="OpenBigWin('printetatrapprdperime.php','');" /></td>
                <td align="right"><span class="leftHeader">
                  <input name="Enregistrer3" type="button" class="button" id="Enregistrer3"  value='<?php echo getlang(188); ?>'   onclick="OpenWin('genererexcelrapprdperime.php','Fichier Excel');" />
                </span></td>
                </tr>
            </tbody>
          </table>       </td> </tr>
