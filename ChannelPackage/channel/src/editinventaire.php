...
if($_SESSION['GL_USER']['DROIT']['int_int']['MODIF']!=1) header("location:accessinterdit.php?selectedTab=home");
        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="2">
          <tr>
            <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
              ...
              <tr>
                <td colspan="2" align="left" valign="top"><form action="dbinventaire.php?do=update" method="post" name="formadd" id="formadd">
