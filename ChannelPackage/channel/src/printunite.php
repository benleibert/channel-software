...
$libellecde = getlang(387);  // 'Liste des unités';
//Ligne
if(isset($_SESSION['WHERE']) && $_SESSION['WHERE']!='') {
	$ligne = ligneEtatListeUnite($_SESSION['WHERE']);
}
else {
$ligne = ligneEtatListeUnite('');
}
?>
    ...
    <table width="800" border="0" align="left"  cellpadding="3" cellspacing="1"  class="botBorder">
                              <tbody>
                                <tr align="left" valign="top" nowrap>
                                  ...
                                  <td width="50" align=right valign="middle" class="botBorderTdall" nowrap="nowrap"><div align="center"><strong>Code unité</strong></div></td>
                                  <td width="400" align=right valign="middle" class="botBorderTdall"><div align="left"><strong><?php echo getlang(357); ?> <?php echo getlang(204); ?></strong> </div></td>
                                </tr>
                                <?php echo $ligne; ?>
        </tbody>
      </table>
