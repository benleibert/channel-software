...
if($_SESSION['DATA_BAK']['table']==''){header('location:sauvegarde.php?selectedTab=data');}
          ...
          <tr>
            <td align="left" valign="top" class="text">
              ...
              <form action="dbbackup.php?do=sauve" method="post" name="formadd" id="formadd">
                <ul>
                <?php
				foreach($_SESSION['DATA_BAK']['table'] as $key => $val){
					echo '<li>'.$val.'</li>';
				}
 				?>
                </ul>
                <p>Total : <?php echo count($_SESSION['DATA_BAK']['table']); 
				unset($_SESSION['DATA_BAK']);
				?> tables<br />
                </p>
              </form></td>
          </tr>
