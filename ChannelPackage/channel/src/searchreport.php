...
function validateForm(){
	...
	var datereport1 	= trimAll(document.formadd.datereport1.value);

	var msg = '';

	if( datereport == "" && datereport1 == ""  && document.formadd.statut.checked==false) {
        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="2">
          <tr>
            <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
              ...
              <tr>
                <td colspan="2" align="left" valign="top"><form action="report.php?selectedTab=bds&do=search" method="post" name="formadd" id="formadd">
                      ...
                      <td class="text" align="center"><table width="600" border="0" align="left" cellpadding="5" cellspacing="0" class="botBorder">
                        <tbody>
                          ...
                          <tr align="left" valign="top">
                            ...
                            <td align="left" class="text"><input name="datereport" type="text" class="formStyle" id="datepicker1" /></td>
                          </tr>
                          <tr align="left" valign="top">
                            <td align="left" class="text"><input name="datereport1" type="text" class="formStyle" id="datepicker2" /></td>
                          </tr>
                          <tr>
                            <td align="right" valign="middle" class="text"><?php echo getlang(143); ?> <?php echo getlang(180); ?> :</td>
