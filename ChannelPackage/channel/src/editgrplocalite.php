...
require_once('functypelocalite.php');
...
(isset($_SESSION['DATA_GL']['ID_GRPLOC']) ? $codegrplocalite = $_SESSION['DATA_GL']['ID_GRPLOC']: $codegrplocalite ='');
(isset($_SESSION['DATA_GL']['GRPLOC_LIBELLE']) ? $grplocalite = $_SESSION['DATA_GL']['GRPLOC_LIBELLE']: $grplocalite ='');
(isset($_SESSION['DATA_GL']['GRPLOC_LIEN']) ? $dependance = $_SESSION['DATA_GL']['GRPLOC_LIEN']: $dependance ='');
...
function validateForm(){
		...
		if(codegrplocalite == '') {
        	msg += '- Veuillez saisir le code du type de localité.\n';
        }
		if(grplocalite == "") {
        	msg += '- Veuillez saisir le libellé du type de localité.\n';
        }
		if(msg !=''){
			alert(msg);
		}
...
function go(){
	if(document.getElementById('codegrplocalite').value != document.getElementById('oldcodegrplocalite').value){
	var xhr = getXhr();
	...
	xhr.onreadystatechange = function(){
		...
		if(xhr.readyState == 4 && xhr.status == 200){
			...
			if(retour !='') document.getElementById('codegrplocalite').focus();
		}
	}

	// Ici on va voir comment faire du post
	xhr.open("POST","dbgrplocalite.php?do=check",true);
	// ne pas oublier éa pour le post
	xhr.setRequestHeader('Content-Type','application/x-www-form-urlencoded');
	// ne pas oublier de poster les arguments
	// ici, l'id de l'auteur
	id = document.getElementById('codegrplocalite').value;
	xhr.send("codegrplocalite="+id);
	}
}
        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="2">
          <tr>
            <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
              ...
              <tr>
                <td colspan="2" align="left" valign="top"><form action="dbgrplocalite.php?do=update" method="post" name="formadd" id="formadd">
                  <table width="100%" border="0" cellpadding="5" cellspacing="0" class="tableBorder">
                    <tr class="header2Bg">
                      <td align="left" valign="top" class="boldText" ><?php echo getlang(440); ?> r un type de localit&eacute;</td>
                    </tr>
                    <tr>
                      <td class="text" align="center"><table width="600" border="0" align="left" cellpadding="5" cellspacing="0" class="botBorder">
                        <tbody>
                          <tr align="left" valign="top">
                            ...
                            <td width="358" align="left" class="text"><input name="codegrplocalite" type="text" class="formStyle" id="codegrplocalite" onblur="go();"  value="<?php echo  $codegrplocalite; ?>" />
                          ...
                          <tr align="left" valign="top">
                            ...
                            <td align="left" class="text"><input name="grplocalite" type="text" class="formStyle" id="grplocalite" value="<?php echo  $grplocalite; ?>" />
                          ...
                          <tr align="left" valign="top">
                            ...
                            <td align="left" class="text"><select name="dependance" id="dependance" class="formStyle">
                              ...
                              <?php echo selectTypeLocalite($dependance); ?>
                            </select></td>
                          </tr>
                          <tr>
                            <td colspan="2"><input name="exercicecourant" type="hidden" id="exercicecourant" value="<?php echo $_SESSION['GL_USER']['EXERCICE']; ?>" />
                              ...
                              <input name='oldcodegrplocalite' type='hidden' id="oldcodegrplocalite" value="<?php echo  $codegrplocalite; ?>" /></td>
                          </tr>
                          <tr align="left" valign="top">
                            <td width="200">&nbsp;</td>
