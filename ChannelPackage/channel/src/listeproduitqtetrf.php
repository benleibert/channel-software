...
//Next link
$urlAlph = "listeproduitqte.php?lg=$lg&wh=";
	...
	if($lg != '') {
		$code .= '<script language="JavaScript"> 
					function pickUp(idArticle,designat,unite,qteDispo,prixUnit,prixUnitn2,refLot,Datep,MonLot){
						...
						window.opener.document.formadd.prix'.$lg.'.value = prixUnitn2;
...
$listeDesProduits =  listeDesProduitsMvtQte($wh,$whereAll);
  ...
  <tr>
    ...
    <table width="400" border="0" align="left" cellpadding="1" cellspacing="1">
      ...
      <tr>
        ...
        <table width="620" border="0" cellpadding="5" cellspacing="1" class="tableBorder">
          <!-- Begin Table Header -->
          <tr class="header2">
