...
$libellecde = 'Liste des comptes utilisateurs';
//Ligne
if(isset($_SESSION['WHERE']) && $_SESSION['WHERE']!='') {
	$ligne = ligneEtatListeUtilisateur($_SESSION['WHERE']);
}
else {
$ligne = ligneEtatListeUtilisateur('','','');
}
?>
...
<table width="700" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
                <tr>
                  <td width="100%" height="20" class="leftHeader"><h3><?php echo $libellecde; ?></h3></td>
                </tr>
      </table>
    <p>&nbsp;</p>
    <tr>
    <td>
    <table width="890" border="0" align="left"  cellpadding="3" cellspacing="1"  class="botBorder">
                              <tbody>
                                <tr align="left" valign="top" nowrap>
                                  <td width="50" align=right valign="middle" class="botBorderTdall"><div align="center"><strong>N&deg;</strong></div></td>
                                  <td width="100" align=right valign="middle" class="botBorderTdall"><div align="left"><strong>Compte</strong> </div></td>
                                  <td width="120" align=center valign="middle" class="botBorderTdall"><div align="center"><strong> <?php echo getlang(68); ?></strong></div></td>
                                  <td width="120" align=center valign="middle" class="botBorderTdall"><div align="center"><strong>N&deg; mlle</strong></div></td>
                                  <td width="120" align=center valign="middle" class="botBorderTdall"><div align="center"><strong><?php echo getlang(103); ?> et pr&eacute;noms</strong></div></td>
                                  <td width="50" nowrap="nowrap" align=center valign="middle" class="botBorderTdall"><strong>Statut</strong></td>

                                 
                                  <td width="160" align=center valign="middle" class="botBorderTdall"><div align="center"><strong>magasin g&eacute;r&eacute;</strong></div></td>
							    </tr>
                                <?php echo $ligne; ?>
        </tbody>
      </table>
