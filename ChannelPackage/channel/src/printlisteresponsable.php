...
$libellecde = 'Liste des responsables';
//Ligne
if(isset($_SESSION['WHERE']) && $_SESSION['WHERE']!='') {
	$ligne = ligneEtatResponsable($_SESSION['WHERE']);
}
else {
$ligne = ligneEtatResponsable('','','');
}
?>
    ...
    <td><table width="100%" border="0" align="left"  cellpadding="3" cellspacing="1"  class="botBorder">
      <tbody>
        <tr align="left" valign="top" nowrap>
          <td width="25%" align=right valign="middle" class="botBorderTdall"><div align="center"><strong><?php echo getlang(103); ?> <?php echo getlang(152); ?></strong></div></td>
          <td width="25%" align=left valign="middle" class="botBorderTdall"><div><strong><?php echo getlang(151); ?></strong></div></td>
          <td width="15%" align=left valign="middle" class="botBorderTdall"><div><strong><?php echo getlang(398); ?></strong></div></td>
          <td width="15%" align=left valign="middle" class="botBorderTdall"><div><strong><?php echo getlang(399); ?></strong></div></td>
