...
$affichage = ligneConrapstocksupseuilmax($_SESSION['DATA_ETAT']['nbreLigne'],$_SESSION['DATA_ETAT']['ligne']); //$where, $order, $sens, $page=1, $nelt
    ...
    <td width="85%" height="80%" align="left" valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="2">
      <tr>
        <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
          <tr>
            <td width="43"  bgcolor="#FFCC66" class="leftHeader"><?php echo getlang(415); ?> : <?php echo $_SESSION['DATA_ETAT']['choix']; ?></td>
          </tr>
          <tr>
              ...
              <td colspan=3 align="left" valign="top">
                ...
                <table width="100%" border="0" cellpadding="2" cellspacing="1" class="tableBorder">
                  ...
                  <tr class="header2">
                    ...
                    <td width="40%" height="25" align="left" valign="middle" class="header2Bg" nowrap="nowrap"><?php echo getlang(199); ?></td>
                    <td width="5%" align="center" valign="middle" class="header2Bg" nowrap>CMM</td>
                    <td width="5%" align="center" valign="middle" class="header2Bg" nowrap><?php echo getlang(307); ?></td>
                    <td width="9%" align="center" valign="middle" class="header2Bg" nowrap><?php echo getlang(308); ?></td>
                    <td width="9%" align="center" valign="middle" class="header2Bg" nowrap><?php echo getlang(436); ?></td>
                    <td width="6%" height="25" align="center" valign="middle" class="header2Bg" nowrap="nowrap"><?php echo getlang(204); ?></td>
                    </tr>
                  <!-- Begin Table row -->
                  <?php echo $affichage;?>
                  <!-- End Table row -->
          ...
          <table border="0" align="right" cellpadding="5" cellspacing="0" class="botBorder">
            <tbody>
              <tr align="left" valign="top">
                <td align="right"><input name="Enregistrer2" type="button" class="button" id="Enregistrer2"  value='<?php echo getlang(187); ?>'  onClick="OpenBigWin('printetatrapstocksupseuilmax.php','');" /></td>
                <td align="right"><span class="leftHeader">
                  <input name="Enregistrer3" type="button" class="button" id="Enregistrer3"  value='<?php echo getlang(188); ?>'   onclick="OpenWin('genererexcelrapstocksupseuilmax.php','Fichier Excel');" />
                </span></td>
                </tr>
            </tbody>
          </table>        </tr>
