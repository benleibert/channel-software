...
if(isset($_GET['do']) && $_GET['do']=="search") {
	$where ="";
	$_SESSION['WHERE'] = "";
	(isset($_POST['nummlle']) && $_POST['nummlle']!='' 	? 	$where .="personnel.NUM_MLLE LIKE '".addslashes(trim($_POST['nummlle']))."' AND " 	: $where .="");
	(isset($_POST['nom']) && $_POST['nom']!='' 	? 	$where .="personnel.PERS_NOM LIKE '".addslashes(trim($_POST['nom']))."%' AND " 	: $where .="");
	(isset($_POST['prenom']) && $_POST['prenom']!='' 	? 	$where .="personnel.PERS_PRENOMS LIKE '".addslashes(trim($_POST['prenom']))."%' AND " 	: $where .="");
	(isset($_POST['tel']) && $_POST['tel']!='' 	? 	$where .="personnel.PERS_TEL LIKE '".addslashes(trim($_POST['tel']))."%' AND " 	: $where .="");
	(isset($_POST['adresse']) && $_POST['adresse']!='' 	? 	$where .="personnel.PERS_ADRESSE LIKE '".addslashes(trim($_POST['adresse']))."%' AND " 	: $where .="");
	(isset($_POST['tel']) && $_POST['tel']!='' 	? 	$where .="personnel.PERS_EMAIL LIKE '".addslashes(trim($_POST['tel']))."%' AND " 	: $where .="");
	(isset($_POST['service']) && $_POST['service']!='0' 	? 	$where .="personnel.CODE_MAGASIN = '".addslashes(trim($_POST['service']))."' AND " 	: $where .="");
	(isset($_POST['fonction']) && $_POST['fonction']!='' 	? 	$where .="personnel.PERS_FONCTION LIKE '".addslashes(trim($_POST['fonction']))."%' AND " 	: $where .="");
	...
	$link ='personnel.php?selectedTab=par&do=search';
	$retour = ligneConPersonnel($where,'','', $page, $_SESSION['GL_USER']['ELEMENT']); //$where, $order, $sens, $page=1, $nelt
}
else {
	$link ='personnel.php?selectedTab=par';
	$retour = ligneConPersonnel('','','', $page, $_SESSION['GL_USER']['ELEMENT']); //$where, $order, $sens, $page=1, $nelt
}
    ...
    <td width="85%" height="80%" align="left" valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="2">
      ...
      <tr>
        <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
		  ...
		  <form name="ListingForm" action="dbpersonnel.php" method="POST">
          <tr>
            <td width="43%"><?php echo  sousMenuDroitSansVlider($page='personnel', $tab='par', $droitMAJ); ?></td>
          ...
          <tr>
            <td colspan=3 align="left" valign="top">
                ...
                <table width="100%" border="0" cellpadding="2" cellspacing="1" class="tableBorder">
                  ...
                  <tr class="header2">
                    ...
                    <td width="10%" height="25" align="left" valign="middle" class="header2Bg">&nbsp;&nbsp;N° mlle</td>
                    <td width="15%" height="25" align="left" valign="middle" class="header2Bg"><?php echo getlang(103); ?> & <?php echo getlang(115); ?></td>
                    <td width="15%" height="25" align="left" valign="middle" class="header2Bg"><?php echo getlang(151); ?></td>
                    <td width="20%" height="25" align="left" valign="middle" class="header2Bg"><?php echo getlang(65); ?></td>
                    <td width="20%" height="25" align="left" valign="middle" class="header2Bg"><?php echo getlang(165); ?></td>
            ...
            <tbody>
              <tr align="left" valign="top">
                <td><input name="Enregistrer2" type="button" class="button" id="Enregistrer2"  value='<?php echo getlang(187); ?>'   onClick="OpenBigWin('printlistepersonne.php','');"></td>
                </tr>
            </tbody>
          </table>
            <!-- Fin Affichage -->
