...
function validateForm(){
	...
	var dateprogramme1 	= trimAll(document.formadd.dateprogramme1.value);
	...
	if( dateprogramme == "" && dateprogramme1 == "" && dotation == "0" && etablissement == "0" &&  document.formadd.statut.checked==false) {
      	msg += 'Veuillez entrer un critère de recherche.\n';
    }
	if(msg !=''){
		alert(msg);
	}
        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="2">
          <tr>
            <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
              <tr>
                <td width="43" bgcolor="#FFCC66" class="leftHeader"><?php echo getlang(54); ?>s et imprimables &rarr; Les programmations</td>
              </tr>
              <tr>
                <td colspan="2" align="left" valign="top"><form action="../src/programme.php?do=search&amp;selectedTab=prg" method="post" name="formadd" id="formadd">
                  <table width="100%" border="0" cellpadding="5" cellspacing="0" class="tableBorder">
                    <tr class="header2Bg">
                      <td align="left" valign="top" class="boldText" >&nbsp;Rechercher une programmation</td>
                    </tr>
                    <tr>
                      <td class="text" align="center"><table width="600" border="0" align="left" cellpadding="5" cellspacing="0" class="botBorder">
                        <tbody>
                          ...
                          <tr align="left" valign="top">
                            <td rowspan="2" align="right" valign="middle" class="text"><?php echo getlang(42); ?> programmation (P&eacute;riode) :&nbsp;</td>
                            <td align="left" class="text"><input name="dateprogramme" type="text" class="formStyle" id="datepicker1" value="" /></td>
                          </tr>
                          <tr align="left" valign="top">
                            <td align="left" class="text"><input name="dateprogramme1" type="text" class="formStyle" id="datepicker2" value="" /></td>
                          </tr>
                          <tr align="left" valign="top">
                          ...
                          <tr align="left" valign="top">
                            <td width="200">&nbsp;</td>
                            <td><input name="Suivant" type="button" class="button" id="Suivant"  value="Rechercher" onclick="validateForm();" />
