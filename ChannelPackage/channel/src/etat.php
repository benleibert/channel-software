    ...
    <td width="85%" height="80%" align="left" valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="2">
      <tr>
        <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
          <tr>
            <td width="43"  bgcolor="#FFCC66" class="leftHeader"><?php echo getlang(106); ?></td>
          </tr>
          <tr>
          ...
          <tr>
            <td align="left" valign="top" class="text">
              <p>Le paramétrage du logiciel est indispensable à son bon fonctionnement.<br>
                Cette rubrique est dédié à cette tâche</p></td>
          </tr>
          <!-- Data Tbale contener -->
        </table></td>
      </tr>
