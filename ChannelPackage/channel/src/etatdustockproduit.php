    ...
    <td width="85%" height="80%" align="left" valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="2">
      <tr>
        <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
          <tr>
            <td width="43" bgcolor="#FFCC66" class="leftHeader"><?php echo getlang(59); ?></td>
          </tr>
          <tr>
        ...
        <tr>
          <td colspan="3" align="left" valign="top"><table width="100%" border="0" cellpadding="2" cellspacing="1" class="tableBorder">
            ...
            <tr class="header2">
              ...
              <td width="50%" height="25" align="left" valign="middle" class="header2Bg" nowrap="nowrap"><?php echo getlang(199); ?></td>
              <td width="9%" align="center" valign="middle" class="header2Bg" nowrap="nowrap"><?php echo getlang(220); ?></td>
              <td width="6%" height="25" align="center" valign="middle" class="header2Bg" nowrap="nowrap">Stocks</td>
