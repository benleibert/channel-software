...
$listeDesProduits =  listeDesProduitsStock($wh,$whereAll);
        ...
        <tr>
          <td colspan="3" align="left" valign="top"><table width="100%" border="0" cellpadding="5" cellspacing="1" class="tableBorder">
            ...
            <tr class="header2">
              ...
              <td width="10%" align="center" valign="middle" class="header2Bg">Lot</td>
              ...
              <td width="20" align="center" valign="middle" class="header2Bg">Prix</td>
