    ...
    <td width="85%" height="80%" align="left" valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="2">
      <tr>
        <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
          <tr>
            <td height="20" bgcolor="#FFCC66" class="leftHeader"><?php echo getlang(36); ?>/livraisons &rarr; Les livraisons</td>
          </tr>
          <tr>
      ...
      <tr>
        <td>Cette commande a été entièrement livrée, veuillez vérifier dans la liste des livraisons en cliquant <a href="livraison.php?selectedTab=bde&amp;rst=1">ici</a></td>
      </tr>
    </table>
          <!-- Fin Affichage -->
          </tr>
