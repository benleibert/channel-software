...
if(isset($_GET['do']) && $_GET['do']=="search") {
	$where ="";
	$_SESSION['WHERE']='';
	(isset($_POST['libprofil']) && $_POST['libprofil']!='' 	? 	$where .="profil.LIBPROFIL LIKE '".addslashes(trim($_POST['libprofil']))."%' AND " 	: $where .="");

	if($where != '')  {$where = substr($where,0, strlen($where)-4);
		$_SESSION['WHERE'] = $where;
	}
	elseif($_SESSION['WHERE'] !='') {$where = $_SESSION['WHERE'];}
	$link ='profil.php?selectedTab=par&do=search';
	$retour = ligneConProfil($where,'','', $page, $_SESSION['GL_USER']['ELEMENT']); //$where, $order, $sens, $page=1, $nelt
}
else {
	$link ='profil.php?selectedTab=par';
	$retour = ligneConProfil('','','', $page, $_SESSION['GL_USER']['ELEMENT']); //$where, $order, $sens, $page=1, $nelt
}
...
<table width="100%" height="80%"  border="0" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="85%" align="left" valign="top"><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
      <tr>
        <td height="23" class="leftHeader"><?php echo getlang(106); ?> -> <?php echo getlang(178); ?></td>
      </tr>
      <tr>
          ...
          <table width="100%"  border="0" cellspacing="0" cellpadding="2">
            <tr>
              <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
                ...
                <form action="dbprofil.php" method="post" name="ListingForm" id="ListingForm">
                  <tr>
                    <td width="43%"><?php echo  sousMenuDroitSansVlider($page='profil', $tab='par', $droitMAJ); ?></td>
                    ...
                    <td colspan="3" align="left" valign="top"><!-- Data Table  -->
                      <table width="100%" border="0" cellpadding="2" cellspacing="1" class="tableBorder">
                        ...
                        <tr class="header2">
                          ...
                          <td width="30%" height="25" align="left" valign="middle" class="header2Bg"><?php echo getlang(84); ?></td>
                          <td width="70%" height="25" align="left" valign="middle" class="header2Bg"><?php echo getlang(547); ?></td>
                          </tr>
                        <!-- Begin Table row -->
                        <?php echo $affichage;?>
                        <!-- End Table row -->
