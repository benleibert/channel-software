...
$libellecde = getlang(389);  // 'Liste des sous-groupes';
//Ligne
if(isset($_SESSION['WHERE']) && $_SESSION['WHERE']!='') {
	$ligne = ligneEtatListeSousgroupe($_SESSION['WHERE']);
}
else {
$ligne = ligneEtatListeSousgroupe('');
}
?>
    ...
    <table width="800" border="0" align="left"  cellpadding="3" cellspacing="1"  class="botBorder">
                              <tbody>
                                <tr align="left" valign="top" nowrap>
                                  ...
                                  <td width="50" align=right valign="middle" class="botBorderTdall" nowrap="nowrap"><div align="center"><strong>Code <?php echo getlang(388); ?></strong></div></td>
                                  <td width="400" align=right valign="middle" class="botBorderTdall"><div align="left"><strong><?php echo getlang(357); ?> <?php echo getlang(388); ?></strong> </div></td>
                                </tr>
                                <?php echo $ligne; ?>
        </tbody>
      </table>
