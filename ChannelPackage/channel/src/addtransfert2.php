...
function validateForm(){
	...
	var nature			= trimAll(document.formadd.nature1.value);
	...
	if( datetransfert == "") {
      	msg += '- Veuillez saisir le date de livraison du  transfert.\n';
    }
	if(nature == "") {
      	msg += '- Veuillez sélectionner la nature du transfert.\n';
    }
        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="2">
          <tr>
            <td><table width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
              ...
              <tr>
                <td colspan="2" align="left" valign="top"><form action="dbtransfert.php?do=trs2" method="post" name="formadd" id="formadd">
                    ...
                    <tr>
                      <td class="text" align="center"><table width="600" border="0" align="left" cellpadding="5" cellspacing="0" class="botBorder">
                        <tbody>
                          ...
                          <tr align="left" valign="top">
                            <td align="right" valign="middle" class="text"><?php echo getlang(42); ?> livraison transfert&nbsp;:&nbsp;</td>
                          ...
                          <tr align="left" valign="top">
                            ...
                            <td align="left" class="text"><input name="reftransfert" type="text" class="formStyle" id="reftransfert" value="" maxlength="20" onblur="go();"  />
                              <span class="mandatory" id="msg"></span></td>
                          </tr>
                          <tr align="left" valign="top">
                            <td align="right" valign="middle" class="text"><?php echo getlang(304); ?> :</td>
                            <td align="left" class="text"><select name="nature" id="nature" class="formStyle" disabled="disabled" >
                              <option value="0"></option>
                              <?php echo selectNatureTransfert($nature); ?>
                            </select>
                              <span class="mandatory">*
                                <input name="nature1" type="hidden" id="nature1" value="<?php echo  $nature; ?>" />
                              </span></td>
                          </tr>
                          <tr align="left" valign="top">
                            <td align="right" valign="middle" class="text"><?php echo getlang(91); ?> :</td>
                            <td align="left" class="text"><select name="magasin_srce" id="magasin_srce" class="formStyle">
                              <option value="0"></option>
                              <?php echo selectmagasinAll(); ?>
                            </select>
                              <span class="mandatory">*</span></td>
                          </tr>
                          <tr align="left" valign="top">
                          ...
                          <tr>
                            ...
                            <td align="left" class="text"><input name="camion" type="text" class="formStyle" id="camion" value="" />
                              <span class="mandatory">*</span></td>
                          </tr>
                          -->
                          <tr>
